...
* Errore (nella prima stampa, edizioni USA e Regno Unito): a pagina 213, abbiamo scritto che "\[l\]'intera rivoluzione tecnologica che ha portato a ChatGPT e ad altri popolari modelli linguistici di grandi dimensioni è stata avviata da un articolo del 2018 che introduceva una nuova e ingegnosa disposizione aritmetica all'interno di una GPU, l'algoritmo "transformer", \[…\]". Si trattava in realtà di un articolo del 2017, intitolato "[Attention Is All You Need](https://arxiv.org/abs/1706.03762)", che ha portato alla creazione del primo GPT (GPT-1) nel 2018.
...
Una ricerca come questa potrebbe permettere alle persone di creare le IA invece di coltivarle? Potrebbe essere d'aiuto\! Purtroppo, ci aspettiamo che, molto prima che le persone arrivino a capire bene cosa succede nei modelli linguistici di grandi dimensioni, sviluppino una comprensione parziale e incompleta che permetterebbe loro di costruire IA molto più efficienti, ma non abbastanza per allinearle.
