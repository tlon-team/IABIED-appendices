# Глава 10: Проклятая задача {#глава-10:-проклятая-задача}
...
Ниже -- ответы на вопросы читателей десятой главы «*Если кто-то его сделает, все умрут*». Мы разберем [пользу исторических аналогий](#а-разве-ии-не-будет-отличаться-от-исторических-примеров?) и обсудим планы, которые могут упростить задачу. Чтобы не пересказывать книгу, мы *пропустим* эти вопросы:
...
В «Расширенном обсуждении» мы разбираем, почему у нас есть лишь [одна попытка согласования](#«до»-и-«после»). А ещё о том, [сколько теории и знаний](#история-«чикагской-поленницы-1») потребовалось для обеспечения безопасности первого в мире ядерного реактора.

## Часто задаваемые вопросы {#часто-задаваемые-вопросы-7}

### А разве ИИ не будет отличаться от исторических примеров? {#а-разве-ии-не-будет-отличаться-от-исторических-примеров?}
...
Так что да, подобрать аналогию для сложности ИИ трудно. Он принесет свои, новые проблемы. Для начала стоит понять, что проблемы вообще будут. Потом -- добавить к этому факт, что у человечества только одна попытка (как мы обсуждали в книге и [разделе ниже](#«до»-и-«после»)). И вот -- ситуация выглядит совсем скверно.

#### С ИИ всё иначе, потому что второго шанса не будет. {#с-ии-всё-иначе,-потому-что-второго-шанса-не-будет.}
...
### Сколько времени займёт решение задачи согласования ИСИ? {#сколько-времени-займёт-решение-задачи-согласования-иси?}

#### Проблема не только в нехватке времени. Проблема -- что ошибки смертельны. {#проблема-не-только-в-нехватке-времени.-проблема----что-ошибки-смертельны.}
...
### А что, если разрабатывать ИИ неспешно и так же плавно внедрять его в общество? {#а-что,-если-разрабатывать-ии-неспешно-и-так-же-плавно-внедрять-его-в-общество?}

#### Скорее всего, это окончится катастрофой. {#скорее-всего,-это-окончится-катастрофой.}
...
В дополнительных материалах к шестой главе (раздел «[А нельзя улучшить людей, чтобы они не отставали от ИИ?](#а-нельзя-улучшить-людей,-чтобы-они-не-отставали-от-ии?)») мы говорили, что люди вряд ли угонятся за развитием ИИ. Даже если немедленно займутся усилением собственного интеллекта. (В Главе 13 мы всё равно призываем к такому усилению. Но это не позволит идти в ногу с машинами, если не остановить их разработку.)
...
### А если ИИ будет много и все разные? {#а-если-ии-будет-много-и-все-разные?}

#### Это не поможет, если мы не научим хотя бы одного из них ценить добро. {#это-не-поможет,-если-мы-не-научим-хотя-бы-одного-из-них-ценить-добро.}
...
## Расширенное обсуждение {#расширенное-обсуждение-8}
...
Можно использовать [симуляции](#а-если-заставить-ии-думать,-будто-он-в-симуляции?) (и подделывать «ощущения» ИИ и всякое такое). Ваша теория подскажет, как сделать их похожими на реальную ситуацию с опцией предательства.
...
### История «Чикагской поленницы-1» {#история-«чикагской-поленницы-1»}
...
[^3]: Например: механика Ньютона давала потрясающе точные прогнозы. Это простая, сжатая математическая теория с огромной объяснительной силой. Она разбила все прошлые идеи в пух и прах. Но попробуйте с ней отправить груз к далеким планетам на релятивистских скоростях. Вам крышка! Ньютоновская механика не учитывает релятивистские эффекты.
	...
	(Вообще, скорее всего человечество *не поняло* бы, что надо отказать. Поэтому мы не надеемся на международную коалицию и считаем, что Земле нужно полностью отступить от этой задачи. См. раздел «[Почему бы международной коалиции не разработать безопасный ИИ совместно, а не запрещать?](#почему-бы-международной-коалиции-не-разработать-безопасный-ии-совместно,-а-не-запрещать?)» в материалах к Главе 12.)
