...
Ниже -- ответы на вопросы читателей десятой главы «*Если кто-то его создаст — все погибнут*». Мы разберем пользу исторических аналогий и обсудим планы, которые могут упростить задачу. Чтобы не пересказывать книгу, мы *пропустим* эти вопросы:
...
### А разве ИИ не будет отличаться от исторических примеров?
...
#### Скорее всего, это окончится катастрофой.
