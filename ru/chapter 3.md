# Глава 3: Научиться хотеть {#глава-3:-научиться-хотеть}
...
## Часто задаваемые вопросы {#часто-задаваемые-вопросы-3}

### Будут ли у ИИ человеческие эмоции? {#будут-ли-у-ии-человеческие-эмоции?}

#### Вероятно, нет. {#вероятно,-нет.-1}
...
### Разве ИИ -- не просто инструменты? {#разве-ии----не-просто-инструменты?}

#### ИИ выращивают, а не собирают. Поэтому они уже сейчас делают не то, что им говорят. {#ии-выращивают,-а-не-собирают.-поэтому-они-уже-сейчас-делают-не-то,-что-им-говорят.}
...
#### LLM уже проявляют инициативу. {#llm-уже-проявляют-инициативу.}
...
#### Компании стараются наделить ИИ агентностью. {#компании-стараются-наделить-ии-агентностью.}
...
### Можно ли просто обучить ИИ быть послушными? {#можно-ли-просто-обучить-ии-быть-послушными?}

#### Пассивность мешает полезности. {#пассивность-мешает-полезности.}
...
#### Мы не умеем надёжно прививать ИИ какой либо конкретный характер. {#мы-не-умеем-надёжно-прививать-ии-какой-либо-конкретный-характер.}
...
### Как у машины могут появиться собственные приоритеты? {#как-у-машины-могут-появиться-собственные-приоритеты?}

#### Решение сложных задач требует от ИИ всё большей инициативы. {#решение-сложных-задач-требует-от-ии-всё-большей-инициативы.}
...
#### Настойчивость полезна, даже если цель не совсем верна. {#настойчивость-полезна,-даже-если-цель-не-совсем-верна.}
...
#### ИИ выращивают, а не создают вручную, поэтому они, вероятно, получат неверные цели. {#ии-выращивают,-а-не-создают-вручную,-поэтому-они,-вероятно,-получат-неверные-цели.}

Это тема следующей главы: *Вы получаете не то, чему обучаете.*

## Расширенное обсуждение {#расширенное-обсуждение-3}

### Антропоморфизм и механоморфизм {#антропоморфизм-и-механоморфизм}
...
#### Механоморфизм и Гарри Каспаров {#механоморфизм-и-гарри-каспаров}
...
#### Недостающая часть {#недостающая-часть}
...
#### Антропоморфизм и обложки бульварных журналов {#антропоморфизм-и-обложки-бульварных-журналов}
...
![](./IABIED_supplement_chapter3_01.png)
...
### Умные ИИ замечают ложь и возможности. {#умные-ии-замечают-ложь-и-возможности.}

#### Глубинные механизмы предсказания {#глубинные-механизмы-предсказания}

Обмануть умный ИИ трудно.

Мы встречали специалистов, которые *напрямую* строят свои надежды на том, что обманут ИИ, заставят его поверить в ложь. Например, постараются, чтобы он думал, что находится [симуляции](#у-ии-есть-много-способов-догадаться,-что-он-не-в-симуляции.), и не решился нас убивать. Другие надеются одурачить ИИ более тонко. Скажем, предлагают заставить его [решить задачу согласования и выдать нам ответ](#подробнее-о-передаче-задачи-ии), несмотря на то, что сам ИИ (исходя из своих чуждых предпочтений) не хотел бы это делать. Так что стоит подробно объяснить, почему трудно заставить умный ИИ поверить в неправду.
...
#### Глубинные механизмы направления {#глубинные-механизмы-направления}
...
### Человечество выкладывалось по полной и будет требовать от ИИ того же {#человечество-выкладывалось-по-полной-и-будет-требовать-от-ии-того-же}
