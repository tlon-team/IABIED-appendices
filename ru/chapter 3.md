# Глава 3: Научиться хотеть {#chapter-3:-learning-to-want}
...
### Будут ли у ИИ человеческие эмоции? {#will-ais-have-human-like-emotions?}
...
### Разве ИИ -- не просто инструменты? {#aren’t-ais-just-tools?}

#### ИИ выращивают, а не собирают. Поэтому они уже сейчас делают не то, что им говорят. {#*-ais-are-grown,-not-crafted.-so-they-already-do-things-other-than-what-they’re-told-to-do.}
...
#### LLM уже проявляют инициативу. {#llms-are-already-taking-initiative.}
...
#### Компании стараются наделить ИИ агентностью. {#the-labs-are-trying-to-make-ais-agentic.}
...
### Можно ли просто обучить ИИ быть послушными? {#can-we-just-train-ais-to-behave-obediently?}

#### Пассивность мешает полезности. {#*-passivity-is-in-tension-with-usefulness.}
...
#### Мы не умеем надёжно прививать ИИ какой либо конкретный характер. {#we-can’t-robustly-train-any-specific-temperament-into-ais.}
...
### Как у машины могут появиться собственные приоритеты? {#how-could-a-machine-end-up-with-its-own-priorities?}

#### Решение сложных задач требует от ИИ всё большей инициативы. {#*-solving-difficult-challenges-requires-ais-to-take-more-and-more-initiative.}
...
#### Настойчивость полезна, даже если цель не совсем верна. {#being-tenacious-is-helpful-even-when-the-target-is-not-quite-right.}
...
#### ИИ выращивают, а не создают вручную, поэтому они, вероятно, получат неверные цели. {#being-grown-rather-than-crafted,-ais-are-liable-to-wind-up-with-the-wrong-targets.}

Это тема следующей главы: *Вы получаете не то, чему обучаете.*

## Расширенное обсуждение {#extended-discussion-3}

### Антропоморфизм и механоморфизм {#anthropomorphism-and-mechanomorphism}
...
#### Механоморфизм и Гарри Каспаров {#mechanomorphism-and-garry-kasparov}
...
#### Недостающая часть {#missing-gears}
...
#### Антропоморфизм и обложки бульварных журналов {#anthropomorphism-and-pulp-magazine-covers}
...
### Путь к хотению {#the-road-to-wanting}
...
### Умные ИИ замечают ложь и возможности. {#smart-ais-spot-lies-and-opportunities.}

#### Глубинные механизмы предсказания {#deep-machinery-of-prediction}

Обмануть умный ИИ трудно.

Мы встречали специалистов, которые *напрямую* строят свои надежды на том, что обманут ИИ, заставят его поверить в ложь. Например, постараются, чтобы он думал, что находится [симуляции](#there-are-many-ways-for-an-ai-to-figure-out-that-it's-not-in-a-simulation.), и не решился нас убивать. Другие надеются одурачить ИИ более тонко. Скажем, предлагают заставить его [решить задачу согласования и выдать нам ответ](#more-on-making-ais-solve-the-problem), несмотря на то, что сам ИИ (исходя из своих чуждых предпочтений) не хотел бы это делать. Так что стоит подробно объяснить, почему трудно заставить умный ИИ поверить в неправду.
...
#### Глубинные механизмы направления {#deep-machinery-of-steering}
...
### Человечество выкладывалось по полной и будет требовать от ИИ того же {#humanity-went-hard,-and-will-try-to-go-hard-on-ai}
