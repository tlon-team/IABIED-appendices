# Глава 12: Не хочу быть паникёром {#глава-12:-не-хочу-быть-паникёром}
...
## Часто Задаваемые Вопросы {#часто-задаваемые-вопросы-9}

### А опасность ИИ умнее людей не отвлекает от других проблем? {#а-опасность-ии-умнее-людей-не-отвлекает-от-других-проблем?}

#### Мир, к сожалению, достаточно велик для множества проблем. {#мир,-к-сожалению,-достаточно-велик-для-множества-проблем.}
...
### Вы против технологий? {#вы-против-технологий?}

#### Нет. Суперинтеллектуальный ИИ -- особый случай. {#нет.-суперинтеллектуальный-ии----особый-случай.}
...
### А не разумнее поспешить, чтобы лидерство досталось «хорошим парням»? {#а-не-разумнее-поспешить,-чтобы-лидерство-досталось-«хорошим-парням»?}
...
#### Остановиться реально. Может, даже не так уж и сложно. {#остановиться-реально.-может,-даже-не-так-уж-и-сложно.}

Мы вернёмся к этому в последней главе книги.

Изменения бывают. Особенно при отчаянной, срочной и осознанной необходимости. Главное препятствие для остановки -- мировые лидеры не осознают опасности. Но [лёд уже тронулся](#призн*а*ют-ли-опасность-выборные-представители-власти?). (см. раздел «Признают ли опасность выборные представители власти?» материалов к Главе 13.)

### Почему бы международной коалиции не разработать безопасный ИИ совместно, а не запрещать? {#почему-бы-международной-коалиции-не-разработать-безопасный-ии-совместно,-а-не-запрещать?}

#### Потому что у нас нет технических возможностей сделать его безопасным. {#потому-что-у-нас-нет-технических-возможностей-сделать-его-безопасным.}
...
### То есть нам нужен *доказуемо* безопасный ИИ? {#то-есть-нам-нужен-*доказуемо*-безопасный-ии?}
...
### Как осознание всего этого влияет на вашу жизнь? {#как-осознание-всего-этого-влияет-на-вашу-жизнь?}

#### Радикально меняет приоритеты. {#радикально-меняет-приоритеты.}
...
### Вы призываете паниковать? {#вы-призываете-паниковать?}

#### Мы говорим, что представители власти должны отнестись к проблеме всерьёз. {#мы-говорим,-что-представители-власти-должны-отнестись-к-проблеме-всерьёз.}
...
#### Крайняя паника к добру не приводит. {#крайняя-паника-к-добру-не-приводит.}
...
### А это всё не просто запугивание со стороны лидеров ИИ-индустрии ради статуса и инвестиций? {#а-это-всё-не-просто-запугивание-со-стороны-лидеров-ии-индустрии-ради-статуса-и-инвестиций?}
...
### А как же польза ИИ умнее людей? {#а-как-же-польза-ии-умнее-людей?}

#### Если поспешить, её не будет. {#если-поспешить,-её-не-будет.}
...
## Развёрнутое обсуждение {#развёрнутое-обсуждение}

### Эффект Лемуана {#эффект-лемуана}
...
### Рабочие планы будут подразумевать отказы ИИ-компаниям {#рабочие-планы-будут-подразумевать-отказы-ии-компаниям}
...
### Суть смертельной гонки {#суть-смертельной-гонки}
...
#### Банальность саморазрушения {#банальность-саморазрушения}
...
#### Пожимая плечами при виде апокалипсиса {#пожимая-плечами-при-виде-апокалипсиса}
...
#### Жизнь в розовых очках {#жизнь-в-розовых-очках}
...
#### Почувствовать СИИ {#почувствовать-сии}
...
#### Обычные люди, необычные технологии {#обычные-люди,-необычные-технологии}
...
[^1]: См. раздел «[Коалиция должна быть большой](#не-сужайте-коалицию)» материалов к Главе 13.

[^2]: См. список сравнений ИИ с ядерным оружием в разделе «[А ИИ разве не будет отличаться от исторических примеров?](#а-разве-ии-не-будет-отличаться-от-исторических-примеров?)» материалов к Главе 10.
...
[^5]: А как ещё, если не международной коалицией? Мы бы посоветовали вкладываться в усиление интеллекта взрослых людей (см. раздел «[Чем поможет сделать людей умнее?](#это-поможет-решить-задачу-согласования.)» материалов к Главе 13). Но с этим не обязательно соглашаться, чтобы признать необходимость закрыть исследования СИИ.
...
[^11]: Люди вроде Саттона и Пейджа, похоже, живут иллюзией, что больший интеллект ведёт к большему добру. Мы уже много где описали, почему это не так. Мы согласны с ними в том, что никогда не создать ИИ умнее людей было бы трагедией. Но гонка за суперинтеллектом, скорее всего, станет полной катастрофой и для человеческих жизней, и для долгосрочного будущего в целом. Даже с инклюзивной, космополитичной и не дискриминирующей по видовому признаку точки зрения (см. раздел «[Почему вас заботят только человеческие ценности?](#почему-вас-заботят-только-человеческие-ценности?)» материалов к Главе 5).
...
[^14]: См. также обсуждение людей, предупреждавших о смертельной ИИ-гонке за годы до создания этих компаний в разделе «[А это всё не просто запугивание со стороны лидеров ИИ-индустрии ради статуса и инвестиций?](#а-это-всё-не-просто-запугивание-со-стороны-лидеров-ии-индустрии-ради-статуса-и-инвестиций?)» выше.
