# Глава 1: Особая сила человечества {#глава-1:-особая-сила-человечества}
...
### Интеллект -- осмысленное понятие? {#интеллект----осмысленное-понятие?}

#### Да. Это слово описывает реальное явление, пусть его и трудно точно определить. {#да.-это-слово-описывает-реальное-явление,-пусть-его-и-трудно-точно-определить.}
...
#### Если вы не можете дать чему-то точное определение, это не значит, что оно не может вам навредить. {#если-вы-не-можете-дать-чему-то-точное-определение,-это-не-значит,-что-оно-не-может-вам-навредить.}
...
### Имеет ли смысл понятие «человеческий уровень интеллекта»? {#имеет-ли-смысл-понятие-«человеческий-уровень-интеллекта»?}

#### Во многих случаях, да. {#во-многих-случаях,-да.}
...
### Разве интеллект не состоит из множества навыков? {#разве-интеллект-не-состоит-из-множества-навыков?}

#### Да, но они сильно пересекаются. {#да,-но-они-сильно-пересекаются.}
...
### А интеллект не переоценён? {#а-интеллект-не-переоценён?}

#### Только если вы используете слишком узкое определение «интеллекта». {#только-если-вы-используете-слишком-узкое-определение-«интеллекта».}
...
### «Обобщённый интеллект» -- осмысленное понятие? {#«обобщённый-интеллект»----осмысленное-понятие?}
...
### Однако «обобщённость» точно определить ещё сложнее, чем «интеллект». {#однако-«обобщённость»-точно-определить-ещё-сложнее,-чем-«интеллект».}

#### Легко сказать, что люди «обобщённее» плодовых мушек. Но как это работает? {#легко-сказать,-что-люди-«обобщённее»-плодовых-мушек.-но-как-это-работает?}
...
### «Интеллект» -- это простая численная величина? {#«интеллект»----это-простая-численная-величина?}

#### Нет. Но есть уровни, которых ИИ ещё не достиг. {#нет.-но-есть-уровни,-которых-ии-ещё-не-достиг.}
...
### Сможет ли ИИ преодолеть критические пороги и «улететь»? {#сможет-ли-ии-преодолеть-критические-пороги-и-«улететь»?}
...
#### Мы не знаем, насколько ИИ далёк от этих порогов. {#мы-не-знаем,-насколько-ии-далёк-от-этих-порогов.}
...
### Разве ChatGPT --- это ещё не обобщённый интеллект? {#разве-chatgpt-----это-ещё-не-обобщённый-интеллект?}

#### Можно и так назвать, если хотите. {#можно-и-так-назвать,-если-хотите.}
...
#### «Обобщённый интеллект» -- неоднозначное понятие. {#«обобщённый-интеллект»----неоднозначное-понятие.}
...
#### Суперинтеллект -- более важная черта {#суперинтеллект----более-важная-черта}
...
### Насколько умным может стать суперинтеллект? {#насколько-умным-может-стать-суперинтеллект?}
...
### Но разве нет больших препятствий на пути к суперинтеллекту? {#но-разве-нет-больших-препятствий-на-пути-к-суперинтеллекту?}
...
#### Эта сфера хорошо справляется с препятствиями. {#эта-сфера-хорошо-справляется-с-препятствиями.}
...
### А разве можно вообще предсказать поведение суперинтеллекта? {#а-разве-можно-вообще-предсказать-поведение-суперинтеллекта?}

#### Не во всём, но в чём-то да. {#не-во-всём,-но-в-чём-то-да.}
...
### А машины не будут по сути своей неспособны на творчество? Или, может, у них есть ещё какие-нибудь фатальные слабости? {#а-машины-не-будут-по-сути-своей-неспособны-на-творчество?-или,-может,-у-них-есть-ещё-какие-нибудь-фатальные-слабости?}
...
### Разве в людях нет чего-то особенного, что какие-то там машины никогда не смогут имитировать? {#разве-в-людях-нет-чего-то-особенного,-что-какие-то-там-машины-никогда-не-смогут-имитировать?}

#### Это кажется маловероятным, да и не особо важным. {#это-кажется-маловероятным,-да-и-не-особо-важным.}
...
- Глава 2: «[Разве ИИ -- это не „просто математика”?](#разве-ии----не-«просто-математика»?)» и «[Разве ИИ не будут холодными, механистичными, излишне логичными или лишёнными какой-то важной искры?](#будет-ли-ии-неизбежно-холодным,-излишне-логичным-или-лишённым-некой-важной-искры?)»
- Глава 3: «[Антропоморфизм и механоморфизм](#антропоморфизм-и-механоморфизм)»
- Глава 5: «[Эффективность, сознание и благополучие ИИ](#эффективность,-сознание-и-благополучие-ии)»

### Вы хотите сказать, что машины обретут сознание? {#вы-хотите-сказать,-что-машины-обретут-сознание?}

#### Не обязательно, и нам это кажется отдельной темой. {#не-обязательно,-и-нам-это-кажется-отдельной-темой.}
...
Последний из этих вопросов -- самый философски сложный. Ещё он приводит к рассуждениям, являются ли ИИ, подобные ChatGPT, объектами, заслуживающими морального отношения. Мы обсудим это [позже](#эффективность,-сознание-и-благополучие-ии), в расширенных рассуждениях по Главе 5.
...
(См. также аналогичный случай [любопытства](#любопытство-не-универсально) в дополнении ко Главе 4.)
...
Мы подробнее разберём, почему считаем, что предсказание и направление событий, скорее всего, не требуют сознания (и что это значит для наших размышлений о благополучии и правах ИИ). Сделаем это после Главы 5, когда заложим необходимую основу. См. раздел «[Эффективность, сознание и благополучие ИИ](#эффективность,-сознание-и-благополучие-ии)».

## Расширенное обсуждение {#расширенное-обсуждение-1}

### Подробнее об интеллекте как предсказании и направлении {#подробнее-об-интеллекте-как-предсказании-и-направлении}
...
#### Одинаковые предсказания {#одинаковые-предсказания}
...
#### Не только предсказатели {#не-только-предсказатели}
...
#### Множество форм интеллекта {#множество-форм-интеллекта}
...
Но чтобы правильно понять, что мы утверждаем в «*Если кто-то его сделает, все умрут*», когда упоминаем «искусственный интеллект», -- не думайте об «искусственной эрудиции», «искусственном [сознании](#вы-хотите-сказать,-что-машины-обретут-сознание?)» или «искусственной человекоподобности». Думайте об «искусственном предсказании и направлении».

### Поверхностность современных ИИ {#поверхностность-современных-ии}
...
(В онлайн-материалах ко Главе 4 с технической точки зрения более подробно рассматривается, [чем такая поверхностность может быть вызвана](#llm-образца-2024-года-и-«поверхностность»-ии).)
...
Мы [не](#вы-думаете,-что-chatgpt-может-нас-всех-убить?) говорим, что ChatGPT убьёт вас завтра. В современных ИИ всё ещё есть некоторая поверхностность. Скорее, мы наблюдаем, что область развивается, и неясно, [долго ли ещё будет](#когда-будут-разработаны-эти-тревожащие-ии?).

### Осознание силы интеллекта {#осознание-силы-интеллекта}

#### Голливудский «интеллект» {#голливудский-«интеллект»}
...
#### Суперинтеллект и эффективный рынок {#суперинтеллект-и-эффективный-рынок}
...
В «[Подробнее об интеллекте как прогнозировании и направлении](#подробнее-об-интеллекте-как-предсказании-и-направлении)» мы уже упоминали один пример, помогающий укрепить интуицию, -- фондовый рынок.
...
Может, причина -- склонность к оптимизму. Или ощущение, что ИИ должны быть [холодными и излишне логичными существами](#будет-ли-ии-неизбежно-холодным,-излишне-логичным-или-лишённым-некой-важной-искры?) с [критическими слепыми пятнами](#а-мы-не-сможем-использовать-критическую-уязвимость-ии?). Как бы то ни было, у этой когнитивной ошибки есть реальные последствия. Если вы не уважаете силу интеллекта, вы совершенно не понимаете, что значило бы для человечества создать суперинтеллект. Вы можете всё ещё пытаться найти выигрышный ход против суперинтеллекта, который предпочёл бы, чтобы вас не было, а ваши ресурсы были использованы для других целей. Но единственный выигрышный ход -- не играть.

### Сложное поведение возникает из простых частей {#сложное-поведение-возникает-из-простых-частей}
...
Мы часто знаем [биохимическую основу](#нанотехнологии-и-синтез-белка) того, что делает мозг. И всегда знаем фундаментальную физику атомов.
...
### Одно и то же можно делать сильно по-разному {#одно-и-то-же-можно-делать-сильно-по-разному}
...
[^13]: Подробнее об этой идее см. в расширенном обсуждении «[Одно и то же можно делать сильно по-разному](#одно-и-то-же-можно-делать-сильно-по-разному)».
...
[^21]: Дальнейшее обсуждение рынков и интеллекта см. в расширеннои обсуждении «[Осознание силы интеллекта](#осознание-силы-интеллекта)».
