# Глава 1: Особая сила человечества {#chapter-1:-humanity’s-special-power}
...
### Интеллект -- осмысленное понятие? {#is-intelligence-a-meaningful-concept?}

#### Да. Это слово описывает реальное явление, пусть его и трудно точно определить. {#yes.-there’s-a-real-phenomenon-to-describe,-even-if-it’s-difficult-to-pin-down.}
...
#### Если вы не можете дать чему-то точное определение, это не значит, что оно не может вам навредить. {#the-fact-that-we-can’t-give-a-precise-definition-doesn’t-mean-that-it-can’t-hurt-us.}
...
### Имеет ли смысл понятие «человеческий уровень интеллекта»? {#is-“human-level-intelligence”-a-meaningful-concept?}

#### Во многих случаях, да. {#yes,-in-many-cases.}
...
### Разве интеллект не состоит из множества навыков? {#doesn’t-intelligence-consist-of-multiple-skills?}

#### Да, но они сильно пересекаются. {#yes,-but-there’s-substantial-overlap.}
...
### А интеллект не переоценён? {#isn’t-intelligence-overrated?}

#### Только если вы используете слишком узкое определение «интеллекта». {#only-if-you’re-using-an-overly-narrow-definition-of-“intelligence.”}
...
### «Обобщённый интеллект» -- осмысленное понятие? {#is-“general-intelligence”-a-meaningful-concept?}
...
### Однако «обобщённость» точно определить ещё сложнее, чем «интеллект». {#but-we’re-even-further-from-pinning-down-“generality”-than-“intelligence.”}

#### Легко сказать, что люди «обобщённее» плодовых мушек. Но как это работает? {#is-“intelligence”-a-simple-scalar-quantity?}
...
### «Интеллект» -- это простая численная величина? {#no.-but-there-are-levels-ai-hasn’t-reached.}

#### Нет. Но есть уровни, которых ИИ ещё не достиг. {#will-ai-cross-critical-thresholds-and-take-off?}
...
### Сможет ли ИИ преодолеть критические пороги и «улететь»? {#probably.}

#### Вероятно. {#we-don’t-know-how-far-ais-are-from-the-thresholds.}
...
#### Мы не знаем, насколько ИИ далёк от этих порогов. {#*-takeoff-speed-doesn’t-affect-the-outcome,-but-the-possibility-of-fast-takeoff-means-we-must-act-soon.}
...
### Разве ChatGPT --- это ещё не обобщённый интеллект? {#isn’t-chatgpt-already-a-general-intelligence?}

#### Можно и так назвать, если хотите. {#you-could-call-it-that-if-you’d-like.}
...
#### «Обобщённый интеллект» -- неоднозначное понятие. {#*-there-are-many-different-things-one-might-mean-by-“general-intelligence.”}
...
#### Суперинтеллект -- более важная черта {#superintelligence-is-a-more-important-distinction.}
...
### Насколько умным может стать суперинтеллект? {#how-smart-could-a-superintelligence-get?}
...
### Но разве нет больших препятствий на пути к суперинтеллекту? {#but-aren’t-there-big-obstacles-to-reaching-superintelligence?}

#### Неясно. {#it-isn’t-clear.}
...
#### Эта сфера хорошо справляется с препятствиями. {#*-the-field-is-good-at-overcoming-obstacles.}
...
### А разве можно вообще предсказать поведение суперинтеллекта? {#isn’t-it-impossible-to-predict-the-behavior-of-a-superintelligence?}

#### Не во всём, но в чём-то да. {#in-some-respects,-but-not-in-every-respect.}
...
### А машины не будут по сути своей неспособны на творчество? Или, может, у них есть ещё какие-нибудь фатальные слабости? {#won’t-machines-be-fundamentally-uncreative,-or-otherwise-fatally-flawed?}
...
### Разве в людях нет чего-то особенного, что какие-то там машины никогда не смогут имитировать? {#isn’t-there-something-special-about-humans-that-mere-machines-could-never-emulate?}

#### Это кажется маловероятным, да и не особо важным. {#it-seems-unlikely,-and-not-especially-relevant.}
...
- Глава 2: «[Разве ИИ -- это не „просто математика”?](#aren't-ais-”just-math”?)» и «[Разве ИИ не будут холодными, механистичными, излишне логичными или лишёнными какой-то важной искры?](#won't-ais-inevitably-be-cold-and-logical,-or-otherwise-missing-some-crucial-spark?)»
- Глава 3: «[Антропоморфизм и механоморфизм](#anthropomorphism-and-mechanomorphism)»
- Глава 5: «[Эффективность, сознание и благополучие ИИ](#effectiveness,-consciousness,-and-ai-welfare)»

### Вы хотите сказать, что машины обретут сознание? {#are-you-saying-machines-will-become-conscious?}

#### Не обязательно, и нам это кажется отдельной темой. {#not-necessarily,-and-this-seems-like-a-separate-topic.}
...
Последний из этих вопросов -- самый философски сложный. Ещё он приводит к рассуждениям, являются ли ИИ, подобные ChatGPT, объектами, заслуживающими морального отношения. Мы обсудим это [позже](#effectiveness,-consciousness,-and-ai-welfare), в расширенных рассуждениях по Главе 5.
...
(См. также аналогичный случай [любопытства](#curiosity-isn't-convergent) в дополнении ко Главе 4.)
...
Мы подробнее разберём, почему считаем, что предсказание и направление событий, скорее всего, не требуют сознания (и что это значит для наших размышлений о благополучии и правах ИИ). Сделаем это после Главы 5, когда заложим необходимую основу. См. раздел «[Эффективность, сознание и благополучие ИИ](#effectiveness,-consciousness,-and-ai-welfare)».

## Расширенное обсуждение {#extended-discussion-1}

### Подробнее об интеллекте как предсказании и направлении {#more-on-intelligence-as-prediction-and-steering}
...
#### Одинаковые предсказания {#same-predictions}
...
#### Разные цели {#different-destinations}
...
#### Не только предсказатели {#impure-predictors}
...
#### Множество форм интеллекта {#intelligence’s-many-shapes}
...
Но чтобы правильно понять, что мы утверждаем в «*Если кто-то его сделает, все умрут*», когда упоминаем «искусственный интеллект», -- не думайте об «искусственной эрудиции», «искусственном [сознании](#are-you-saying-machines-will-become-conscious?)» или «искусственной человекоподобности». Думайте об «искусственном предсказании и направлении».

### Поверхностность современных ИИ {#the-shallowness-of-current-ais}
...
(В онлайн-материалах ко Главе 4 с технической точки зрения более подробно рассматривается, [чем такая поверхностность может быть вызвана](#circa-2024-llms-and-ai-"shallowness").)
...
Мы [не](#are-you-suggesting-that-chatgpt-could-kill-us-all?) говорим, что ChatGPT убьёт вас завтра. В современных ИИ всё ещё есть некоторая поверхностность. Скорее, мы наблюдаем, что область развивается, и неясно, [долго ли ещё будет](#when-is-this-worrisome-sort-of-ai-going-to-be-developed?).

### Осознание силы интеллекта {#appreciating-the-power-of-intelligence}

#### Голливудский «интеллект» {#hollywood-“intelligence”}
...
#### Суперинтеллект и эффективный рынок {#market-efficiency-and-superintelligence}
...
В «[Подробнее об интеллекте как прогнозировании и направлении](#more-on-intelligence-as-prediction-and-steering)» мы уже упоминали один пример, помогающий укрепить интуицию, -- фондовый рынок.
...
Может, причина -- склонность к оптимизму. Или ощущение, что ИИ должны быть [холодными и излишне логичными существами](#won't-ais-inevitably-be-cold-and-logical,-or-otherwise-missing-some-crucial-spark?) с [критическими слепыми пятнами](#won't-we-be-able-to-exploit-the-ai's-critical-weakness?). Как бы то ни было, у этой когнитивной ошибки есть реальные последствия. Если вы не уважаете силу интеллекта, вы совершенно не понимаете, что значило бы для человечества создать суперинтеллект. Вы можете всё ещё пытаться найти выигрышный ход против суперинтеллекта, который предпочёл бы, чтобы вас не было, а ваши ресурсы были использованы для других целей. Но единственный выигрышный ход -- не играть.

### Сложное поведение возникает из простых частей {#special-behavior-is-built-out-of-mundane-parts}
...
Мы часто знаем [биохимическую основу](#nanotechnology-and-protein-synthesis) того, что делает мозг. И всегда знаем фундаментальную физику атомов.
...
### Одно и то же можно делать сильно по-разному {#the-same-work-can-be-done-in-many-different-ways}
...
[^13]: Подробнее об этой идее см. в расширенном обсуждении «[Одно и то же можно делать сильно по-разному](#the-same-work-can-be-done-in-many-different-ways)».
...
[^21]: Дальнейшее обсуждение рынков и интеллекта см. в расширеннои обсуждении «[Осознание силы интеллекта](#appreciating-the-power-of-intelligence)».
