# Часть II: Один сценарий вымирания {#часть-ii:-один-сценарий-вымирания}
...
## Часто задаваемые вопросы {#часто-задаваемые-вопросы-6}

### Почему вы выбрали именно такой сеттинг? {#почему-вы-выбрали-именно-такой-сеттинг?}

#### Он правдоподобный, и про него легко писать. {#он-правдоподобный,-и-про-него-легко-писать.}
...
Мы избрали сценарий, который начинается очень скоро. Мы не считаем, что так обязательно и будет. [Мы не уверены](#когда-будут-разработаны-эти-тревожащие-ии?). Но о событиях, близких к настоящему, гораздо проще писать. Если бы мы перенесли действие дальше в будущее и выдумали больше футуристических деталей о произошедшем за это время, рассказ был бы ещё менее правдоподобным. Да и эти детали только отвлекали бы.
...
#### Будущее может пойти и множеством других путей. {#будущее-может-пойти-и-множеством-других-путей.}
...
### Почему Sable так мыслит? {#почему-sable-так-мыслит?}

#### Мы показываем, что у ИИ легко могут появиться странные и непредусмотренные предпочтения. {#мы-показываем,-что-у-ии-легко-могут-появиться-странные-и-непредусмотренные-предпочтения.}
...
### Почему «Galvanic» изображена довольно осторожной? {#почему-«galvanic»-изображена-довольно-осторожной?}

#### Чтобы Sable было не слишком просто. {#чтобы-sable-было-не-слишком-просто.}
...
### Почему «Galvanic» изображена недостаточно осторожной? {#почему-«galvanic»-изображена-недостаточно-осторожной?}

#### Отчасти потому, что это реалистично. {#отчасти-потому,-что-это-реалистично.}
...
Мы ожидаем, что на самом деле ошибки корпораций проявятся раньше. Что их будет больше. Что они будут в каком-то смысле глупее. Компании уже сейчас берут ИИ, демонстрирующие множество [тревожных сигналов](#но-ведь-разработчики-на-практике-делают-ии-хорошими,-безопасными-и-послушными?), и делают их ещё намного больше, не зная, где [критические пороги](#нет.-мы-не-знаем,-где-находятся-критические-пороги.) и не пересекут ли они один из них. *Сейчас* они не параноят на этот счёт. С чего бы нам ожидать, что завтра вдруг начнут?

(Вспомните, в прошлом нас уверяли, что [никто не будет столь глуп, чтобы подключить умный ИИ к интернету](#могут-ли-разработчики-просто-держать-ии-в-коробке?). Легко говорить, что в будущем поведение корпораций изменится. Но этого не происходит.)

#### Отчасти потому, что так проще писать. {#отчасти-потому,-что-так-проще-писать.}

Мы говорили об этом в отступлении в Главе 7. Можно было бы рассказать историю, где все ведут себя крайне параноидально и осторожно, и куда более умный ИИ сбегает на куда более позднем этапе. Учитывая наблюдаемое сегодня поведение компаний, такая история была бы менее реалистична. И к тому же её было бы сложнее писать. Ведь в ней действуют ещё более умные и способные ИИ в более отдалённом будущем. (См. ниже раздел «Почему вы так описали фазу экспансии Sable» о том, [почему мы хотели написать историю, где Sable как можно дольше относительно глуп](#мы-попытались-выбрать-из-правдоподобных-сценариев-особенно-медленный-и-не-странный.).)

#### Отчасти потому, что так рано или поздно и будет, если человечество не остановится. {#отчасти-потому,-что-так-рано-или-поздно-и-будет,-если-человечество-не-остановится.}
...
Если человечество, не умея согласовывать ИИ, продолжит создавать всё более умные ИИ и продолжит давать им влиять на мир, в конце концов они сообразят, как влиять на мир в угоду своим целям, а не нашим. Как мы уже [говорили](#всё-равно-бы-не-сработало.) в материалах к Главе 6 в разделе «Могут ли разработчики просто держать ИИ в коробке?», не бывает инструментов, которые можно использовать только во благо.
...
#### Но: тут и нужно вмешаться. Сценарий нужно остановить, пока он не начался. {#но:-тут-и-нужно-вмешаться.-сценарий-нужно-остановить,-пока-он-не-начался.}
...
### Почему в вашей истории только один такой умный ИИ, как Sable? {#почему-в-вашей-истории-только-один-такой-умный-ии,-как-sable?}

#### Отчасти потому, что это реалистично. {#отчасти-потому,-что-это-реалистично.-1}
...
#### Отчасти потому, что так проще писать. {#отчасти-потому,-что-так-проще-писать.-1}
...
См. также наше обсуждение, что [скоординированные ИИ ничего не оставят людям](#а-ии-не-потребуются-работающие-законы?) (если только один из них уже не заботится о нас) в разделе «А ИИ не потребуются работающие законы?» материалов к Главе 5.

### Если бы история началась позже, был бы мир лучше подготовлен? {#если-бы-история-началась-позже,-был-бы-мир-лучше-подготовлен?}
...
### Почему фаза экспансии Sable прошла именно так? {#почему-фаза-экспансии-sable-прошла-именно-так?}

#### Мы попытались выбрать из правдоподобных сценариев особенно медленный и не странный. {#мы-попытались-выбрать-из-правдоподобных-сценариев-особенно-медленный-и-не-странный.}
...
### Почему вы написали именно такой финал? {#почему-вы-написали-именно-такой-финал?}

#### Это наше лучшее предположение о физически возможном. {#это-наше-лучшее-предположение-о-физически-возможном.}
...
## Расширенное обсуждение {#расширенное-обсуждение-7}

### Соревнование с Китаем {#соревнование-с-китаем}
...
[^1]: Мы не говорим, что в эволюции приматов был резкий скачок. Отличие людей от шимпанзе сначала наращивалось медленно, а потом быстрее. Мы говорим, что это качественный разрыв, независимо от того, каким плавным был переход. См. также раздел «[Сможет ли ИИ преодолеть критические пороги и „улететь"?](#нет.-но-есть-уровни,-которых-ии-ещё-не-достиг.)» в материалах к Главе 1.
