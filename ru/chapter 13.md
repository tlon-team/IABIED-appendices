# Глава 13: Остановите это {#chapter-13:-shut-it-down}
...
### Можем ли мы подождать и посмотреть? {#can-we-adopt-a-wait-and-see-approach?}

#### Нет. Мы не знаем, где находятся критические пороги. {#no.-we-don’t-know-where-the-critical-thresholds-are.}
...
### Будут ли предупредительные выстрелы? {#will-there-be-warning-shots?}

#### Возможно. Если мы хотим ими воспользоваться, готовиться надо сейчас. {#*-maybe.-if-we-wish-to-make-use-of-them,-we-must-prepare-now.}
...
#### Предупреждения вряд ли будут очевидны. {#warning-shots-are-unlikely-to-be-clear.}
...
Если завтра ИИ чуть активнее попытаются сбежать -- это не будет новостью. Следующая попытка, ещё чуть компетентнее, -- уже старая история. А когда сбежать получится -- будет уже поздно. (См. обсуждение этого явления в разделе «[Эффект Лемуана](#the-lemoine-effect)» материалов к Главе 12).
...
#### «Пробуждающие» катастрофы, скорее всего, не будут вызваны суперинтеллектом. {#clear-ai-disasters-probably-won’t-implicate-superintelligence.}
...
#### Человечество так себе отвечает на сюрпризы. {#humanity-isn’t-great-at-responding-to-shocks.}
...
#### Пора действовать. {#we-should-act-now.}
...
### Как остановить *всех* без шпионского ПО на каждом компьютере? {#how-would-stopping-everyone-be-possible-without-installing-spyware-on-every-computer?}

#### Надо действовать быстро. {#by-acting-soon.}
...
### Но вы предлагаете контролировать, сколько передовых чипов есть у частных лиц. {#but-you’re-advocating-control-of-how-many-advanced-ai-computer-chips-individuals-can-own.}

#### Да. А ещё мы выступаем за запрет исследований. {#yes.-we-also-advocate-a-research-ban.}
...
### Зачем запрещать исследования? Это уж слишком радикально. {#why-a-research-ban?-that-seems-extreme.}

#### Новые прорывы могут привести к тому, что создание суперинтеллекта будет невозможно остановить. {#more-breakthroughs-might-make-it-effectively-impossible-to-stop-people-from-making-superintelligence.}
...
### Разве можно остановить технологию? {#can-a-technology-really-be-stopped?}

#### Много технологий запрещено или строго регулируется. {#*-many-technologies-are-banned-or-heavily-regulated.}
...
#### Запрет может быть точечным. {#a-ban-can-be-narrowly-targeted.}
...
#### Значительная часть проблемы -- люди не осознают нависшую угрозу искусственного суперинтеллекта. {#a-big-part-of-the-problem-is-that-people-don’t-understand-the-looming-threat-of-artificial-superintelligence.}
...
### Не даёт ли это правительствам слишком много власти? {#isn’t-this-handing-too-much-power-to-governments?}

#### У них уже есть полномочия запрещать опасные технологии. {#the-power-to-ban-dangerous-technology-is-already-vested-in-governments.}
...
### А некоторые страны не откажутся от запрета? {#wouldn’t-some-nations-reject-a-ban?}

#### Если они поймут угрозу, нет. {#*-not-if-they-understand-the-threat.}
...
#### Договор потребует реального отслеживания и контроля за исполнением. {#a-treaty-would-require-real-monitoring-and-enforcement.}
...
#### Это уже работало {#this-method-has-worked-before.}
...
### Может ли режим мониторинга длиться вечно? {#can-a-monitoring-regime-last-forever?}

#### Нет. Понадобится какой-то другой выход из ситуации. {#no.-some-other-off-ramp-will-be-needed.}
...
Настолько, чтобы они не верили в научные теории вроде аристотелизма или геоцентризма, даже если все вокруг верят. Настолько, чтобы у них был шанс пересечь пропасть между «До» и «После» с первой же попытки. (См. раздел «[„До” и „После”](#a-closer-look-at-before-and-after)» материалов к Главе 10.)
...
#### Мониторингу *не следует* быть вечным. {#a-monitoring-regime-shouldn’t-last-forever.}
...
Это неправда. Есть и другие маршруты в столь же яркое будущее. Без риска потерять всё ни за что. Надо поискать другой путь. (См. раздел «[Если поспешить, её не будет.](#rushing-ahead-destroys-those-benefits.)» материалов к Главе 12.)

### Зачем делать людей умнее? {#why-would-making-humans-smarter-help?}

#### Это поможет решить задачу согласования. {#*-it-could-help-with-solving-the-alignment-problem.}
...
Обычно такая наивность простительна. Обычно реальность не уничтожает *всё человечество* за гордыню одного алхимика. Но с машинным суперинтеллектом такой роскоши у нас нет. (См. раздел «[„До” и „После”](#a-closer-look-at-before-and-after)» материалов к Главе 10.)
...
#### К усовершенствованным людям не прилагается серьезная задача «согласования человека». {#augmented-humans-don’t-pose-a-major-“human-alignment”-problem.}
...
#### Работать над остановкой суперинтеллекта можно, даже если вы не согласны по поводу усовершенствования людей. {#we-can-work-together-to-stop-superintelligence-while-disagreeing-on-human-enhancement.}
...
### «Согласованный с кем?» {#“aligned-to-whom?”}

#### Трудный вопрос. Но разработку нужно остановить независимо от ответа. {#this-is-a-thorny-question.-regardless-of-the-answer,-we-need-to-halt-development.}
...
### А не разумнее ли избегать разговоров о вымирании? {#isn’t-it-smarter-to-avoid-talking-about-extinction?}

#### Время политических игр прошло. {#the-time-has-passed-for-playing-political-games.}
...
Кстати: с тех пор как мы написали предыдущий абзац, предложенная нами стратегия стала приносить всё больше результатов. См. [чуть ниже](#will-elected-officials-recognize-this-as-a-real-threat?), что политики говорили о суперинтеллекте летом 2025 года. Похоже, настало время для настоящего обсуждения опасности искусственного суперинтеллекта.

### Призн*а*ют ли опасность выборные представители власти? {#will-elected-officials-recognize-this-as-a-real-threat?}

#### Всё больше признают. {#an-increasing-number-already-have.}
...
### Ситуация безнадёжна? {#is-the-situation-hopeless?}
...
## Расширенное обсуждение {#extended-discussion-11}

### Что нужно для глобальной остановки разработки ИИ? {#what-would-it-take-to-shut-down-global-ai-development?}
...
#### Предотвратить появление более многочисленных и мощных чипов для ИИ. {#preventing-the-creation-of-more-and-better-ai-chips}
...
#### Предотвратить использование для ИИ более мощных чипов. {#preventing-the-usage-of-more-and-better-ai-chips}
...
#### Предотвратить прогресс алгоритмов. {#preventing-algorithmic-progress}
...
Чтобы даже несовершенный запрет стал достаточно эффективным, очень важно, чтобы мировые лидеры действительно понимали -- если продолжить давить на газ, [погибнут лично они и их семьи](#wouldn't-some-nations-reject-a-ban?). Самые вероятные сценарии нарушения -- если государства решат, будто собственный суперинтеллект -- это стратегический актив (или что это иллюзия, отвлекающая от прибыльных ИИ-инструментов). Если они не будут видеть в нём кнопку для всеобщего самоубийства. Вряд ли государства станут вести секретные разработки СИИ, понимая, что это равносильно тому, чтобы зарядить пистолет, приставить к виску и спустить курок.
...
#### Чем дольше ждём, тем труднее будет {#the-longer-we-wait,-the-harder-it-gets}
...
### Предварительный черновик договора с примечаниями {#a-tentative-draft-of-a-treaty,-with-annotations}
...
[^1]: Разберём этот пример подробнее. Кабина «Аполлона-1» загорелась во время симуляции запуска 27 января 1967 года. В NASA смогли извлечь урок из ошибки. Инженеры понимали каждую деталь ракеты. Они диагностировали проблему. Дело, вероятно, было в посеребрённом медном проводе (изоляция которого протёрлась от движения двери) рядом с подтекающей трубой охлаждения с этиленгликолем и водой. Ситуацию усугубила атмосфера из чистого кислорода в капсуле и горючие материалы в кабине. Кроме того, давление перед открытием люка надо было выровнять. Но огонь не дал добраться до управления клапаном. А пожар резко усилил разницу давления.
	...
	Современные ИИ-компании и близко не показывают такого уважения к задаче. (См. раздел «[Мы знаем, как выглядит серьёзное отношение к задаче. Тут не так.](#we-know-what-it-looks-like-when-a-problem-is-being-treated-with-respect,-and-this-isn't-it)» материалов к Главе 11) У них нет таких подробных планов. Они не близки к правильному решению. Когда ИИ делает что-то непонятное, они не могут найти причину, как нашли тот провод. Они недостаточно близки к успеху, чтобы учиться на ошибках.
...
[^2]: Мы не рекомендуем международную коалицию для создания ИИ. (См. раздел «[Почему бы международной коалиции не разработать безопасный ИИ совместно, а не запрещать?](#why-not-use-international-cooperation-to-build-ai-safely,-rather-than-to-shut-it-all-down?)» материалов к Главе 12.) Но теоретически она могла бы породить организацию уровня NASA или FAA, способную реально учиться на ошибках индустрии.
