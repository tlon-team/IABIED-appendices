...
Это последняя часть материалов к «*Если кто-то его создаст — все погибнут*». В последней, 14-й, Главе обсуждаются эти вопросы:
...
Может, небольшая катастрофа настроит общество против ИИ. А может, обойдётся и без катастроф. Скажем, появится новый алгоритм, и ИИ начнут проявлять инициативу так, что это всех перепугает. Или ситуацию переломит какой-то побочный социальный эффект. Или «*Если кто-то его создаст — все погибнут*» запустит цепную реакцию и направит мир по лучшему пути.
...
[^13]: Завершая эти онлайн-материалы, мы увидели ещё один хороший знак: ряд экспертов по нацбезопасности и бывших представителей власти положительно оценили черновик «*Если кто-то его создаст — все погибнут*».
