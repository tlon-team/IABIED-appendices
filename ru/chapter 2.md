# Глава 2: Выращен, а не собран {#глава-2:-выращен,-а-не-собран}
...
## Часто задаваемые вопросы {#часто-задаваемые-вопросы-2}

### Почему градиентный спуск важен? {#почему-градиентный-спуск-важен?}

#### Он важен для понимания, как создатели могут и не могут влиять на современные ИИ. {#он-важен-для-понимания,-как-создатели-могут-и-не-могут-влиять-на-современные-ии.}
...
#### Он важен для понимания, какими знаниями специалисты по ИИ обладают, а какими -- нет. {#он-важен-для-понимания,-какими-знаниями-специалисты-по-ии-обладают,-а-какими----нет.}
...
### Понимают ли специалисты, что происходит внутри ИИ? {#понимают-ли-специалисты,-что-происходит-внутри-ии?}
...
#### Понимание внутреннего устройства ИИ всё ещё в зачаточном состоянии. {#понимание-внутреннего-устройства-ии-всё-ещё-в-зачаточном-состоянии.}
...
#### То, что мы понимаем, не на том уровне абстракции. {#то,-что-мы-понимаем,-не-на-том-уровне-абстракции.}
...
Точно так же понимание транзисторов не сильно поможет понять, о чём ИИ думает. Даже тот, кто знает о весах, активациях и градиентном спуске всё, будет озадачен, когда ИИ начнёт делать что-то [неожиданное и незапланированное](#но-ведь-разработчики-на-практике-делают-ии-хорошими,-безопасными-и-послушными?). Механика физики, транзисторов и архитектуры ИИ в каком-то смысле полностью объясняет его поведение. Но это слишком низкие уровни абстракции. А «психология ИИ» ещё моложе и ещё менее развита, чем психология людей.

### Можно ли в принципе понять интеллект? {#можно-ли-в-принципе-понять-интеллект?}
...
И разные крошечные части искусственных нейронных сетей уже удалось понять. Выяснилось, что маленькая нейросеть [интересным образом](https://cprimozic.net/blog/reverse-engineering-a-small-neural-network/) складывает числа. ИИ иногда говорят, что 9.11 больше 9.9, и люди выяснили причину -- они думают о [датах, а не о десятичных дробях](#понимание-внутреннего-устройства-ии-всё-ещё-в-зачаточном-состоянии.).[^3]
...
Более подробно эта тема раскрыта в [расширенном обсуждении](#интеллект-постижим).

### Но ведь некоторые ИИ отчасти мыслят на английском. Разве это не помогает? {#но-ведь-некоторые-ии-отчасти-мыслят-на-английском.-разве-это-не-помогает?}

#### Не так сильно, как можно было бы надеяться. Мы уже видим признаки неискренности. {#не-так-сильно,-как-можно-было-бы-надеяться.-мы-уже-видим-признаки-неискренности.}
...
#### Тревожные сигналы чего-то стоят, только если на них обращать внимание. {#тревожные-сигналы-чего-то-стоят,-только-если-на-них-обращать-внимание.}
...
Более подробно эта тема будет раскрыта в материалах к Главе 11 в «[Разве исследователи не получат предупреждения о проблемах заранее?](#а-у-исследователей-не-будет-ранних-предупреждений-о-проблемах?)».

### Разве ИИ -- не «просто математика»? {#разве-ии----не-«просто-математика»?}

#### Если ИИ -- «просто математика», то люди -- «просто биохимия». {#если-ии----«просто-математика»,-то-люди----«просто-биохимия».}
...
#### Математика может представлять то, что мы интуитивно «математическим» не считаем. {#математика-может-представлять-то,-что-мы-интуитивно-«математическим»-не-считаем.}
...
*Здорово*, что бесконечное разнообразие вещей можно построить из чрезвычайно простых частей. Но в этом нет ничего невыразимого или волшебного. Можно изучать, как изображения тёплых и красивых цветов кодируются в единицы и нули, пока это не перестанет казаться удивительным. Сравните с [ошибкой витализма](#сложное-поведение-возникает-из-простых-частей).
...
### Разве ИИ не просто предсказывают следующий токен? {#разве-ии-не-просто-предсказывают-следующий-токен?}

#### Предсказание токенов требует понимания мира. {#предсказание-токенов-требует-понимания-мира.}
...
#### Современные ИИ не просто предсказывают токены. {#современные-ии-не-просто-предсказывают-токены.}
...
### А ИИ разве не просто повторяют за людьми как попугаи? {#а-ии-разве-не-просто-повторяют-за-людьми-как-попугаи?}

#### Чтобы хорошо предсказывать следующий токен, LLM приходится понимать, как устроен мир. {#чтобы-хорошо-предсказывать-следующий-токен,-llm-приходится-понимать,-как-устроен-мир.}
...
#### ИИ уже сейчас могут превзойти свои обучающие данные. И даже обходиться без человеческих. {#ии-уже-сейчас-могут-превзойти-свои-обучающие-данные.-и-даже-обходиться-без-человеческих.}
...
### Будет ли ИИ неизбежно холодным, излишне логичным или лишённым некой важной искры? {#будет-ли-ии-неизбежно-холодным,-излишне-логичным-или-лишённым-некой-важной-искры?}
...
Говоря, что интеллект состоит из обыденных частей и что он доступен машинам, мы его не принижаем. См. наше подробное обсуждение [витализма](#сложное-поведение-возникает-из-простых-частей).
...
Мы подробнее раскроем эту мысль в одном из дополнений к главе 3: «[Антропоморфизм и механоморфизм](#антропоморфизм-и-механоморфизм)».

#### ИИ -- новые, интересные и странные сущности. {#ии----новые,-интересные-и-странные-сущности.}
...
### Разве большие языковые модели не будут похожи на людей, на чьих данных они обучались? {#разве-большие-языковые-модели-не-будут-похожи-на-людей,-на-чьих-данных-они-обучались?}

#### Чтобы быть одним человеком и чтобы предсказывать многих нужны разные механизмы. {#чтобы-быть-одним-человеком-и-чтобы-предсказывать-многих-нужны-разные-механизмы.}

(Это сокращённая версия более технического обсуждения. См. его ниже в разделе «[Притворяйся, пока не станешь](#«притряйся,-вопока-не-станешь»).)
...
#### Архитектура больших языковых моделей сильно отличается от человеческой. {#архитектура-больших-языковых-моделей-сильно-отличается-от-человеческой.}

В Главе 2 мы кратко обсудили, насколько LLM для нас чужды.

В Главе 4 мы подробнее рассмотрим, как у ИИ появляются очень странные предпочтения и стремления. Мы уже начали наблюдать это в реальном мире. Мы отправили книгу в печать, а число примеров всё растёт. Некоторые из них можно найти в [дополнении](#но-ведь-разработчики-на-практике-делают-ии-хорошими,-безопасными-и-послушными?) к Главе 4.

### Как ИИ, обученный только на человеческих данных, может превзойти людей? {#как-ии,-обученный-только-на-человеческих-данных,-может-превзойти-людей?}

#### Может, изучив общие навыки и лучше их применяя. {#может,-изучив-общие-навыки-и-лучше-их-применяя.}
...
#### И может сделать это любым другим подходящим способом. Это часто нужно для успеха, поэтому градиентный спуск найдёт как. {#и-может-сделать-это-любым-другим-подходящим-способом.-это-часто-нужно-для-успеха,-поэтому-градиентный-спуск-найдёт-как.}

Предсказание человеческих слов требует понимания мира. Мы это уже обсуждали в «[А ИИ разве не просто повторяют за людьми как попугаи?](#а-ии-разве-не-просто-повторяют-за-людьми-как-попугаи?)».
...
### Почему вы думаете, что люди могут создать сверхчеловеческий ИИ, если они даже не понимают, что такое интеллект? {#почему-вы-думаете,-что-люди-могут-создать-сверхчеловеческий-ии,-если-они-даже-не-понимают,-что-такое-интеллект?}

#### Предыдущие успехи в области ИИ не требовали глубокого понимания интеллекта. {#предыдущие-успехи-в-области-ии-не-требовали-глубокого-понимания-интеллекта.}
...
#### Естественному отбору не нужно было «понимать» интеллект. {#естественному-отбору-не-нужно-было-«понимать»-интеллект.}
...
### Разве галлюцинации не показывают, что современные ИИ слабы? {#разве-галлюцинации-не-показывают,-что-современные-ии-слабы?}

#### Галлюцинации демонстрируют как неспособность, так и несогласованность. {#галлюцинации-демонстрируют-как-неспособность,-так-и-несогласованность.}
...
#### Неясно, насколько сложно будет избавиться от галлюцинаций и как это расширит возможности ИИ. {#неясно,-насколько-сложно-будет-избавиться-от-галлюцинаций-и-как-это-расширит-возможности-ии.}
...
Но есть и другая сторона медали. Может, галлюцинации и другие проблемы с надёжностью будут тормозить развитие ИИ ещё долгие годы. А может, надёжность -- последний недостающий элемент. Может, стоит кому-то прийти в голову, как эти проблемы решить, ИИ перейдёт некий [критический порог](#легко-сказать,-что-люди-«обобщённее»-плодовых-мушек.-но-как-это-работает?). Мы не знаем.
...
См. также наше обсуждение того, как [эта область хорошо справляется с преодолением препятствий](#эта-сфера-хорошо-справляется-с-препятствиями.).

### А у нас не закончатся данные до того, как ИИ успеет полноценно развиться? Или электроэнергия? Или финансирование? {#а-у-нас-не-закончатся-данные-до-того,-как-ии-успеет-полноценно-развиться?-или-электроэнергия?-или-финансирование?}

#### Вероятно, нет. {#вероятно,-нет.}
...
#### Не ждите новой «зимы ИИ». {#не-ждите-новой-«зимы-ии».}
...
### Смогут ли LLM развиться до суперинтеллекта? {#смогут-ли-llm-развиться-до-суперинтеллекта?}

#### Это неясно. Но исследователи находят, как преодолеть их прежние ограничения. {#это-неясно.-но-исследователи-находят,-как-преодолеть-их-прежние-ограничения.}
...
#### Другие подходы могут скоро дойти до суперинтеллекта, даже если LLM не преуспеют. {#другие-подходы-могут-скоро-дойти-до-суперинтеллекта,-даже-если-llm-не-преуспеют.}

[Эта область хорошо справляется с преодолением препятствий.](#эта-сфера-хорошо-справляется-с-препятствиями.) Мы написали «*Если кто-то его сделает, все умрут*» не для того, чтобы предупредить конкретно об LLM. Мы предупреждаем о суперинтеллекте.
...
См. также расширенное обсуждение «[Зачем разбираться в LLM?](#какая-польза-от-знаний-об-llm?)» ниже.

## Расширенное обсуждение {#расширенное-обсуждение-2}

### Интеллект постижим {#интеллект-постижим}
...
#### Заявления о непостижимости в науке почти всегда оказывались неверными {#заявления-о-непостижимости-в-науке-почти-всегда-оказывались-неверными}
...
#### Видно, что у интеллекта есть структура и закономерности. {#видно,-что-у-интеллекта-есть-структура-и-закономерности.}
...
#### Мы ещё многое не поняли о *человеческом* интеллекте, что должно быть постижимо в принципе {#мы-ещё-многое-не-поняли-о-*человеческом*-интеллекте,-что-должно-быть-постижимо-в-принципе}
...
#### Уже есть некоторый прогресс {#уже-есть-некоторый-прогресс}
...
Конечно, важно *ещё* *и* то, что современному человечеству до этого достижения очень далеко. Но сам факт, что оно возможно, влияет на то, как нам следует выбираться из этой передряги. Подробнее об этом позже, в [расширенном обсуждении](#что-нужно-для-глобальной-остановки-разработки-ии?) к Главе 10.

#### «Очевидные» идеи приходят не сразу {#«очевидные»-идеи-приходят-не-сразу}
...
### Какая польза от знаний об LLM? {#какая-польза-от-знаний-об-llm?}
...
Без алгоритма «трансформер» не существовало бы современных ИИ. Это был крупный прорыв. А совершили его всего несколько человек из Google. Следующий подобный прорыв может перевести, а может и не перевести ИИ за [критическую черту](#легко-сказать,-что-люди-«обобщённее»-плодовых-мушек.-но-как-это-работает?). Это легче понять, если вы представляете, что «трансформер» такое, насколько он прост и почему он так сильно повлиял на всю область.

Есть много дезинформации, рассчитанной на слушателя, не знающего, как работает ИИ. Некоторые [говорят](#понимают-ли-специалисты,-что-происходит-внутри-ии?), будто люди понимают, что происходит внутри современных ИИ, хотя это не так. Другие говорят, что ИИ никогда не сможет быть опасным, потому что это «[просто математика](#разве-ии----не-«просто-математика»?)», как будто существует непреодолимая пропасть между мышлением ИИ, основанным на [куче](#llm-большие) «математики», и мышлением человека, основанным на куче «биохимии».
...
Мы надеемся, что описанное в «*Если кто-то его сделает, все умрут*» станет защитой от распространённых заблуждений и дезинформации. Для читателей, которым интересны подробности, [ниже](#подробное-описание-llm) мы приводим более полный разбор работы одной конкретной LLM.
...
## Подробное описание LLM {#подробное-описание-llm}

### Как работает Llama 3.1 405B {#как-работает-llama-3.1-405b}

Ниже приведено обещанное в книге более подробное описание LLM под названием Llama 3.1 405B. Оно предназначено для любопытных, а также для того, чтобы по-настоящему понять, в какой степени современные ИИ скорее «выращивают», чем создают. (См. также: [Какая польза от знаний об LLM?](#какая-польза-от-знаний-об-llm?))
...
[^1]: см. самый вопиющий из известных нам примеров рассмотрен в ответе на вопрос «[Понимают ли специалисты, что происходит внутри ИИ?](#понимают-ли-специалисты,-что-происходит-внутри-ии?)».
...
[^15]: Новые архитектуры используют более сложные функции. Например, Llama 3.1, которую мы опишем [ниже](#подробное-описание-llm), использует функцию «SwiGLU», сложную формулу, которую мы здесь приводить не будем. Её создатель сам не знает, почему она работает, и пишет: «Мы не предлагаем объяснения, почему эти архитектуры, по-видимому, работают. Мы приписываем их успех, как и всё остальное, божественной благодати».
