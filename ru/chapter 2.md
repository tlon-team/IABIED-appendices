# Глава 2: Выращен, а не собран {#chapter-2:-grown,-not-crafted}
...
### Почему градиентный спуск важен? {#why-does-gradient-descent-matter?}

#### Он важен для понимания, как создатели могут и не могут влиять на современные ИИ. {#*-it’s-important-for-understanding-how-engineers-can-and-cannot-shape-modern-ais.}
...
#### Он важен для понимания, какими знаниями специалисты по ИИ обладают, а какими -- нет. {#it’s-important-for-understanding-what-sort-of-expertise-ai-experts-do-and-do-not-have.}
...
### Понимают ли специалисты, что происходит внутри ИИ? {#do-experts-understand-what’s-going-on-inside-ais?}
...
#### Понимание внутреннего устройства ИИ всё ещё в зачаточном состоянии. {#efforts-to-understand-ais’-internals-are-still-in-their-infancy.}
...
#### То, что мы понимаем, не на том уровне абстракции. {#the-parts-we-understand-are-at-the-wrong-level-of-abstraction.}
...
Точно так же понимание транзисторов не сильно поможет понять, о чём ИИ думает. Даже тот, кто знает о весах, активациях и градиентном спуске всё, будет озадачен, когда ИИ начнёт делать что-то [неожиданное и незапланированное](#aren't-developers-regularly-making-their-ais-nice-and-safe-and-obedient?). Механика физики, транзисторов и архитектуры ИИ в каком-то смысле полностью объясняет его поведение. Но это слишком низкие уровни абстракции. А «психология ИИ» ещё моложе и ещё менее развита, чем психология людей.

### Можно ли в принципе понять интеллект? {#is-intelligence-understandable-in-principle?}
...
И разные крошечные части искусственных нейронных сетей уже удалось понять. Выяснилось, что маленькая нейросеть [интересным образом](https://cprimozic.net/blog/reverse-engineering-a-small-neural-network/) складывает числа. ИИ иногда говорят, что 9.11 больше 9.9, и люди выяснили причину -- они думают о [датах, а не о десятичных дробях](#efforts-to-understand-ais'-internals-are-still-in-their-infancy.).[^3]
...
Более подробно эта тема раскрыта в [расширенном обсуждении](#intelligence-isn't-ineffable).

### Но ведь некоторые ИИ отчасти мыслят на английском. Разве это не помогает? {#but-some-ais-partly-think-in-english-—-doesn’t-that-help?}

#### Не так сильно, как можно было бы надеяться. Мы уже видим признаки неискренности. {#*-not-as-much-as-you-might-hope;-we-already-see-signs-of-infidelity.}
...
#### Тревожные сигналы чего-то стоят, только если на них обращать внимание. {#warning-signs-only-matter-if-you-pay-attention-to-them.}
...
Более подробно эта тема будет раскрыта в материалах к Главе 11 в «[Разве исследователи не получат предупреждения о проблемах заранее?](#won't-there-be-early-warnings-researchers-can-use-to-identify-problems?)».

### Разве ИИ -- не «просто математика»? {#aren’t-ais-“just-math”?}

#### Если ИИ -- «просто математика», то люди -- «просто биохимия». {#*-saying-ais-are-“just-math”-is-like-saying-humans-are-“just-biochemistry.”}
...
#### Математика может представлять то, что мы интуитивно «математическим» не считаем. {#mathematical-operations-can-represent-ideas-that-aren’t-intuitively-“mathematical.”}
...
### Разве ИИ не просто предсказывают следующий токен? {#aren’t-ais-just-predicting-the-next-token?}

#### Предсказание токенов требует понимания мира. {#*-predicting-tokens-requires-understanding-the-world.}
...
#### Современные ИИ не просто предсказывают токены. {#modern-ais-don’t-just-predict-tokens.}
...
### А ИИ разве не просто повторяют за людьми как попугаи? {#aren’t-ais-only-able-to-parrot-back-what-humans-say?}

#### Чтобы хорошо предсказывать следующий токен, LLM приходится понимать, как устроен мир. {#to-predict-the-next-token-well,-llms-need-to-learn-how-the-world-works.}
...
#### ИИ уже сейчас могут превзойти свои обучающие данные. И даже обходиться без человеческих. {#*-ais-can-already-surpass-their-training-data,-or-forego-human-data.}
...
### Будет ли ИИ неизбежно холодным, излишне логичным или лишённым некой важной искры? {#won’t-ais-inevitably-be-cold-and-logical,-or-otherwise-missing-some-crucial-spark?}
...
Говоря, что интеллект состоит из обыденных частей и что он доступен машинам, мы его не принижаем. См. наше подробное обсуждение [витализма](#special-behavior-is-built-out-of-mundane-parts).
...
Мы подробнее раскроем эту мысль в одном из дополнений к главе 3: «[Антропоморфизм и механоморфизм](#anthropomorphism-and-mechanomorphism)».

#### ИИ -- новые, интересные и странные сущности. {#ais-are-new,-interesting,-weird-entities.}
...
### Разве большие языковые модели не будут похожи на людей, на чьих данных они обучались? {#won’t-llms-be-like-the-humans-in-the-data-they’re-trained-on?}

#### Чтобы быть одним человеком и чтобы предсказывать многих нужны разные механизмы. {#*-there’s-a-difference-between-the-machinery-it-takes-to-be-one-person-and-the-machinery-it-takes-to-predict-many-individuals.}

(Это сокращённая версия более технического обсуждения. См. его ниже в разделе «[Притворяйся, пока не станешь](#"fake-it-'til-you-make-it").)
...
#### Архитектура больших языковых моделей сильно отличается от человеческой. {#the-architecture-of-llms-is-very-different-from-that-of-humans.}

В Главе 2 мы кратко обсудили, насколько LLM для нас чужды.

В Главе 4 мы подробнее рассмотрим, как у ИИ появляются очень странные предпочтения и стремления. Мы уже начали наблюдать это в реальном мире. Мы отправили книгу в печать, а число примеров всё растёт. Некоторые из них можно найти в [дополнении](#aren't-developers-regularly-making-their-ais-nice-and-safe-and-obedient?) к Главе 4.

### Как ИИ, обученный только на человеческих данных, может превзойти людей? {#how-could-an-ai-trained-only-on-human-data-surpass-humans?}

#### Может, изучив общие навыки и лучше их применяя. {#*-perhaps-by-learning-general-skills-and-implementing-them-better.}
...
#### И может сделать это любым другим подходящим способом. Это часто нужно для успеха, поэтому градиентный спуск найдёт как. {#perhaps-by-whatever-other-method-works.-success-often-requires-such-skills,-so-gradient-descent-will-find-them.}

Предсказание человеческих слов требует понимания мира. Мы это уже обсуждали в «[А ИИ разве не просто повторяют за людьми как попугаи?](#aren't-ais-only-able-to-parrot-back-what-humans-say?)».
...
### Почему вы думаете, что люди могут создать сверхчеловеческий ИИ, если они даже не понимают, что такое интеллект? {#what-makes-you-think-people-can-build-superhuman-ai-when-they-don’t-even-understand-intelligence?}

#### Предыдущие успехи в области ИИ не требовали глубокого понимания интеллекта. {#*-past-ai-progress-hasn’t-required-much-understanding-of-intelligence.}
...
#### Естественному отбору не нужно было «понимать» интеллект. {#natural-selection-didn’t-need-to-“understand”-intelligence.}
...
### Разве галлюцинации не показывают, что современные ИИ слабы? {#don’t-hallucinations-show-that-modern-ais-are-weak?}

#### Галлюцинации демонстрируют как неспособность, так и несогласованность. {#*-hallucinations-reveal-both-a-limitation-and-a-misalignment.}
...
#### Неясно, насколько сложно будет избавиться от галлюцинаций и как это расширит возможности ИИ. {#it’s-unclear-how-hard-it-will-be-to-get-rid-of-hallucinations,-or-how-much-this-will-boost-capabilities.}
...
См. также наше обсуждение того, как [эта область хорошо справляется с преодолением препятствий](#*-the-field-is-good-at-overcoming-obstacles.).

### А у нас не закончатся данные до того, как ИИ успеет полноценно развиться? Или электроэнергия? Или финансирование? {#but-won’t-we-run-out-of-data-before-ai-goes-all-the-way?-or-electrical-power?-or-funding?}
...
#### Не ждите новой «зимы ИИ». {#don’t-expect-another-“ai-winter.”}
...
### Смогут ли LLM развиться до суперинтеллекта? {#could-llms-advance-all-the-way-to-superintelligence?}

#### Это неясно. Но исследователи находят, как преодолеть их прежние ограничения. {#it-isn’t-clear,-but-researchers-are-finding-ways-to-overcome-old-llm-limitations.}
...
#### Другие подходы могут скоро дойти до суперинтеллекта, даже если LLM не преуспеют. {#*-other-approaches-may-achieve-superintelligence-soon,-even-if-llms-don’t.}

[Эта область хорошо справляется с преодолением препятствий.](#*-the-field-is-good-at-overcoming-obstacles.) Мы написали «*Если кто-то его сделает, все умрут*» не для того, чтобы предупредить конкретно об LLM. Мы предупреждаем о суперинтеллекте.
...
См. также расширенное обсуждение «[Зачем разбираться в LLM?](#what-good-does-knowledge-of-llms-do?)» ниже.

## Расширенное обсуждение {#extended-discussion-2}

### Интеллект постижим {#intelligence-isn’t-ineffable}
...
#### Заявления о непостижимости в науке почти всегда оказывались неверными {#claims-of-ineffability-have-an-extremely-poor-track-record-in-the-sciences}
...
#### Видно, что у интеллекта есть структура и закономерности. {#intelligence-exhibits-structure-and-regularities}
...
#### Мы ещё многое не поняли о *человеческом* интеллекте, что должно быть постижимо в принципе {#there’s-a-lot-we-don’t-yet-understand-about-human-intelligence-that-should-be-understandable-in-principle}
...
#### Уже есть некоторый прогресс {#there-has-already-been-some-progress-on-understanding-intelligence}
...
Конечно, важно *ещё* *и* то, что современному человечеству до этого достижения очень далеко. Но сам факт, что оно возможно, влияет на то, как нам следует выбираться из этой передряги. Подробнее об этом позже, в [расширенном обсуждении](#what-would-it-take-to-shut-down-global-ai-development?) к Главе 10.

#### «Очевидные» идеи приходят не сразу {#“obvious”-insights-take-time}
...
### Какая польза от знаний об LLM? {#what-good-does-knowledge-of-llms-do?}
...
Без алгоритма «трансформер» не существовало бы современных ИИ. Это был крупный прорыв. А совершили его всего несколько человек из Google. Следующий подобный прорыв может перевести, а может и не перевести ИИ за [критическую черту](#is-"intelligence"-a-simple-scalar-quantity?). Это легче понять, если вы представляете, что «трансформер» такое, насколько он прост и почему он так сильно повлиял на всю область.

Есть много дезинформации, рассчитанной на слушателя, не знающего, как работает ИИ. Некоторые [говорят](#do-experts-understand-what's-going-on-inside-ais?), будто люди понимают, что происходит внутри современных ИИ, хотя это не так. Другие говорят, что ИИ никогда не сможет быть опасным, потому что это «[просто математика](#aren't-ais-"just-math"?)», как будто существует непреодолимая пропасть между мышлением ИИ, основанным на [куче](#llms-are-large) «математики», и мышлением человека, основанным на куче «биохимии».
...
Мы надеемся, что описанное в «*Если кто-то его сделает, все умрут*» станет защитой от распространённых заблуждений и дезинформации. Для читателей, которым интересны подробности, [ниже](#a-full-description-of-an-llm) мы приводим более полный разбор работы одной конкретной LLM.
...
## Подробное описание LLM {#a-full-description-of-an-llm}

### Как работает Llama 3.1 405B {#how-llama-3.1-405b-works}

Ниже приведено обещанное в книге более подробное описание LLM под названием Llama 3.1 405B. Оно предназначено для любопытных, а также для того, чтобы по-настоящему понять, в какой степени современные ИИ скорее «выращивают», чем создают. (См. также: [Какая польза от знаний об LLM?](#what-good-does-knowledge-of-llms-do?))
...
[^1]: см. самый вопиющий из известных нам примеров рассмотрен в ответе на вопрос «[Понимают ли специалисты, что происходит внутри ИИ?](#do-experts-understand-what's-going-on-inside-ais?)».
...
[^15]: Новые архитектуры используют более сложные функции. Например, Llama 3.1, которую мы опишем [ниже](#a-full-description-of-an-llm), использует функцию «SwiGLU», сложную формулу, которую мы здесь приводить не будем. Её создатель сам не знает, почему она работает, и пишет: «Мы не предлагаем объяснения, почему эти архитектуры, по-видимому, работают. Мы приписываем их успех, как и всё остальное, божественной благодати».
