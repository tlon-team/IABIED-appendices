# Глава 11: Алхимия, а не наука {#глава-11:-алхимия,-а-не-наука}
...
## Часто задаваемые вопросы {#часто-задаваемые-вопросы-8}

### Да мы как-нибудь выкарабкаемся, как обычно. Почему нет? {#да-мы-как-нибудь-выкарабкаемся,-как-обычно.-почему-нет?}

#### Мир обычно «выкарабкивается» методом проб и ошибок. А тут ранние ошибки не оставят никого в живых. {#мир-обычно-«выкарабкивается»-методом-проб-и-ошибок.-а-тут-ранние-ошибки-не-оставят-никого-в-живых.}

См. Главу 10 и [расширенное обсуждение](#«до»-и-«после») в материалах к ней.

### Вы считаете, что согласование -- это «всё или ничего»? {#вы-считаете,-что-согласование----это-«всё-или-ничего»?}

#### Нет. Но «частичное согласование» скорее всего тоже приведёт к катастрофе. {#нет.-но-«частичное-согласование»-скорее-всего-тоже-приведёт-к-катастрофе.}

Один из доводов против беспокойства о суперинтеллекте звучит примерно так: «Развитие ИИ, вероятно, будет [постепенным](#а-что,-если-разрабатывать-ии-неспешно-и-так-же-плавно-внедрять-его-в-общество?). На каждом шаге мы сможем методом проб и ошибок научиться держать его в узде. Согласованию не обязательно быть *идеальным*, чтобы всё закончилось хорошо». (См. также раздел «А что если разрабатывать ИИ неспешно и так же плавно внедрять его в общество?» дополнительных материалов к Главе 10.) Мы не возлагаем на этот сценарий особых надежд. Вот несколько причин:

- Наши опасения не зависят от скорости прогресса. Мы не можем точно сказать, выйдет ли ИИ на плато на пути к суперинтеллекту. Это сложный вопрос. Наша лучшая догадка: у машинного интеллекта есть [пороговые эффекты](#легко-сказать,-что-люди-«обобщённее»-плодовых-мушек.-но-как-это-работает?). Но это лишь предположение. Наши аргументы [не строятся на нём](#а-что,-если-разрабатывать-ии-неспешно-и-так-же-плавно-внедрять-его-в-общество?). История Sable во второй части книги намеренно описывает катастрофу из-за ИИ, который не так уж сильно превосходит человеческий уровень. Отчасти для того, чтобы показать: враждебному ИИ не обязательно быстро становиться суперинтеллектом. Он может стать чрезвычайно опасным и без этого.

- На вопрос «А что если нам повезёт и будет куча времени на проверку идей согласования на достаточно слабых ИИ?» мы отвечаем в главе 10 и материалах ([«До» и «После»](#«до»-и-«после»)) к ней. Исследователи могут много чего выяснить о таких системах. Но ИИ, которые безопасно изучать, будут неизбежно критически отличаться от первых моделей, достаточно мощных для прохождения точки невозврата. Даже зрелой науке было бы очень сложно учесть все эти нюансы. А для области всё ещё на стадии алхимии, области, что работает с непостижимыми ИИ (которые выращивают, а не конструируют) -- вообще без шансов.

- Согласование ИИ не обязано быть идеальным для отличных долгосрочных результатов. В принципе, можно аккуратно создать ИИ с некоторой толерантностью к ошибкам. Если знать, что делаешь.[^1] Но это не значит, что «частично» или даже «в основном» согласованные системы приведут к нормальному исходу. ИИ по очень многим причинам может сейчас или в ближайшем будущем вести себя хорошо в 95% случаев, безо всяких гарантий счастливого исхода для человечества. Мы уже обсуждали эти причины с разных сторон в [онлайн-материалах к Главе 5](#глава-5:-его-любимые-вещи).
...
Более реалистичный сценарий: ИИ окажется «частично» согласованным в том смысле, что у него (как у нас) инструментальные стратегии [переплетутся с терминальными предпочтениями](#рефлексия-и-самомодификации-всё-усложняют). (См. «Рефлексия и самомодификации всё усложняют» в материалах к Главе 4.) Скажем, у него появится стремление, похожее на любопытство. И другое, похожее на [тягу к охране природы](#разве-ии-не-захочет,-чтобы-мы-были-счастливы-и-здоровы?-ради-сохранения-экологии-или-из-за-какого-то-похожего-стремления?). Кто-то посмотрит на это и скажет: «Гляньте! У модели развиваются очень человечные побуждения». Такой ИИ можно в некотором смысле назвать «частично» согласованным.

Но когда этот ИИ дорастёт до суперинтеллекта, ничего хорошего скорее всего не получится. Может, он потратит кучу ресурсов, [бессознательно](#потеря-будущего) преследуя свою странную версию любопытства. А человечество сохранит в отредактированном, более удовлетворительном для него виде. (Как многие защитники природы убрали бы из неё [малярийных комаров и причиняющих мучения паразитов](#разве-ии-не-захочет,-чтобы-мы-были-счастливы-и-здоровы?-ради-сохранения-экологии-или-из-за-какого-то-похожего-стремления?), имей они такую возможность). Тут опять уместно: процветающие люди -- [не самое эффективное решение](#счастливые,-здоровые,-свободные-люди----не-самое-эффективное-решение-почти-для-любой-задачи.) подавляющего большинства задач. (См. раздел «Посчитает ли ИИ полезным нас оставить?» материалов к Главе 5).

Или другой вариант: ценности ИИ приводят к очень гуманному поведению *в обучающей среде*. Люди радуются, он точно выглядит «частично согласованным». (Что происходит уже сейчас. Это [иллюзия](#а-разве-claude-не-подаёт-признаков-согласованности?). См. «А разве Claude не подаёт признаков согласованности?» в материалах к Главе 4). Но это мало говорит о том, как ИИ поведёт себя, получив куда более широкий простор для действий. Чтобы люди процветали *и тогда*, благополучие человечества должно быть частью *наиболее предпочтительного для ИИ исхода*.
...
Чтобы ИИ дал нам *хоть что-то*, он должен заботиться о нас именно так, как надо, хотя бы чуть-чуть. И большинство способов «слегка промахнуться» не такие. См. «[Неужели ИИ не будет хоть немного ценить людей?](#неужели-ии-не-будет-хоть-немного-ценить-людей?)» в материалах к Главе 5.

### А всё не станет получше, когда вмешается правительство? {#а-всё-не-станет-получше,-когда-вмешается-правительство?}

#### Смотря как, и как скоро вмешается. {#смотря-как,-и-как-скоро-вмешается.}
...
О том, какие меры властей реально могут предотвратить катастрофу, читайте в Главе 13 и разделе «[Почему бы международной коалиции не разработать безопасный ИИ совместно, а не запрещать?](#почему-бы-международной-коалиции-не-разработать-безопасный-ии-совместно,-а-не-запрещать?)» материалов к Главе 12.

### А самые безрассудные компании не оказываются одновременно самыми некомпетентными и потому неопасными? {#а-самые-безрассудные-компании-не-оказываются-одновременно-самыми-некомпетентными-и-потому-неопасными?}

#### Вообще говоря, нет. Пренебрежение правилами часто даёт преимущество. {#вообще-говоря,-нет.-пренебрежение-правилами-часто-даёт-преимущество.}
...
### А разве не нужно спешить из-за «опережения по железу» («hardware overhang»)? {#а-разве-не-нужно-спешить-из-за-«опережения-по-железу»-(«hardware-overhang»)?}

#### Это самоубийство. Мы слишком далеки от решения задачи согласования. {#это-самоубийство.-мы-слишком-далеки-от-решения-задачи-согласования.}
...
Нам этот довод кажется весьма слабым. Одна из проблем: интеллект, вероятно, подвержен [пороговым эффектам](#легко-сказать,-что-люди-«обобщённее»-плодовых-мушек.-но-как-это-работает?).
...
Это наглядный пример того, как боссы ИИ-компаний хватаются за любой довод, оправдывающий спешку. Большинство таких аргументов не выдерживают критики. Мы [не советуем](#рабочие-планы-будут-подразумевать-отказы-ии-компаниям) доверять им лишь потому, что они исходят от руководителя корпорации. (См. также раздел «Рабочие планы будут подразумевать отказы ИИ-компаниям» материалов к Главе 12.)

### А нам не нужно мчаться вперёд, чтобы можно было исследовать согласование? {#а-нам-не-нужно-мчаться-вперёд,-чтобы-можно-было-исследовать-согласование?}

#### Мы выступаем против всей нынешней парадигмы ИИ. {#мы-выступаем-против-всей-нынешней-парадигмы-ии.}
...
### А что если компании будут использовать ИИ только для безопасных задач? {#а-что-если-компании-будут-использовать-ии-только-для-безопасных-задач?}

#### Даже вроде бы безобидные действия могут требовать опасных способностей. {#даже-вроде-бы-безобидные-действия-могут-требовать-опасных-способностей.}
...
#### Мы не видим вариантов использования ИИ, которые радикально всё бы меняли, но не требовали прорывов в согласовании. {#мы-не-видим-вариантов-использования-ии,-которые-радикально-всё-бы-меняли,-но-не-требовали-прорывов-в-согласовании.}
...
### Почему бы просто не читать мысли ИИ? {#почему-бы-просто-не-читать-мысли-ии?}

#### Их трудно прочесть. {#их-трудно-прочесть.}
...
Первая проблема -- мы пока плохо читаем мысли ИИ. Специалисты, изучающие внутренности ИИ, пока бесконечно далеки от такого уровня понимания. Они [прямо об этом говорят](#понимают-ли-специалисты,-что-происходит-внутри-ии?) (см. раздел «Понимают ли специалисты, что происходит внутри ИИ?» материалов к Главе 2).
...
#### Мы бы не знали, что делать, поймав ИИ на опасных мыслях. {#мы-бы-не-знали,-что-делать,-поймав-ии-на-опасных-мыслях.}
...
У ИИ буду механизмы, умеющие находить эффективные решения в самых разных областях. Они наверняка заметят и возможность обхитрить операторов. (см. раздел «[Глубинные механизмы направления](#глубинные-механизмы-направления)» в материалах к Главе 3).
...
Они склонны уверенно «[галлюцинировать](#разве-галлюцинации-не-показывают,-что-современные-ии-слабы?)». А ни один инженер даже близко не понимает, какие механизмы за этим стоят. Ни у кого нет такой точности понимания, чтобы залезть внутрь ИИ и вытащить «галлюцинирующие» части (если это вообще возможно).

Вытащить «лживые» части [ещё сложнее](#глубинные-механизмы-направления).
...
Мы (Юдковский и Соарес) занялись задачей согласования ИИ ещё до того, как стало ясно -- градиентный спуск победит. В ИИ тогда ничего толком не работало. И была надежда: создавая интеллект, человечество поймёт, как он устроен. Но *даже тогда* мы ожидали, что согласование будет сложным (причин много, например, [самомодификация](#рефлексия-и-самомодификации-всё-усложняют)). Чтение мыслей ИИ приблизило бы нас к чуть более простой задаче -- согласованию *понятного* нам разума. Но это лишь шаг. Читать мысли -- не значит понимать разум в деталях или знать, как его изменить. Это полезно. Но это не решение проблемы. Мы не думаем, что сейчас есть доступные технические решения. А значит, человечеству нужно просто отступить. [^7]

См. также раздел «[Тревожные сигналы бесполезны, если не знать, что с ними делать](#тревожные-сигналы-бесполезны,-если-не-знать,-что-с-ними-делать.)» ниже.

### А если заставить ИИ спорить, конкурировать или присматривать друг за другом? {#а-если-заставить-ии-спорить,-конкурировать-или-присматривать-друг-за-другом?}

#### Став достаточно умными, ИИ, вероятно, сговорятся. {#став-достаточно-умными,-ии,-вероятно,-сговорятся.}
...
Многие хитрые схемы строятся на [чтении мыслей одного ИИ другим](https://openai.com/index/chain-of-thought-monitoring/). Например, можно потребовать у одного ИИ доносить на другой, если тот халтурит и не пытается (скажем) [решить](#подробнее-о-передаче-задачи-ии) задачу согласования суперинтеллекта (см. раздел «Подробнее о передаче задачи ИИ» ниже).
...
Да и без этого, -- остаются прежние проблемы. [Ну, поймали вы ИИ на жульничестве, и что дальше?](#их-трудно-прочесть.) [Тревожные сигналы бесполезны, если не знать, что с ними делать](#тревожные-сигналы-бесполезны,-если-не-знать,-что-с-ними-делать.) (см. раздел ниже).
...
На наш взгляд, это уже звучит безумно. Погружение в детали ситуацию не спасает. Совсем не похоже, что человечество сможет провернуть такое [с первой попытки](#«до»-и-«после»). Учиться на ошибках нам никто не даст.

### А как насчёт других планов по согласованию ИИ? {#а-как-насчёт-других-планов-по-согласованию-ии?}

#### Другие предложения по согласованию мы разбираем в книге. {#другие-предложения-по-согласованию-мы-разбираем-в-книге.}

А ещё см. расширенное обсуждение ниже. Там мы подробнее разбираем идеи «[ИИ, который стремится к истине](#подробнее-об-ии,-который-«стремится-к-истине»)», «[Покорного ИИ](#подробнее-о-«покорном»-ии)» и [использования ИИ для решения согласования](#подробнее-о-передаче-задачи-ии).

### А у исследователей не будет ранних предупреждений о проблемах? {#а-у-исследователей-не-будет-ранних-предупреждений-о-проблемах?}

#### Тревожные сигналы бесполезны, если не знать, что с ними делать. {#тревожные-сигналы-бесполезны,-если-не-знать,-что-с-ними-делать.}

В материалах к Главе 2 (раздел «Но ведь некоторые ИИ отчасти мыслят на английском. Разве это не помогает?») мы рассматривали проблематичность идеи полагаться на тревожные сигналы в [человекочитаемых «цепочках мыслей»](#но-ведь-некоторые-ии-отчасти-мыслят-на-английском.-разве-это-не-помогает?) (chain-of-thought), которые генерируют некоторые рассуждающие модели.
...
(Здесь напрашивается параллель с нынешней ситуацией в ИИ-исследованиях. Ранние предупреждения [игнорируются](#эффект-лемуана). Обеспокоенных сотрудников [увольняют под надуманными предлогами](https://www.transformernews.ai/p/openai-employee-says-he-was-fired) или они [решают, что с них хватит, и уходят сами](https://www.vox.com/future-perfect/2024/5/17/24158403/openai-resignations-ai-safety-ilya-sutskever-jan-leike-artificial-intelligence). Инсайдеры [пишут открытые письма, пытаясь достучаться до общественности](https://righttowarn.ai/).)
...
#### Пока что ИИ -- не такая зрелая инженерная дисциплина, которая смогла бы справиться с этой задачей. {#пока-что-ии----не-такая-зрелая-инженерная-дисциплина,-которая-смогла-бы-справиться-с-этой-задачей.}
...
## Расширенное обсуждение {#расширенное-обсуждение-9}

### Подробнее о планах, которые мы раскритиковали в книге {#подробнее-о-планах,-которые-мы-раскритиковали-в-книге}

#### Подробнее об ИИ, который «стремится к истине» {#подробнее-об-ии,-который-«стремится-к-истине»}
...
А даже если бы и влияло. Ведь xAI уткнулись бы в другую проблему, которую мы тоже обсуждали. Искусственный суперинтеллект, *действительно* ставящий истину превыше всего, нёс бы гибель. Ведь счастливые, здоровые и свободные люди -- [не самый эффективный метод](#счастливые,-здоровые,-свободные-люди----не-самое-эффективное-решение-почти-для-любой-задачи.) поиска и добычи истин (см. раздел «Счастливые, здоровые, свободные люди -- не самое эффективное решение почти для любой задачи» в материалах к Главе 5).

#### Подробнее о «покорном» ИИ {#подробнее-о-«покорном»-ии}
...
Всё это *уже* не так. Вспомните «Truth Terminal» из шестой главы. Его подключили к сети, запустили в автономном цикле и пустили в Твиттер писать всё, что в голову взбредёт. Или возьмём «Эпоху Агентов», о которой столько [говорят](#компании-стараются-наделить-ии-агентностью.) в 2025 году (см. ссылки в разделе «Компании стараются наделить ИИ агентностью» материалов к Главе 3).
...
Компании будут дальше обучать свои ИИ вести себя полезно и дружелюбно (или хотя бы не позорить создателей). Пока что ИИ большую часть времени выглядят удобными и «покорными». Но не иссякает поток громких сбоев (вроде Sidney, которую мы обсуждали в второй главе, или «[МехаГитлера](#подробнее-об-ии,-который-«стремится-к-истине»)»). А странного [поведения](#но-ведь-разработчики-на-практике-делают-ии-хорошими,-безопасными-и-послушными?) в нестандартных случаях, вплоть до вызова [психозов](#ии-психоз), и вовсе море (см. разделы «Но ведь разработчики на практике делают ИИ хорошими, безопасными и послушными?» и «ИИ-психоз» материалов к Главе 4).
...
Допустим, ИИ-компания обращает внимание на тревожные звоночки (что, увы, бывает редко). Но, как мы уже обсуждали выше, *заметить*, что ИИ предлагает план с подставой -- не то же самое, что [заставить его *прекратить*](#а-у-исследователей-не-будет-ранних-предупреждений-о-проблемах?). Разработчики могут требовать у ИИ идеи, пока они не станут такими сложными, что люди больше не будут видеть в них изъяны. Но это не значит, что изъяны исчезнут.

Если разработчикам сильно повезёт, они смогут [прочитать «мысли» ИИ](#почему-бы-просто-не-читать-мысли-ии?). Увидеть явные сигналы, что нельзя доверять ему исследования согласования. Они заметят, скажем, что он прикидывает, какие части плана люди скорее всего не поймут.
...
#### Не думайте, будто лаборатории втайне знают, что делают {#не-думайте,-будто-лаборатории-втайне-знают,-что-делают}
...
### Мы знаем, как выглядит серьёзное отношение к задаче. Тут не так. {#мы-знаем,-как-выглядит-серьёзное-отношение-к-задаче.-тут-не-так.}
...
Не поймите нас неправильно. Мы считаем оценку Амодея в «10--25 процентов» смехотворно *оптимистичной*. Задача слишком сложна. А у людей [нет права на ошибку](#с-ии-всё-иначе,-потому-что-второго-шанса-не-будет.). Но даже это -- *безумие*.
...
Тем временем ИИ выдают [всё больше тревожных сигналов](#цели-ии-нам-чужды.-направление,-куда-они-тянут,-лишь-более-менее-совпадает-с-тем,-что-нам-надо.). А лаборатории всё прут вперед и твердят, что, *наверное*, как-нибудь да обойдётся. (См. раздел «Но ведь разработчики на практике делают ИИ хорошими, безопасными и послушными?» материалов к Главе 4.)
...
### Кнопки выключения и исправимость {#кнопки-выключения-и-исправимость}

#### Умные ИИ сопротивляются изменению своих целей {#умные-ии-сопротивляются-изменению-своих-целей}
...
Короткий ответ: по умолчанию -- нет. (См. раздел «[Глубинные механизмы направления](#глубинные-механизмы-направления)» материалов к Главе 3). Но можно ли *создать* ИИ, который позволит разработчикам менять себя и исправлять ошибки, даже если сам он [их не признаёт](#ортогональность:-у-ии-может-быть-почти-любая-цель)-any-goal) (см. раздел «Ортогональность: у ИИ может быть (почти) любая цель» материалов к Главе 5)?
...
Вот и ИИ со сложными и развивающимися предпочтениями захочет, чтобы они развивались [своим путем](#рефлексия-и-самомодификации-всё-усложняют). А не чтобы их заменили на более симпатичные для людей.
...
#### Уроки из окопов {#уроки-из-окопов}
...
[^1]: Почему крайне важно понимать, что вы делаете, см. в разделе «[Глубинные механизмы направления](#глубинные-механизмы-направления)» материалов к Главе 3 и разделах «„Умный” (обычно) значит „неисправимый”» и «[Трудно добиться надёжной лени](#трудно-добиться-надёжной-лени)» материалов к Главе 5.

[^2]: См. раздел «[Неужели ИИ не будет хоть немного ценить людей?](#неужели-ии-не-будет-хоть-немного-ценить-людей?)» материалов к Главе 5.
