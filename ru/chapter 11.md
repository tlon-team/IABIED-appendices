# Глава 11: Алхимия, а не наука {#chapter-11:-an-alchemy,-not-a-science}
...
### Да мы как-нибудь выкарабкаемся, как обычно. Почему нет? {#won’t-we-just-muddle-through,-like-always?}

#### Мир обычно «выкарабкивается» методом проб и ошибок. А тут ранние ошибки не оставят никого в живых. {#the-world-usually-muddles-through-by-trial-and-error.-in-this-case,-early-errors-wouldn’t-leave-survivors.}

См. Главу 10 и [расширенное обсуждение](#a-closer-look-at-before-and-after) в материалах к ней.

### Вы считаете, что согласование -- это «всё или ничего»? {#do-you-see-alignment-as-all-or-nothing?}

#### Нет. Но «частичное согласование» скорее всего тоже приведёт к катастрофе. {#no.-but-“partial-alignment”-is-still-likely-to-be-catastrophic.}

Один из доводов против беспокойства о суперинтеллекте звучит примерно так: «Развитие ИИ, вероятно, будет [постепенным](#what-if-ai-is-developed-only-slowly,-and-it-slowly-integrates-with-society?). На каждом шаге мы сможем методом проб и ошибок научиться держать его в узде. Согласованию не обязательно быть *идеальным*, чтобы всё закончилось хорошо». (См. также раздел «А что если разрабатывать ИИ неспешно и так же плавно внедрять его в общество?» дополнительных материалов к Главе 10.) Мы не возлагаем на этот сценарий особых надежд. Вот несколько причин:

- Наши опасения не зависят от скорости прогресса. Мы не можем точно сказать, выйдет ли ИИ на плато на пути к суперинтеллекту. Это сложный вопрос. Наша лучшая догадка: у машинного интеллекта есть [пороговые эффекты](#is-"intelligence"-a-simple-scalar-quantity?). Но это лишь предположение. Наши аргументы [не строятся на нём](#what-if-ai-is-developed-only-slowly,-and-it-slowly-integrates-with-society?). История Sable во второй части книги намеренно описывает катастрофу из-за ИИ, который не так уж сильно превосходит человеческий уровень. Отчасти для того, чтобы показать: враждебному ИИ не обязательно быстро становиться суперинтеллектом. Он может стать чрезвычайно опасным и без этого.

- На вопрос «А что если нам повезёт и будет куча времени на проверку идей согласования на достаточно слабых ИИ?» мы отвечаем в главе 10 и материалах ([«До» и «После»](#a-closer-look-at-before-and-after)) к ней. Исследователи могут много чего выяснить о таких системах. Но ИИ, которые безопасно изучать, будут неизбежно критически отличаться от первых моделей, достаточно мощных для прохождения точки невозврата. Даже зрелой науке было бы очень сложно учесть все эти нюансы. А для области всё ещё на стадии алхимии, области, что работает с непостижимыми ИИ (которые выращивают, а не конструируют) -- вообще без шансов.

- Согласование ИИ не обязано быть идеальным для отличных долгосрочных результатов. В принципе, можно аккуратно создать ИИ с некоторой толерантностью к ошибкам. Если знать, что делаешь.[^1] Но это не значит, что «частично» или даже «в основном» согласованные системы приведут к нормальному исходу. ИИ по очень многим причинам может сейчас или в ближайшем будущем вести себя хорошо в 95% случаев, безо всяких гарантий счастливого исхода для человечества. Мы уже обсуждали эти причины с разных сторон в [онлайн-материалах к Главе 5](#chapter-5:-its-favorite-things).
...
Более реалистичный сценарий: ИИ окажется «частично» согласованным в том смысле, что у него (как у нас) инструментальные стратегии [переплетутся с терминальными предпочтениями](#reflection-and-self-modification-make-it-all-harder). (См. «Рефлексия и самомодификации всё усложняют» в материалах к Главе 4.) Скажем, у него появится стремление, похожее на любопытство. И другое, похожее на [тягу к охране природы](#won't-ai-want-to-keep-us-happy-and-healthy-for-the-sake-of-ecological-preservation-or-some-similar-drive?). Кто-то посмотрит на это и скажет: «Гляньте! У модели развиваются очень человечные побуждения». Такой ИИ можно в некотором смысле назвать «частично» согласованным.

Но когда этот ИИ дорастёт до суперинтеллекта, ничего хорошего скорее всего не получится. Может, он потратит кучу ресурсов, [бессознательно](#losing-the-future) преследуя свою странную версию любопытства. А человечество сохранит в отредактированном, более удовлетворительном для него виде. (Как многие защитники природы убрали бы из неё [малярийных комаров и причиняющих мучения паразитов](#won't-ai-want-to-keep-us-happy-and-healthy-for-the-sake-of-ecological-preservation-or-some-similar-drive?), имей они такую возможность). Тут опять уместно: процветающие люди -- [не самое эффективное решение](#happy,-healthy,-free-people-aren't-the-most-efficient-solution-to-almost-any-problem.) подавляющего большинства задач. (См. раздел «Посчитает ли ИИ полезным нас оставить?» материалов к Главе 5).

Или другой вариант: ценности ИИ приводят к очень гуманному поведению *в обучающей среде*. Люди радуются, он точно выглядит «частично согласованным». (Что происходит уже сейчас. Это [иллюзия](#doesn't-the-claude-chatbot-show-signs-of-being-aligned?). См. «А разве Claude не подаёт признаков согласованности?» в материалах к Главе 4). Но это мало говорит о том, как ИИ поведёт себя, получив куда более широкий простор для действий. Чтобы люди процветали *и тогда*, благополучие человечества должно быть частью *наиболее предпочтительного для ИИ исхода*.
...
Чтобы ИИ дал нам *хоть что-то*, он должен заботиться о нас именно так, как надо, хотя бы чуть-чуть. И большинство способов «слегка промахнуться» не такие. См. «[Неужели ИИ не будет хоть немного ценить людей?](#won't-ais-care-at-least-a-little-about-humans?)» в материалах к Главе 5.

### А всё не станет получше, когда вмешается правительство? {#won’t-the-situation-get-better-once-governments-get-more-involved?}

#### Смотря как, и как скоро вмешается. {#it-depends-on-how-(and-how-soon)-they-get-involved.}
...
О том, какие меры властей реально могут предотвратить катастрофу, читайте в Главе 13 и разделе «[Почему бы международной коалиции не разработать безопасный ИИ совместно, а не запрещать?](#why-not-use-international-cooperation-to-build-ai-safely,-rather-than-to-shut-it-all-down?)» материалов к Главе 12.

### А самые безрассудные компании не оказываются одновременно самыми некомпетентными и потому неопасными? {#won’t-the-most-reckless-companies-naturally-be-the-most-incompetent,-and-thus-not-a-threat?}

#### Вообще говоря, нет. Пренебрежение правилами часто даёт преимущество. {#not-in-general.-corner-cutting-is-often-competitive.}
...
### А разве не нужно спешить из-за «опережения по железу» («hardware overhang»)? {#isn’t-it-important-to-race-ahead-because-of-“hardware-overhang”?}

#### Это самоубийство. Мы слишком далеки от решения задачи согласования. {#that-would-be-suicidal,-because-we’re-too-far-from-an-alignment-solution.}
...
Нам этот довод кажется весьма слабым. Одна из проблем: интеллект, вероятно, подвержен [пороговым эффектам](#is-"intelligence"-a-simple-scalar-quantity?).
...
Это наглядный пример того, как боссы ИИ-компаний хватаются за любой довод, оправдывающий спешку. Большинство таких аргументов не выдерживают критики. Мы [не советуем](#workable-plans-will-involve-telling-ai-companies-"no.") доверять им лишь потому, что они исходят от руководителя корпорации. (См. также раздел «Рабочие планы будут подразумевать отказы ИИ-компаниям» материалов к Главе 12.)

### А нам не нужно мчаться вперёд, чтобы можно было исследовать согласование? {#isn’t-it-important-to-race-ahead-so-we-can-do-alignment-research?}

#### Мы выступаем против всей нынешней парадигмы ИИ. {#*-we-strongly-recommend-against-this-entire-ai-paradigm.}
...
### А что если компании будут использовать ИИ только для безопасных задач? {#what-if-ai-companies-only-deploy-their-ais-for-non-dangerous-actions?}

#### Даже вроде бы безобидные действия могут требовать опасных способностей. {#*-actions-that-seem-benign-can-still-require-dangerous-capabilities.}
...
#### Мы не видим вариантов использования ИИ, которые радикально всё бы меняли, но не требовали прорывов в согласовании. {#we-don’t-see-game-changing-ai-uses-that-require-no-alignment-breakthroughs.}
...
### Почему бы просто не читать мысли ИИ? {#why-not-just-read-the-ai’s-thoughts?}

#### Их трудно прочесть. {#*-their-thoughts-are-hard-to-read.}
...
Первая проблема -- мы пока плохо читаем мысли ИИ. Специалисты, изучающие внутренности ИИ, пока бесконечно далеки от такого уровня понимания. Они [прямо об этом говорят](#do-experts-understand-what's-going-on-inside-ais?) (см. раздел «Понимают ли специалисты, что происходит внутри ИИ?» материалов к Главе 2).
...
#### Мы бы не знали, что делать, поймав ИИ на опасных мыслях. {#we-wouldn’t-know-what-to-do-if-we-caught-one-having-dangerous-thoughts.}
...
У ИИ буду механизмы, умеющие находить эффективные решения в самых разных областях. Они наверняка заметят и возможность обхитрить операторов. (см. раздел «[Глубинные механизмы направления](#deep-machinery-of-steering)» в материалах к Главе 3).
...
Они склонны уверенно «[галлюцинировать](#don't-hallucinations-show-that-modern-ais-are-weak?)». А ни один инженер даже близко не понимает, какие механизмы за этим стоят. Ни у кого нет такой точности понимания, чтобы залезть внутрь ИИ и вытащить «галлюцинирующие» части (если это вообще возможно).

Вытащить «лживые» части [ещё сложнее](#deep-machinery-of-steering).
...
Мы (Юдковский и Соарес) занялись задачей согласования ИИ ещё до того, как стало ясно -- градиентный спуск победит. В ИИ тогда ничего толком не работало. И была надежда: создавая интеллект, человечество поймёт, как он устроен. Но *даже тогда* мы ожидали, что согласование будет сложным (причин много, например, [самомодификация](#reflection-and-self-modification-make-it-all-harder)). Чтение мыслей ИИ приблизило бы нас к чуть более простой задаче -- согласованию *понятного* нам разума. Но это лишь шаг. Читать мысли -- не значит понимать разум в деталях или знать, как его изменить. Это полезно. Но это не решение проблемы. Мы не думаем, что сейчас есть доступные технические решения. А значит, человечеству нужно просто отступить. [^7]

См. также раздел «[Тревожные сигналы бесполезны, если не знать, что с ними делать](#*-warning-signs-don't-help-if-you-don't-know-what-to-do-with-them.)» ниже.

### А если заставить ИИ спорить, конкурировать или присматривать друг за другом? {#what-if-we-made-ais-debate,-compete-with,-or-oversee-each-other?}

#### Став достаточно умными, ИИ, вероятно, сговорятся. {#if-the-ais-get-smart-enough-to-matter,-they-likely-collude.}
...
Да и без этого, -- остаются прежние проблемы. [Ну, поймали вы ИИ на жульничестве, и что дальше?](#*-their-thoughts-are-hard-to-read.) [Тревожные сигналы бесполезны, если не знать, что с ними делать](#*-warning-signs-don't-help-if-you-don't-know-what-to-do-with-them.) (см. раздел ниже).
...
На наш взгляд, это уже звучит безумно. Погружение в детали ситуацию не спасает. Совсем не похоже, что человечество сможет провернуть такое [с первой попытки](#a-closer-look-at-before-and-after). Учиться на ошибках нам никто не даст.

### А как насчёт других планов по согласованию ИИ? {#what-about-various-other-ai-alignment-plans?}

#### Другие предложения по согласованию мы разбираем в книге. {#we-cover-additional-alignment-proposals-in-the-book.}

А ещё см. расширенное обсуждение ниже. Там мы подробнее разбираем идеи «[ИИ, который стремится к истине](#more-on-making-ai-that-is-"truth-seeking")», «[Покорного ИИ](#more-on-making-ai-that-is-"submissive")» и [использования ИИ для решения согласования](#more-on-making-ais-solve-the-problem).

### А у исследователей не будет ранних предупреждений о проблемах? {#won’t-there-be-early-warnings-researchers-can-use-to-identify-problems?}

#### Тревожные сигналы бесполезны, если не знать, что с ними делать. {#*-warning-signs-don’t-help-if-you-don’t-know-what-to-do-with-them.}

В материалах к Главе 2 (раздел «Но ведь некоторые ИИ отчасти мыслят на английском. Разве это не помогает?») мы рассматривали проблематичность идеи полагаться на тревожные сигналы в [человекочитаемых «цепочках мыслей»](#but-some-ais-partly-think-in-english-—-doesn't-that-help?) (chain-of-thought), которые генерируют некоторые рассуждающие модели.
...
(Здесь напрашивается параллель с нынешней ситуацией в ИИ-исследованиях. Ранние предупреждения [игнорируются](#the-lemoine-effect). Обеспокоенных сотрудников [увольняют под надуманными предлогами](https://www.transformernews.ai/p/openai-employee-says-he-was-fired) или они [решают, что с них хватит, и уходят сами](https://www.vox.com/future-perfect/2024/5/17/24158403/openai-resignations-ai-safety-ilya-sutskever-jan-leike-artificial-intelligence). Инсайдеры [пишут открытые письма, пытаясь достучаться до общественности](https://righttowarn.ai/).)
...
#### Пока что ИИ -- не такая зрелая инженерная дисциплина, которая смогла бы справиться с этой задачей. {#ai-is-not-the-kind-of-mature-engineering-field-that’s-equipped-for-this-kind-of-problem.}
...
## Расширенное обсуждение {#extended-discussion-9}

### Подробнее о планах, которые мы раскритиковали в книге {#more-on-some-of-the-plans-we-critiqued-in-the-book}

#### Подробнее об ИИ, который «стремится к истине» {#more-on-making-ai-that-is-“truth-seeking”}
...
А даже если бы и влияло. Ведь xAI уткнулись бы в другую проблему, которую мы тоже обсуждали. Искусственный суперинтеллект, *действительно* ставящий истину превыше всего, нёс бы гибель. Ведь счастливые, здоровые и свободные люди -- [не самый эффективный метод](#happy,-healthy,-free-people-aren't-the-most-efficient-solution-to-almost-any-problem.) поиска и добычи истин (см. раздел «Счастливые, здоровые, свободные люди -- не самое эффективное решение почти для любой задачи» в материалах к Главе 5).

#### Подробнее о «покорном» ИИ {#more-on-making-ai-that-is-“submissive”}
...
Всё это *уже* не так. Вспомните «Truth Terminal» из шестой главы. Его подключили к сети, запустили в автономном цикле и пустили в Твиттер писать всё, что в голову взбредёт. Или возьмём «Эпоху Агентов», о которой столько [говорят](#the-labs-are-trying-to-make-ais-agentic.) в 2025 году (см. ссылки в разделе «Компании стараются наделить ИИ агентностью» материалов к Главе 3).
...
Компании будут дальше обучать свои ИИ вести себя полезно и дружелюбно (или хотя бы не позорить создателей). Пока что ИИ большую часть времени выглядят удобными и «покорными». Но не иссякает поток громких сбоев (вроде Sidney, которую мы обсуждали в второй главе, или «[МехаГитлера](#more-on-making-ai-that-is-"truth-seeking")»). А странного [поведения](#aren't-developers-regularly-making-their-ais-nice-and-safe-and-obedient?) в нестандартных случаях, вплоть до вызова [психозов](#ai-induced-psychosis), и вовсе море (см. разделы «Но ведь разработчики на практике делают ИИ хорошими, безопасными и послушными?» и «ИИ-психоз» материалов к Главе 4).
...
Допустим, ИИ-компания обращает внимание на тревожные звоночки (что, увы, бывает редко). Но, как мы уже обсуждали выше, *заметить*, что ИИ предлагает план с подставой -- не то же самое, что [заставить его *прекратить*](#won't-there-be-early-warnings-researchers-can-use-to-identify-problems?). Разработчики могут требовать у ИИ идеи, пока они не станут такими сложными, что люди больше не будут видеть в них изъяны. Но это не значит, что изъяны исчезнут.

Если разработчикам сильно повезёт, они смогут [прочитать «мысли» ИИ](#why-not-just-read-the-ai's-thoughts?). Увидеть явные сигналы, что нельзя доверять ему исследования согласования. Они заметят, скажем, что он прикидывает, какие части плана люди скорее всего не поймут.
...
#### Не думайте, будто лаборатории втайне знают, что делают {#don’t-assume-labs-secretly-know-what-they’re-doing}
...
### Мы знаем, как выглядит серьёзное отношение к задаче. Тут не так. {#we-know-what-it-looks-like-when-a-problem-is-being-treated-with-respect,-and-this-isn’t-it}
...
Не поймите нас неправильно. Мы считаем оценку Амодея в «10--25 процентов» смехотворно *оптимистичной*. Задача слишком сложна. А у людей [нет права на ошибку](#ai-is-different-because-we-get-no-second-chance.). Но даже это -- *безумие*.
...
Тем временем ИИ выдают [всё больше тревожных сигналов](#*-ais-steer-in-alien-directions-that-only-mostly-coincide-with-helpfulness.). А лаборатории всё прут вперед и твердят, что, *наверное*, как-нибудь да обойдётся. (См. раздел «Но ведь разработчики на практике делают ИИ хорошими, безопасными и послушными?» материалов к Главе 4.)
...
### Кнопки выключения и исправимость {#shutdown-buttons-and-corrigibility}

#### Умные ИИ сопротивляются изменению своих целей {#smart-ais-resist-having-their-goals-overwritten}
...
Короткий ответ: по умолчанию -- нет. (См. раздел «[Глубинные механизмы направления](#deep-machinery-of-steering)» материалов к Главе 3). Но можно ли *создать* ИИ, который позволит разработчикам менять себя и исправлять ошибки, даже если сам он [их не признаёт](#orthogonality:-ais-can-have-(almost)-any-goal) (см. раздел «Ортогональность: у ИИ может быть (почти) любая цель» материалов к Главе 5)?
...
Вот и ИИ со сложными и развивающимися предпочтениями захочет, чтобы они развивались [своим путем](#reflection-and-self-modification-make-it-all-harder). А не чтобы их заменили на более симпатичные для людей.
...
#### Уроки из окопов {#lessons-from-the-trenches}
...
[^1]: Почему крайне важно понимать, что вы делаете, см. в разделе «[Глубинные механизмы направления](#deep-machinery-of-steering)» материалов к Главе 3 и разделах «„Умный” (обычно) значит „неисправимый”» и «[Трудно добиться надёжной лени](#it's-hard-to-get-robust-laziness)» материалов к Главе 5.

[^2]: См. раздел «[Неужели ИИ не будет хоть немного ценить людей?](#won't-ais-care-at-least-a-little-about-humans?)» материалов к Главе 5.
