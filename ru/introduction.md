# Введение: Что сложно, а что просто {#introduction:-hard-calls-and-easy-calls}
...
### Зачем писать книгу об угрозе вымирания от сверхчеловеческого ИИ? {#why-write-a-book-about-superhuman-ai-as-an-extinction-threat?}

#### Потому что ситуация действительно кажется серьезной и неотложной. {#because-the-situation-seems-genuinely-serious-and-urgent.}
...
Ведущие ученые в области ИИ вместе подписали открытое [письмо](https://aistatement.com/). Они предупреждают общественность, что эту угрозу следует рассматривать как «глобальный приоритет, наряду с другими глобальными рисками, такими как пандемии и ядерная война». Такое беспокойство --- не редкость. Его разделяет [почти половина специалистов](#ai-experts-on-catastrophe-scenarios) (см. ниже «Эксперты по ИИ о катастрофических сценариях»). Мы надеемся, что даже если вы изначально настроены скептически, то такие заявления со стороны экспертов и высокие ставки, если их опасения верны, ясно показывают, что тема заслуживает серьезного обсуждения.
...
### Вы думаете, что ChatGPT может нас всех убить? {#are-you-suggesting-that-chatgpt-could-kill-us-all?}

#### Нет. Мы беспокоимся о будущих достижениях в области ИИ. {#no.-the-worry-is-about-forthcoming-advances-in-ai.}
...
### Но люди же постоянно паникуют и слишком остро реагируют на происходящее? {#aren’t-people-always-panicking-and-overreacting-to-things?}

#### Да. Но это не значит, что опасности нет. {#yes.-but-this-doesn’t-mean-that-nothing-is-ever-actually-dangerous.}
...
### Когда будут разработаны эти тревожащие ИИ? {#when-is-this-worrisome-sort-of-ai-going-to-be-developed?}

#### Знание о том, что технология грядёт, не говорит, когда именно она появится. {#*-knowing-that-a-technology-is-coming-doesn’t-grant-knowledge-of-exactly-when-it’s-coming.}
...
#### Экспертов постоянно удивляет, как быстро ИИ развивается. {#experts-keep-being-surprised-by-how-fast-ai-progress-happens.}
...
#### К заявлениям СМИ о том, что может и не может скоро произойти, лучше относиться скептически. (Возможно, это уже произошло!) {#be-suspicious-of-media-claims-about-what-can-and-can’t-happen-soon.-(it-may-have-already-happened!)}
...
### Можно ли по прошлому экстраполировать, когда мы создадим ИИ умнее человека? {#can-we-use-past-progress-to-extrapolate-when-we’ll-build-smarter-than-human-ai?}

#### Для этого у нас недостаточно понимания интеллекта. {#we-don’t-have-a-good-enough-understanding-of-intelligence-for-that.}
...
### Чем мотивированы авторы? Нет ли у них конфликта интересов? {#what-are-your-incentives-and-conflicts-of-interest,-as-authors?}

#### В среднем мы не ожидаем заработать на книге. И ещё -- мы будем рады, если её тезис ошибочен. {#we-don’t-expect-to-make-any-money-from-the-book-in-the-average-case.-separately,-we-would-love-to-be-wrong-about-the-book’s-thesis.}
...
### Разве всё это про ИИ -- не просто научная фантастика? {#isn’t-this-ai-stuff-just-science-fiction?}

#### Распространённость темы в художественной литературе не особо о чём-то говорит. {#*-we-can’t-learn-much-from-a-topic’s-prevalence-in-fiction.}
...
#### У ИИ точно будут странные последствия. {#the-consequences-of-ai-are-inevitably-going-to-be-weird.}
...
![](./IABIED_supplement_introduction_01.png)
...
#### Долгосрочные прогнозы и технологические изменения {#the-long-term-future-will-likewise-be-weird.}
...
#### Будущее настигнет нас быстро. {#the-future-will-hit-us-fast.}
...
## Расширенное обсуждение {#extended-discussion}

### Эксперты по ИИ о катастрофических сценариях {#ai-experts-on-catastrophe-scenarios}
...
### Когда Лео Силард увидел будущее {#when-leo-szilard-saw-the-future}
...
[^1]: Мы рассказываем часть истории Лео Сциларда в [расширенном обсуждении](#when-leo-szilard-saw-the-future) ниже.
