...
### ¿No se verán limitadas las IA por su capacidad para diseñar y realizar experimentos? {#¿no-se-verán-limitadas-las-ia-por-su-capacidad-para- diseñar-y-realizar-experimentos?}

#### **La inteligencia permite aprender más de los experimentos y realizarlos de forma más rápida, informativa y paralelizada.** {#la-inteligencia-permite-aprender-más-de-los-experimentos-y-realizarlos-de-forma-más-rápida,-informativa-y-paralelizada.}
...
### Nanotecnología y síntesis de proteínas {#nanotecnología-y-síntesis-de-proteínas}
...
#### **Superar la biología** {#superar-la-biología}
...
3. A la selección natural le cuesta crear cosas nuevas o solucionar problemas que requieran cambios simultáneos en lugar de cambios secuenciales. Esto limita enormemente los diseños a los que puede acceder la evolución y da a los diseños actuales en biología su aspecto parchado, improvisado y enredado según los estándares de la ingeniería humana. Por ejemplo, la complejidad (de las partes conocidas) del metabolismo humano: \[IMG TODO: la fuente es [https://www.reddit.com/r/MapPorn/comments/6sxznd/map\_of\_the\_known\_human\_metabolic\_pathways/](https://www.reddit.com/r/MapPorn/comments/6sxznd/map_of_the_known_human_metabolic_pathways/) \]
...
#### **Freitas y los glóbulos rojos** {#freitas-y-los-glóbulos-rojos}
...
Decir que la nanotecnología drexleriana es factible en principio no significa necesariamente que las primeras IA más inteligentes que los humanos pudieran construir una tecnología que se acerque a esos límites físicos. Nuestra mejor estimación es que está dentro del rango de cosas que una superinteligencia artificial podría resolver, porque resolver este tipo de tareas de ingeniería parece ser principalmente un desafío cognitivo (que puede solucionarse pensando) y [no esperamos que la fase de experimentación y pruebas tenga que ser muy larga](#la-inteligencia-permite-aprender-más-de-los-experimentos-y-realizarlos-de-forma-más-rápida,-informativa-y-paralelizada.).
...
### ¿Por qué elegimos esta historia? {#¿por-qué-elegimos-esta-historia?}
...
#### **Nuestra historia muestra cómo la IA es susceptible de tener preferencias extrañas y no intencionadas.** {#nuestra-historia-muestra-cómo-la-ia-es-susceptible-de-tener-preferencias-extrañas-y-no-intencionadas.}
...
### ¿Por qué se describe a Galvanic como bastante cautelosa? {#¿por-qué-se-describe-a-galvanic-como-bastante-cautelosa?}

#### **Para plantear un desafío a Sable.** {#para-plantear-un-desafío-a-sable.}
...
### ¿Por qué se describe a Galvanic como poco cautelosa? {#¿por-qué-se-describe-a-galvanic-como-poco-cautelosa?}
...
### ¿Por qué narrar una historia con una sola IA tan inteligente como Sable? {#¿por-qué-narrar-una-historia-con-una-sola-ia-tan-inteligente-como-sable?}
...
Véase también nuestro debate sobre cómo [las IA coordinadas no dejarán nada para los humanos](#¿no-necesitarán-las-ia-que-impere-la-ley?) (a menos que alguna de ellas se preocupe por nosotros).

### Si la historia comenzara más tarde, ¿estaría el mundo mejor preparado? {#si-la-historia-comenzara-más-tarde,-¿estaría-el-mundo-mejor-preparado?}
...
### ¿Por qué hicieron que la fase de expansión de Sable se desarrollara de esa manera? {#¿por-qué-hicieron-que-la-fase-de-expansión-de-sable-se-desarrollara-de-esa-manera?}

#### **Intentábamos describir un escenario especialmente lento y comprensible, de entre los escenarios posibles.** {#intentábamos-describir-un-escenario-especialmente-lento-y-comprensible,-de-entre-los-escenarios-posibles.}
...
### ¿Por qué escribieron el final de esa manera? {#¿por-qué-escribieron-el-final-de-esa-manera?}
...
### ¿Cuánto tiempo tardaría en resolverse el problema de la alineación de la SIA? {#¿cuánto-tiempo-tardaría-en-resolverse-el-problema-de-la-alineación-de-la-sia?}
...
#### **Esto muy probablemente sería catastrófico.** {#esto-muy-probablemente-sería-catastrófico.}
...
### ¿Qué pasaría si hubiera muchas inteligencias artificiales diferentes? {#¿qué-pasaría-si-hubiera-muchas-inteligencias-artificiales-diferentes?}
...
### Una mirada más detallada al antes y el después {#una-mirada-más-detallada-al-antes-y-el-después}
...
Y podrías [configurar simulaciones](#¿y-si-le-hacemos-creer-que-está-en-una-simulación?) (e intentar falsificar las sensaciones internas de la IA, etc.) de una manera que, según tu teoría de la cognición, sería muy similar al estado cognitivo en el que entraría la IA una vez que realmente tuviera la opción de traicionarte.
...
#### **El mundo suele salir adelante a base de ensayo y error. Pero en este caso, los errores iniciales no dejarían sobrevivientes.** {#el-mundo-suele-salir-adelante-a-base-de-ensayo-y-error.-Pero-en-este-caso,-los-errores-iniciales-no-dejarían-sobrevivientes.}

Véase el capítulo 10 y el [debate ampliado correspondiente](#una-mirada-más-detallada-al-antes-y-el-después) sobre la diferencia entre el antes y el después.

### ¿Consideran que la alineación es todo o nada? {#¿consideran-que-la-alineación-es-todo-o-nada?}
...
Para que la IA nos dé *cualquier cosa*, tiene que preocuparse por nosotros de la manera correcta, al menos un poco. Y hay muchísimos «episodios que casi fueron una catástrofe» que no están a la altura de esa vara. Véase también: «[¿No se preocuparán las IA al menos un poco por los humanos?](#¿no-se-preocuparán-las-ia-al-menos-un-poco-por-los-humanos?)»

### ¿No mejorará la situación una vez que los gobiernos se involucren más? {#¿no-mejorará-la-situación-una-vez-que-los-gobiernos-se-involucren-más?}
...
Para obtener más información sobre qué intervenciones gubernamentales tienen posibilidades reales de evitar una catástrofe asociada a la IA, véase el capítulo 13, así como el [debate sobre por qué la colaboración internacional probablemente no sería suficiente](#¿por-qué-no-utilizar-la-cooperación-internacional-para-construir-una-ia-segura,-en-lugar-de-cancelarlo-todo?).
...
#### **Eso sería suicida, porque estamos demasiado lejos de una solución para la alineación.** {#eso-sería-suicida,-porque-estamos-demasiado-lejos-de-una-solución-para-la-alineación.}
...
Creemos que este es un buen ejemplo de cómo los ejecutivos de las empresas de IA se aferran a cualquier argumento que consideren persuasivo para justificar su avance acelerado. Creemos que la mayoría de estos argumentos pueden descartarse por sus propios méritos, y [recomendamos no](#los-planes-viables-implicarán-decir-«no»-a-las-empresas-de-ia.) dar más importancia a un argumento solo porque lo haya planteado un ejecutivo de una empresa de IA.

### ¿No es importante adelantarse para poder investigar la alineación? {#¿no-es-importante-adelantarse-para-poder-investigar-la-alineación?}
...
#### **Hay mucho trabajo significativo que podría hacerse ahora.** {#hay-mucho-trabajo-significativo-que-podría-hacerse-ahora.}
...
### ¿Qué pasaría si las empresas de IA solo desplegaran sus IA para acciones que no fueran peligrosas? {#¿qué-pasaría-si-las-empresas-de-ia-solo-desplegaran-sus-ia-para-acciones-que-no-fueran-peligrosas?}
...
### ¿Por qué no simplemente leer los pensamientos de la IA? {#¿por-qué-no-simplemente-leer-los-pensamientos-de-la-ia?}
...
De hecho, nosotros (Yudkowsky y Soares) empezamos a trabajar en el problema de la alineación de la IA antes de que estuviera claro que el descenso de gradiente se iba a convertir en el paradigma dominante. En aquellos días, cuando nada funcionaba en la IA, parecía una apuesta razonable que la humanidad descubriría cómo funciona la inteligencia en el camino hacia su creación, e *incluso entonces*, esperábamos que el problema de la alineación de la IA fuera difícil (por diversas razones, como las formas en que la IA [se modificaría a sí misma con el tiempo](#la-reflexión-y-la-automodificación-hacen-todo-más-difícil)). Leer los pensamientos de la IA sería un paso atrás hacia el problema ligeramente más fácil de alinear una mente que los humanos *sí* entendían, pero solo un paso: leer una mente está muy lejos de entenderla a detalle o de saber cómo cambiarla.
...
Véase también: [De nada sirven las señales de advertencia si no sabes qué hacer con ellas.](#*-de-nada-sirven-las-señales-de-advertencia-si-no-sabes-qué-hacer-con-ellas.)
...
Hemos oído a gente proponer todo tipo de planes descabellados que implican [utilizar IA para supervisar los pensamientos de otras IA](https://openai.com/index/chain-of-thought-monitoring/). Por ejemplo, se podría intentar utilizar una IA para delatar a cualquier IA que no esté haciendo todo lo posible por (por ejemplo) [descubrir cómo resolver](#más-sobre-hacer-que-las-ia-resuelvan-el-problema) el problema de la alineación de la superinteligencia.
...
Véanse también las discusiones más detalladas sobre la [IA que busca la verdad](#más-sobre-la-creación-de-una-ia-que-«busque-la-verdad»), la [IA sumisa](#más-sobre-la-creación-de-una-ia-que-sea-«sumisa») y el [uso de IA para resolver la alineación de la IA](#más-sobre-hacer-que-las-ia-resuelvan-el-problema), donde se profundiza un poco más en esas propuestas.

### ¿No habrá alertas tempranas que sirvan a los investigadores para identificar problemas? {#¿no-habrá-alertas-tempranas-que-sirvan-a-los-investigadores-para-identificar-problemas?}

#### **\* De nada sirven las señales de advertencia si no sabes qué hacer con ellas.** {#*-de-nada-sirven-las-señales-de-advertencia-si-no-sabes-qué-hacer-con-ellas.}

En los recursos del capítulo 2, examinamos algunos problemas de confiar en las señales de advertencia en los [blocs de notas de cadena de pensamiento en inglés](#pero-algunas-ia-piensan-parcialmente-en-inglés,-¿no-ayuda-eso?) que se encuentran en algunos modelos de razonamiento.
...
#### **La IA no es un campo de ingeniería maduro que esté equipado para este tipo de problemas.** {#la-ia-no-es-un-campo-de-ingeniería-maduro-que-esté-equipado-para-este-tipo-de-problemas.}
...
### Más sobre algunos de los planes que criticamos en el libro {#más-sobre-algunos-de-los-planes-que-criticamos-en-el-libro}

#### **Más sobre la creación de una IA que «busque la verdad»** {#más-sobre-la-creación-de-una-ia-que-«busque-la-verdad»}
...
Hasta la fecha, esto ha dado lugar a una dinámica en la que las IA parecen bastante útiles y «sumisas» en el caso típico, pero con una serie regular de percances espectaculares (como el de Sydney, comentado en el capítulo 2, y «[MechaHitler](#más-sobre-la-creación-de-una-ia-que-«busque-la-verdad») y un océano de [comportamientos extraños y preocupantes](#¿no-hacen-los-desarrolladores-regularmente-que-sus-ia-sean-buenas,-seguras-y-obedientes?) en los extremos, como la [psicosis inducida por la IA](#psicosis-inducida-por-la-ia).
...
Del mismo modo, podemos entrenar a las IA hasta el punto de que parezcan amistosas cuando interactúan con los humanos en contextos similares a los de entrenamiento. Pero [una actriz no es idéntica al personaje que interpreta](#*-los-llm-actuales-son-como-alienígenas-que-llevan-muchas-máscaras.), y el mecanismo que hace que una IA desmesurada y caótica parezca amistosa probablemente no la hará ser profundamente amistosa, especialmente de un modo que se mantenga después de que la IA madure, invente nuevas tecnologías y cree nuevas opciones para sí misma. Véanse los capítulos 4 y 5 para obtener más información sobre este tema.

#### **Más sobre cómo hacer que las IA resuelvan el problema** {#más-sobre-hacer-que-las-ia-resuelvan-el-problema}
...
Incluso si una empresa de IA presta atención a las señales de advertencia sutiles —lo cual, por desgracia, es un gran «si»—, sigue existiendo el problema de que la habilidad de *darse cuenta* de que la IA está proponiendo planes defectuosos (en tu perjuicio y en su beneficio) no se traduce en la capacidad de [hacer que *se detenga*](#¿no-habrá-alertas-tempranas-que-sirvan-a-los-investigadores-para-identificar-problemas?). Los desarrolladores pueden hacer que la IA siga proponiendo ideas hasta que sean lo suficientemente complicadas como para que el desarrollador no pueda detectar ningún defecto, pero este no es un método que solucione los defectos reales.
...
Mientras tanto, las IA están emitiendo [una serie cada vez mayor de señales de advertencia](#*-las-ia-siguen-rumbos-extraños-que-solo-coinciden-en-parte-con-lo-que-resulta-útil.), y los laboratorios se limitan a seguir avanzando, diciendo que *probablemente* todo saldrá bien, de un modo u otro.
...
Por la misma razón, una IA con preferencias complejas y en evolución querrá que sus preferencias evolucionen [*a su manera*](#la-reflexión-y-la-automodificación-hacen-todo-más-difícil´), en lugar de querer cambiar sus heurísticas por las que los humanos consideran convincentes.
...
Pero aprendimos algo de este ejercicio. No solo aprendimos sobre el problema en sí, sino también sobre lo difícil que es conseguir que las organizaciones que otorgan becas externas o los editores de revistas *entiendan cuál es el problema*. Un número sorprendente de personas vio simples acertijos matemáticos y dijo: «Esperan que la IA sea simple y matemática», y no vio la cuestión de fondo de que es [difícil perjudicar las capacidades de dirección de una IA](#la-maquinaria-profunda-de-la-dirección)*,* al igual que es [difícil perjudicar su capacidad de calcular probabilidades](#la-maquinaria-profunda-de-la-predicción).
...
### ¿No es el peligro de una IA más inteligente que los humanos una distracción de otros problemas? {#¿no-es-el-peligro-de-una-ia-más-inteligente-que-los-humanos-una-distracción-de-otros-problemas?}
...
### ¿Están en contra de la tecnología? {#¿están-en-contra-de-la-tecnología?}
...
### ¿No es más inteligente adelantarse y asegurarse de que los actores bienintencionados lleven la delantera? {#¿no-es-más-inteligente-adelantarse-y-asegurarse-de-que-los-actores-bienintencionados-lleven-la-delantera?}
...
Las cosas cambian, especialmente cuando hay una necesidad desesperada, urgente y reconocida. El principal impedimento para ponerle freno es que los líderes mundiales no se percaten del peligro. Y ese proceso [ya ha comenzado](#¿reconocerán-esto-los-funcionarios-elegidos-como-una-amenaza-real?).

### ¿Por qué no utilizar la cooperación internacional para construir una IA segura, en lugar de cancelarlo todo? {#¿por-qué-no-utilizar-la-cooperación-internacional-para-construir-una-ia-segura,-en-lugar-de-cancelarlo-todo?) }
...
### ¿Están diciendo que necesitamos una IA *demostrablemente* segura? {#¿están-diciendo-que-necesitamos-una-ia-*demostrablemente*-segura?}
...
### ¿Qué efecto tiene en su vida cotidiana creer todo esto? {#¿qué-efecto-tiene-en-su-vida-cotidiana-creer-todo-esto?}
...
### ¿Quieren decir que deberíamos entrar en pánico? {#¿quieren decir que deberíamos entrar en pánico?}
...
#### **Actuar con pánico extremo no da buenos resultados.** {#actuar-con-pánico-extremo-no-da-buenos-resultados.}
...
### ¿No es todo esto mero alarmismo de los líderes de la IA para ganar estatus y atraer inversión? {#¿no-es-todo-esto-mero-alarmismo-de-los-líderes-de-la-ia-para-ganar-estatus-y-atraer-inversión?}
...
### ¡Pero no todos los expertos están de acuerdo sobre los riesgos! {#¡pero-no-todos-los-expertos-están-de-acuerdo-sobre-los-riesgos! }
...
### Pero ¿qué hay de los beneficios de una IA más inteligente que los humanos? {#pero-¿qué-hay-de-los-beneficios-de-una-ia-más-inteligente-que-los-humanos?}
...
#### **Vivir en un mundo de ensueño** {#vivir-en-un-mundo-de-ensueño}
...
#### **¿Qué perfil se necesita?** {#¿qué-perfil-se-necesita?}
...
#### **Humanos comunes, tecnología inusual** {#humanos-comunes,-tecnología-inusual}
...
Como [discutimos anteriormente](#¿superará-la-ia-los-umbrales-criticos-y-despegará?), los cerebros de los chimpancés son muy similares a los cerebros humanos, salvo que son aproximadamente cuatro veces más pequeños. No hay un módulo adicional de «ser muy inteligente» dentro de los cerebros humanos; hay una transición gradual entre cerebros como los suyos y cerebros como los nuestros; sería difícil decir dónde está la línea entre «una sociedad de estos daría lugar a un montón de monos» y «una sociedad de estos caminará sobre la luna» solo con mirar los cerebros. Los cerebros de los primates cruzaron un umbral crítico, y no habría sido evidente desde el exterior. ¿Hay umbrales críticos que la IA cruzará? ¡Quién sabe! No es que los ingenieros de IA puedan decírnoslo; ni siquiera [son](https://arxiv.org/abs/2206.07682) [capaces](https://arxiv.org/abs/2406.04391) de predecir las capacidades específicas de sus nuevos sistemas de IA antes de ponerlos en marcha.
...
### ¿Habrá disparos de advertencia? {#¿habrá-disparos-de-advertencia?}
...
#### **Es probable que en los desastres de IA claros no esté implicada la superinteligencia.** {#es-probable-que-en-los-desastres-de-ia-claros-no-esté-implicada-la-superinteligencia.}
...
### ¿Realmente se puede detener una tecnología? {#¿realmente-se-puede-detener-una-tecnología?}
...
#### **Una prohibición puede estar muy focalizada.** {#una-prohibición-puede-estar-muy-focalizada.}
...
### ¿No rechazarían algunos países una prohibición? {#¿no-rechazarían-algunos-países-una-prohibición?}
...
#### **Un tratado requeriría vigilancia y hacerse cumplir.** {#un-tratado-requeriría-vigilancia-y-hacerse-cumplir.}
...
### ¿Puede un régimen de vigilancia durar para siempre? {#¿puede-un-régimen-de-vigilancia-durar-para-siempre?}
...
#### **Ningún régimen de vigilancia debería durar para siempre.** {#ningún-régimen-de-vigilancia-debería-durar-para-siempre.}
...
### ¿Por qué ayudaría hacer más inteligentes a los humanos? {#¿por-qué-ayudaría-hacer-más-inteligentes-a-los-humanos?}

#### **\* Podría ayudar a resolver el problema de la alineación.** {#*-podría-ayudar-a-resolver-el-problema-de-la-alineación.}
...
#### **Los humanos mejorados no plantean un gran problema de «alineación humana».** {#los-humanos-mejorados-no-plantean-un-gran-problema-de-«alineación-humana».}
