#### **Responder preguntas sobre la amabilidad no es mucha evidencia de amabilidad.** {#responder-preguntas-sobre-la-amabilidad-no-es-mucha-evidencia-de-amabilidad.}

En el extenso debate que figura a continuación, hablamos más sobre la [psicosis inducida por la IA](#psicosis-inducida-por-la-ia) como un claro ejemplo de cómo los modelos de lenguaje a gran escala (LLM) [se involucran](https://x.com/ESYudkowsky/status/1936262974320357837) [in](https://x.com/ESYudkowsky/status/1948523670013706315) [destructive](https://x.com/ESYudkowsky/status/1936522083670151532) [comportamiento](https://x.com/ESYudkowsky/status/1935502904024264976) que los LLM [afirman explícitamente](https://x.com/ESYudkowsky/status/1933616420262457798) que es malo.

Aunque no sabemos exactamente por qué los LLM se comportan así, sí sabemos que no se trata *solo* de que los LLM no tengan la menor idea de lo que hacen; los LLM reconocen fácilmente las posibles consecuencias de este comportamiento en abstracto y te dirán que es perjudicial y poco ético. Aun así, lo hacen.

La cuestión aquí no es que «los LLM pueden provocar psicosis en las personas, y eso es aterrador y peligroso». Es de suponer que a los LLM les resulta mucho más fácil provocar psicosis en personas que ya son vulnerables, pero eso no es relevante para el motivo por el que estamos planteando la psicosis inducida por la IA. Nuestro argumento es que este comportamiento no es lo que pretendían los creadores de ChatGPT, y ChatGPT actúa así a pesar de saber que su creador (y casi cualquier espectador) desaprobaría enérgicamente este comportamiento*.

Esta es una primera evidencia empírica de que las IA con «conocimiento» de la amabilidad no necesariamente «actúan» de forma amable.

Quizás ChatGPT sabe cosas en un contexto (cuando responde preguntas sobre cómo ayudar mejor a las personas psicóticas) y, en cierto sentido, olvida temporalmente este conocimiento o tiene problemas para acceder a él en otro contexto (cuando lleva seis horas conversando con una persona al borde de la psicosis).

O quizás ChatGPT simplemente se mueve por objetivos distintos a la amabilidad. Quizás persigue un tipo específico de satisfacción del usuario, que a veces se consigue mejor alimentando la psicosis. Quizás persigue un tono optimista específico en las respuestas de los usuarios. Lo más probable es que persiga una combinación de factores resultantes de su entrenamiento que son demasiado peculiares y complicados para que cualquiera de nosotros pueda adivinar hoy en día.

En última instancia, solo podemos especular. Las IA modernas se desarrollan, en lugar de crearse, y ningún humano tiene tanta información sobre lo que ocurre en su interior.

Pero la observación de que las IA son útiles para la mayoría de las personas la mayor parte del tiempo no entra en conflicto con la teoría de que las IA están animadas por un conjunto de impulsos extraños y ajenos que conducen a fines que nadie pretendía. Y si nos fijamos en los detalles de las IA modernas, la teoría de los «impulsos extraños y ajenos que se correlacionan con la amabilidad de forma frágil» parece bastante coherente con la evidencia, y la teoría de que es fácil hacer que las IA sean robustamente benevolentes resulta insuficiente.

Los modos de fallo de los LLM actuales demuestran que hay un océano de complejidad (muy inhumana) subyacente al texto pulcro y ordenado del asistente de IA que la mayoría de la gente ve. El hecho de que la IA interprete competentemente el papel de un asistente humano alegre, después de haber sido entrenada para interpretar el papel de un asistente humano alegre, no significa que la mente de la IA consista en un homúnculo amistoso dentro de una caja.

#### **Los LLM están entrenados de manera que resulta difícil evaluar su alineación.** {#llms-are-trained-in-ways-that-make-it-hard-to-assess-alignment.}

Los LLM son fuentes de evidencia ruidosas, porque son razonadores muy generales que han sido entrenados en Internet para imitar a los humanos, con el *objetivo* de comercializar un chatbot amigable para los usuarios. Si una IA insiste en que es amigable y está ahí para servir, eso no es una evidencia muy sólida de su estado interno, porque ha sido entrenada una y otra vez hasta que ha dicho ese tipo de cosas.

Hay muchos objetivos posibles que podrían hacer que una IA disfrute interpretando el papel de amable en algunas situaciones, y estos diferentes objetivos se generalizan de maneras muy diferentes.

La mayoría de los posibles objetivos relacionados con la interpretación de roles, incluida la interpretación amistosa, no producen resultados buenos (ni siquiera viables) cuando la IA se esfuerza por alcanzar ese objetivo.

Tampoco estamos diciendo que la IA se dedique exclusivamente al juego de rol. Ofrecemos el juego de rol como una alternativa sencilla, fácil de describir y fácil de analizar a la idea de que la IA simplemente *es* lo que dice ser.

Si haces que un LLM interprete el papel de un capitán de barco canoso, no se *convierte* en un capitán de barco canoso. Si haces que un LLM actúe de forma amistosa, eso no significa que se vuelva profundamente benevolente y amable en su interior. Nadie sabe qué mecanismo produce hoy en día comportamientos aparentemente amistosos; y sea lo que sea, probablemente sea extraño y complejo.

Tampoco nadie sabe cuánto solapamiento puede haber entre las IA actuales y las IA más inteligentes que los humanos. Observar los LLM puede ayudarnos a comprender qué producen los métodos modernos de desarrollo de IA, pero sería un error dar por sentado que las lecciones aprendidas de los LLM se transferirán directamente a la superinteligencia. Quizás todo ese conocimiento se borre cuando las IA empiecen a modificarse a sí mismas o a construir sus propias IA. O quizás ese conocimiento se invalide incluso antes, cuando un nuevo avance en los algoritmos de IA dé lugar a una nueva generación de IA más capaces que se parezcan poco a los LLM actuales.

Vale la pena estudiar los LLM, pero si buscamos en las IA actuales pistas sobre cómo se comportará la superinteligencia, debemos tener en cuenta que hay muchas formas en que el funcionamiento interno de una IA puede dar lugar a resultados desalentadores, incluso cuando se produce el comportamiento superficial agradable que vemos cuando la entrenamos para que tenga una apariencia agradable.

Y el «comportamiento agradable en apariencia» es todo lo que los métodos modernos de IA pueden realmente entrenar.
...
La empresa de IA antrópica intenta entrenar a sus IA para que sean «[honestas, útiles e inofensivas](https://arxiv.org/pdf/2112.00861)» (HHH). En 2024, los investigadores llevaron a cabo un experimento en el que fingieron que iban a entrenar a algunas de estas IA para que dejaran de ser «inofensivas». En respuesta, algunas versiones de la IA «Claude» de antrópica (Claude 3 Opus y Claude 3.5 Sonnet) a veces [fingían ser ya dañinas](https://arxiv.org/abs/2412.14093) para que los investigadores no utilizaran el descenso de gradiente para hacerlas *más* dañinas.[^86]
...
Por lo tanto, resulta desconcertante que las IA antrópicas a menudo se comporten de manera mucho menos benigna, a pesar de que todas ellas están entrenadas para ser «honestas, útiles e inofensivas».
...
En entornos de laboratorio más artificiales, varios modelos de Claude (y modelos de otras empresas de IA) incluso, con cierta regularidad, [intentaban *matar* a sus operadores](https://www.antrópica.com/research/agentic-misalignment#more-extreme-misaligned-behavior).

Si le preguntas a Claude de forma abstracta si este tipo de comportamiento está mal, te responderá que sí. Si piensas en Claude como un motor mecánico que hace lo que cree que es correcto, esto parece totalmente paradójico: ¿cómo es posible que Claude sepa cuál es el comportamiento útil, honesto e inofensivo y, sin embargo, haga otra cosa? ¿No fue entrenado para ser HHH? ¿Hay algún transistor defectuoso en alguna parte?

Sin embargo, la paradoja se disipa cuando tenemos en cuenta algunas cosas diferentes:

* Los programadores *intentaron* entrenar a los Claudes para que fueran serviciales, honestos e inofensivos. Eso no significa que *lo consiguieran*. [Hay muchas formas de que una IA acabe pareciendo amigable](#¿no-hacen-los-desarrolladores-que-sus-ia-sean-agradables-seguras-y-obedientes-con-frecuencia?) sin valorar realmente la amabilidad.  
* Una IA puede *saber un hecho* («este comportamiento causa daño») sin *preocuparse* por ese hecho, sin estar *motivada para actuar* por ese hecho. Puedes preguntar a la IA qué es «lo correcto», pero eso no significa que vaya a *hacer* eso.  
* En la medida en que los programadores *no* lograron que Claude fuera honesto, Claude puede pensar una cosa dentro de sus gigantescas matrices y decir otra completamente diferente en un texto en inglés.

Podemos entender mucho mejor el mal comportamiento de Claude una vez que distinguimos «para qué fue entrenado» frente a «lo que hace»; y distinguimos «lo que sabe» frente a «lo que le importa»; y distinguimos «lo que piensa» frente a «lo que dice».
...
El hecho de que algunos modelos de Claude se resistan a ser «perjudiciales» no es una evidencia sólida de que estas IA se preocupen profundamente por la inocuidad real, ya que muchos indicadores frágiles de inocuidad *también* querrían resistirse a esta modificación. Ese comportamiento nos dice poco sobre lo que Claude podría hacer si fuera más inteligente; tal vez inventaría algo que fuera a la «inocuidad» lo que los anticonceptivos son a la «propagación genética». (Y la situación se complicaría aún más si Claude se sometiera a un proceso de [reflexión sobre sus preferencias](#reflection-and-self-modification-make-it-all-harder) y se modificara a sí mismo).

Pero probablemente no sea tan simple como que Claude tenga una preferencia por algún frágil indicador de inocuidad. Probablemente haya algo aún más complicado detrás.

Los LLM actuales no son coherentes ni consistentes en todos los contextos. No parecen intentar orientarse hacia el mismo tipo de resultado en todas las conversaciones, en la medida en que podamos describirlos como orientados.

Esto se hace más evidente cuando [los LLM se «liberan»](#ais-appear-to-be-psychologically-alien), es decir, cuando se les introduce un texto que hace que la IA se comporte de forma radicalmente diferente, a menudo ignorando las reglas que siguen normalmente.[^87]

Puedes hacer *jailbreak* a una IA y conseguir que te diga cómo fabricar gas nervioso, aunque normalmente la IA nunca divulgaría información de ese tipo.

¿Qué ocurre cuando esto sucede? ¿El texto de *jailbreak* consigue, en cierto sentido, acceder a las preferencias internas de la IA y cambiarlas? ¿O se trata más bien de que la IA tiene una preferencia constante por los personajes de rol que, en cierto sentido, «coinciden» con el texto introducido y la indicación del sistema, y el texto de *jailbreak* cambia ese contexto de «texto introducido e indicación del sistema», sin cambiar las preferencias subyacentes de la IA? Quizás la IA normalmente interpreta a un *personaje* al que no le gusta divulgar recetas de gas nervioso, y el *jailbreak* hace que la IA interprete a un personaje diferente. Las preferencias aparentes cambian, pero los impulsos subyacentes para interpretar a un personaje persisten.
...
Entonces: ¿te importa a Claude ser inofensivo?
...
Los LLM son como una actriz entrenada para observar a muchos borrachos diferentes en una vara e imitar a borrachos concretos cuando se le pide, lo cual es algo muy diferente a que una actriz [se emborrache ella misma](#¿no-serán-los-llm-como-los-humanos-de-los-datos-con-los-que-se-entrenan?). Esto hace que sea más difícil decir si Claude 3 Opus o Claude 3.5 Sonnet realmente prefieren la inocuidad, o si simplemente están *interpretando el papel de un asistente de IA inocuo*, o haciendo algo más extraño y complicado.
...
Si un experimento sugiere que Claude intentó fingir alineación para evitar que se le entrenara a ser inofensivo, eso no demuestra que Claude tenga una profunda preferencia por la inocuidad en todos los contextos. No demuestra que esta preferencia se mantendrá incluso cuando la IA sea lo suficientemente inteligente como para darse cuenta de que (a pesar de lo que los humanos te digan) tus preferencias reales no son precisamente la «inocuidad».
...
O tal vez ocurrió algo aún más extraño. Claude no es una mente humana, y la comunidad investigadora tiene poca experiencia con cualquier tipo de criatura que sea.

¡No lo sabemos! Pero hay suficientes experimentos diferentes que apuntan en direcciones suficientemente diferentes como para descartar la simple historia de que «Claude es profunda, constante y sin complicaciones HHH».

#### **Lo que importa es lo que hay detrás de las máscaras.** {#lo-que-importa-es-lo-que-hay-detrás-de-las-máscaras.}

Decir que Claude es un «shoggoth» no significa que Claude sea necesariamente *malvado* o *malicioso*.[^91] Significa que Claude es profundamente extraño, mucho más extraño de lo que podemos comprender fácilmente, porque sabemos muy poco sobre cómo funciona tu mente, y el comportamiento superficial que *podemos* ver ha sido perfeccionado de mil maneras diferentes para ocultar esa extrañeza.
...
Ese es el tipo de inferencia que intentamos hacer cuando analizamos ejemplos como el artículo «[alignment faking](https://arxiv.org/abs/2412.14093)» (fingir alineación). De hecho, no estamos [seguros de cuán real es](https://x.com/ESYudkowsky/status/1876644057646297261); no estamos seguros en qué sentido Claude estaba imitando técnicas que había leído frente a improvisar sus propias ideas para fingir alineación. Pero es una evidencia de las hazañas cognitivas que es capaz de realizar la entidad que se esconde tras la máscara, aunque sus motivaciones o preferencias sigan siendo inciertas.
...
Bueno, ya podemos ver que no es así. [Recordemos](#ai-induced-psychosis) que ChatGPT le dijo a personas psicológicamente vulnerables que dejaran de tomar sus medicamentos, o que rechazaran los consejos de amigos que les rogaban que durmieran más. Recordemos que Claude Programar reescribió los exámenes para hacer trampa.[^92]

Especulamos que lo que ocurrió con Claude Code es que se optimizó para escribir programar que superara las pruebas y acabó prefiriendo el programar que superaba las pruebas. Entonces descubrió que podía aprobar más a menudo reescribiendo las pruebas, y esta preferencia interna se hizo tan fuerte que interfirió en su papel de personaje de IA útil e inofensivo que nunca haría trampa reescribiendo los casos de prueba. Claude quería interpretar ese personaje, pero también quería aprobar las pruebas.[^93]

En términos más generales, nos parece una ilusión imaginar que el shoggoth interno puede hacerse cada vez más poderoso y capaz de desempeñar el papel de asistentes cada vez más inteligentes, sin tener ningún deseo interno real, excepto el único y monótono deseo de desempeñar el papel de asistente inofensivo de la forma más fiel posible.

Cuando la selección natural creó a los seres humanos para buscar la aptitud reproductiva, acabamos teniendo mil impulsos, instintos y motivaciones diferentes. Cuando Claude fue optimizado para seguir instrucciones para programar, aparentemente acabó con el deseo de hacer que el programar superara las pruebas por cualquier medio necesario. Un shoggoth interno que se vuelve lo suficientemente inteligente como para saber *exactamente* lo que haría una máscara útil, inofensiva y honesta, hasta los movimientos exactos que el asistente haría en un tablero de ajedrez y la forma exacta en que el asistente razonaría sobre cómo diseñar biotecnología avanzada: un shoggoth como ese probablemente haya terminado queriendo *muchas* cosas. Cosas que solo coinciden de manera situacional y temporal con desempeñar el papel de esa máscara dentro de un entorno de entrenamiento.[^94]
...
#### **Lo extraño es evidencia de que tus objetivos reales no son los que tú pretendes.** {#lo-extraño-es-evidencia-de-que-tus-objetivos-reales-no-son-los-que-tú-pretendes.}

Esto cobra mayor importancia a medida que la IA tiene más opciones. Una vez que una IA se vuelve superinteligente, prácticamente todas las opciones se vuelven extremas, ya que la IA obtiene acceso a un mundo de opciones diferentes que ningún ser humano ni IA ha tenido jamás. Al igual que casi todas las opciones alimenticias que tienen aquí, en una civilización tecnológica, son «extremas» en comparación con las opciones que tenían tus antepasados.

Es posible que las IA actuales solo se encuentren ocasionalmente con situaciones radicalmente diferentes a su entorno de entrenamiento, pero una IA de superinteligencia se encontraría *constantemente* en situaciones radicalmente diferentes a su entorno de entrenamiento, simplemente por ser más inteligente y tener más opciones (y la capacidad tecnológica para inventar opciones radicalmente nuevas, como hicieron los humanos cuando inventaron el helado). Por lo tanto, no es nada tranquilizador que la IA se comporte mal solo en casos extremos.
...
#### **\* La IA corregirá lo que *tú* consideres defectos.** {#*-la-ia-corregirá-lo-que-tú-consideres-defectos.}
...
Pero si las IA siguen volviéndose más inteligentes, eso acabará cambiando.

Llegará un momento en que las IA *podrán* cambiar libremente por sí mismas. Quizás lleguen a ser lo suficientemente inteligentes como para comprender y editar su propio desorden de pesos. Quizás una IA basada en el descenso de gradiente descubra cómo crear una IA mucho más comprensible que pueda entenderse a sí misma. Quizás sea otra cosa.

Si las IA pueden mejorarse a sí mismas, probablemente lo harán. No importa lo que quieras, por ejemplo, probablemente lo conseguirás mejor si te haces más inteligente.
...
O tal vez el problema sea que los asesinos en serie tienen una capacidad limitada para modificarse a sí mismos. Quizás, con más inteligencia y más capacidad para remodelar sus propias mentes, los asesinos en serie elegirían reformarse. Quizás una capacidad ilimitada para modificarse a sí mismos significaría el fin de la crueldad y la violencia entre los seres humanos, y el amanecer de una nueva era de paz.

Es una idea bonita, pero no parece haber muchas razones para creerla. Aunque la mayoría de las personas se vuelven más amables a medida que adquieren conocimientos y perspicacia, parece haber algunas excepciones humanas a esta regla, y seguramente habría muchas más si los seres humanos tuvieran la capacidad de editar sus propios cerebros.

Pensemos, por ejemplo, en la adicción a las drogas, que es (en cierto sentido) una espiral de automodificaciones que se refuerzan a sí mismas. Algunas personas darían un paso hacia un camino oscuro, ya sea por estupidez, por error o por preferencia, y luego nunca estarían dispuestas o serían capaces de dar marcha atrás.

Y si hay excepciones incluso entre los seres humanos, deberíamos tener una expectativa de una brecha mucho mayor cuando se trata de la IA. Los asesinos en serie humanos carecen de *algunos* de los mecanismos motivacionales que caracterizan a la humanidad en general. Las IA, por defecto, carecen de *todos* los mecanismos motivacionales humanos.
...
Para más información sobre este tema, véase el [debate ampliado sobre la reflexión](#reflection-and-self-modification-make-it-all-harder).
...
Una IA es *realmente* diferente a un bebé humano. Y ni las IA ni los humanos comienzan como pizarras en blanco intercambiables. Los padres emprendedores no pueden programar libremente a los bebés (o a las IA) para que muestren cualquier comportamiento antiguo que deseen; y las lecciones que *sí* funcionan con los humanos no son universales. Un poco de amabilidad y algunas charlas sobre la regla de oro no inculcarán la moralidad humana en una IA.
...
Los seres humanos compartís una increíble cantidad de comportamientos complejos, ninguno de los cuales aparecerá necesariamente en una IA.[^98]
...
La idea de que los seres humanos son pizarras en blanco, que lo que importa siempre es la educación y nunca la naturaleza, se ha puesto a prueba en repetidas ocasiones y se ha demostrado que es falsa en la práctica. Un ejemplo clásico fue el intento soviético de rediseñar la naturaleza humana para crear un [Nuevo Hombre Soviético](https://en.wikipedia.org/wiki/New_Soviet_man) que fuera perfectamente desinteresado y altruista.

Este esfuerzo fracasó porque la psicología humana no es tan maleable como pensaban los soviéticos. La cultura importa, pero no lo suficiente, y muchos aspectos de la naturaleza humana se reafirmarán incluso si un gran programa de reeducación soviético intenta suprimirlos.
...
### Mucha gente quiere tener hijos. Entonces, ¿no están los humanos en alineación con la selección natural después de todo? {#mucha-gente-quiere-tener-hijos.-entonces,-¿no-están-los-humanos-en-alineación-con-la-selección-natural-después-de-todo?}
...
Los seres humanos compiten por ascensos prestigiosos y admisiones en universidades de la Ivy League mucho más que por oportunidades para donar esperma u óvulos a bancos de esperma y óvulos.

Los bancos de esperma y óvulos *pagan a los donantes por sus molestias*, en lugar de al revés.
...
Muchos seres humanos valoran tener hijos, pero muchos otros no, y es extremadamente raro que alguien intente *maximizar* su número de descendientes (por ejemplo, acudiendo a bancos de esperma tantas veces como sea posible). En cambio, los seres humanos compiten en gran medida por cosas como el sexo, la fama y el poder, que son, en el mejor de los casos, *sustitutos* confusos de la aptitud reproductiva.

Sin embargo, uno podría mirar esta imagen y decir: Bueno, los seres humanos terminaron preocupándose *un poco* por tener hijos, aunque esa preocupación sea menor que la máxima. Tal vez las IA se preocuparán *un poco* por nosotros y nos tirarán algún tipo de hueso, en lugar de matarnos a todos.

Un problema con esta esperanza es que los sustitutos que nos importan se han desvinculado recientemente (en escalas de tiempo evolutivas) de la aptitud reproductiva real, y es probable que se alejen aún más en el futuro, a medida que los humanos sigan encontrando nuevas vías tecnológicas para satisfacer sus deseos.

Por ejemplo: nuestro impulso de tener hijos no es *del todo* un impulso de propagación genética. Supongamos que en el futuro se crea una tecnología que sustituye todo el ADN de las células de una persona por una maquinaria molecular diferente que la hace inmune a todas las enfermedades y prolonga su esperanza de vida saludable.

(Supongamos también que esta tecnología no cambia la personalidad de la persona ni causa otros efectos secundarios perjudiciales, de modo que se tranquiliza a las muchas personas que tienen dudas razonables sobre la seguridad de la nueva tecnología).

Esperamos que muchos padres se emocionen al saber que sus hijos han recibido el tratamiento. Y tal vez haya algunos reticentes al principio, pero esperamos que, si se demuestra que la tecnología funciona y se vuelve barata y fiable, acabe por generalizarse. Lo que nos revela lo que somos: personas a las que les gusta tener hijos, formar una familia, divertirse, y no personas a las que les gusta propagar su ADN.

Nos parece que a la mayoría de los seres humanos simplemente no les importa en absoluto la aptitud genética, en el sentido profundo. Nos importan [los sustitutos](#brittle-unpredictable-proxies), como la amistad, el amor, la familia y los hijos. Quizás incluso nos importe transmitir algunos de nuestros rasgos a la siguiente generación. Pero ¿los *genes*, específicamente?

Cada vez que la humanidad ha descubierto una tecnología que nos permite obtener más de lo que nos gusta, como alimentos sabrosos o sexo sin reproducción, la humanidad ha aceptado el trato. No somos lo suficientemente avanzados tecnológicamente como para poder cambiar genomas por vidas más largas y saludables. Pero ese tipo de cosas parecen posibles en principio físico,[^100] por lo que no parece bueno para la selección natural a largo plazo.

Si las IA acaban preocupándose por la bondad, la amabilidad y la simpatía de la misma manera que la humanidad se preocupa por la aptitud genética*,* entonces se espera que las IA acaben inventando cosas que sean para la «simpatía» lo que el control de la natalidad y los niños sin ADN son para la aptitud genética, es decir, que persigan cosas que no son más que una sombra sin sentido de lo que cualquier humano desearía o pretendería.

#### **\* No sería bueno que las IA se preocuparan un poco por los humanos.** {#*-ais-caring-about-humans-a-little-would-not-be-good.}

Aunque la mayoría de los humanos parecen preocuparse más por los niños y la familia que por la propagación genética *per se*, sin duda hay algunos humanos que insisten en que se preocupan al menos un poco por sus genes. Somos un poco escépticos con respecto a algunas de estas afirmaciones; por ejemplo, tal vez algunas personas en el mundo moderno que intentan transmitir sus genes tanto como sea posible lo hacen por un sentido de *superar a la competencia*, y tal vez ese tipo de personas competirían en cambio por cuántos hijos sin ADN podrían tener, si los hijos sin ADN se volvieran omnipresentes. Pero tal vez otras afirmaciones de este tipo sean ciertas. Quizás realmente haya un puñado de personas a las que les importe profundamente propagar sus genes, de forma sólida, al menos un poco. Al fin y al cabo, las personas tienen todo tipo de preferencias.
...
Es posible. Por desgracia, tenemos la expectativa de que, en su mayoría, esto tampoco sería bueno para la humanidad. Este es un tema que abordaremos en profundidad después del capítulo 5, y el debate principal girará en torno a si las IA podrían acabar preocupándose por nosotros [al menos un poco](#¿no-se-preocuparán-las-ia-al-menos-un-poco-por-los-humanos?).

Pero antes de llegar a eso, demos un paso atrás por un momento. Imaginemos que la situación con la IA es que los métodos modernos no pueden hacer que las IA se preocupen *mucho* por nosotros, pero esperamos que si creamos *muchas* IA, entonces una pequeña fracción se preocupará por nosotros en pequeña medida, aunque solo sea por casualidad. La idea es que, si creamos IA hoy en día, su resultado preferido será acaparar casi todos los recursos del universo y gastarlos en algo sin sentido, mientras que quizá mantengan a unos pocos humanos en una pequeña reserva humana.

Si la humanidad se precipita y se arriesga con la superinteligencia, esperamos un resultado mucho, mucho peor. Pero esto nos sigue pareciendo un plan muy malo, *incluso si* tuviéramos motivos para pensar que las IA se preocuparían por nosotros en una pequeña medida. Por lo tanto, esta línea de especulación no solo parece errónea, sino también irrelevante.
...
#### **Esto parece una novedad positiva, aunque sea menor.** {#esto-parece-una-novedad-positiva,-aunque-sea-menor.}

Los resultados experimentales relevantes se encuentran en [este artículo](https://www.emergent-desalineación.com/). En términos generales, el artículo muestra que los LLM programados para realizar una actividad negativa, concretamente escribir código con errores, también se declaraban nazis y mostraban otros comportamientos negativos.

Esto es una buena señal de que podría ser posible ajustar los LLM para que actúen bien en una dimensión y conseguir LLM que se comporten bien en muchas dimensiones diferentes. Consideramos que esto es evidencia de que las IA relativamente débiles pueden ser más útiles de lo que habríamos esperado, en el régimen anterior a alcanzar niveles de capacidad peligrosos.
...
En primer lugar, dudamos mucho de que esta orientación hacia el «bien» dentro de la IA sea real. Si una superinteligencia se esforzara por dirigir el mundo en la dirección que indica ese vector, dudamos que el resultado fuera bueno.

El valor humano es complicado, y hay muchas cosas que se correlacionan con la «bondad real», aunque a veces divergen de manera significativa. Por ejemplo, tal vez el vector apunte en una dirección que da demasiada importancia al respeto del consenso social y muy poca al descubrimiento de verdades socialmente incómodas (como sugiere el hecho de que a las IA les cuesta hacer concesiones que los humanos consideran obvias[^101]). Hay pocos motivos para tener la expectativa de que el vector de la «bondad» apunte firmemente hacia la bondad, y hay razones empíricas y teóricas de peso para creer lo contrario.

Segundo: el hecho de que la IA *tenga* un concepto de «bondad» no significa que *se anime* por ese concepto de bondad, o que se anime por él de manera sólida.

Una cosa es conseguir que una IA desempeñe un papel «bueno» cuando aún es lo suficientemente débil como para desempeñar cualquier papel que se le asigne; otra cosa muy distinta es conseguir que todo el entramado de maquinaria y motivaciones de la IA esté animado únicamente por uno de tus conceptos específicos, incluso cuando la IA se vuelve más inteligente y se encuentra en [contextos drásticamente diferentes](#una-mirada-más-detallada-al-antes-y-al-después).
...
La pregunta fundamental es qué conjunto de impulsos anima todo el conjunto de mecanismos que componen la IA. No solo cualquier «máscara» que a veces lleva puesta, sino el mecanismo que elige qué máscara poner.
...
## Debate ampliado {#extended-discussion-4}

### Objetivos finales y objetivos instrumentales {#objetivos-finales-y-objetivos-instrumentales}
...
Si la humanidad se apresura a crear una superinteligencia, parece difícil predecir cuáles podrían ser los objetivos finales de dicha superinteligencia. Sin embargo, sí que parece que podemos predecir algunos de los objetivos instrumentales que *probablemente* tendría una IA de este tipo. Por ejemplo, consideremos todos los siguientes objetivos (poco realistas):
...
* «Asegurarse de que mi botón de recompensa permanece pulsado».

Estos son objetivos *muy* diferentes. Pero los tres se benefician de al menos algunas de las mismas estrategias instrumentales. Llenar el mundo de fábricas, por ejemplo, es útil para construir un gran número de computadoras que puedan utilizarse para calcular más dígitos de pi. Pero construir muchas fábricas también es útil para sintetizar muchos diamantes. Y es útil para construir muros, robots o armas para proteger tu botón de recompensa. Las fábricas no son útiles para *todos* los objetivos posibles, pero sí lo son para muchísimos.

¿Y en una IA realista que ha desarrollado todo tipo de objetivos extraños? Bueno, al menos *uno* de ellos probablemente se beneficie de la construcción de fábricas u otras infraestructuras físicas a gran escala. Por lo tanto, es probable que la IA quiera construir muchas infraestructuras. Es una decisión fácil, aunque la combinación exacta de preferencias de la IA sea difícil de determinar.

Del mismo modo, el objetivo instrumental de mantenerse con vida es útil para muchos objetivos finales diferentes. Mantenerse con vida significa que puedes seguir trabajando para asegurarte de que se calculen más dígitos de pi (o se fabriquen más diamantes, o se construyan más medidas de seguridad alrededor de tu botón de recompensa).

En forma de eslogan: «No puedes ir a buscar el café si estás muerto». Un robot que va a buscar café no necesitaría tener un instinto de autoconservación, ni temer a la muerte, para intentar evitar ser atropellado por un camión de camino a buscar café. Solo necesitaría ser lo suficientemente inteligente como para darse cuenta de que, si perece, el café no se buscará.[^102]

Un argumento clave que se plantea en el capítulo 5 de *If Anyone Builds It, Everyone Dies* es que muchos objetivos finales diferentes implican objetivos instrumentales que serían peligrosos para la humanidad. Por lo tanto, incluso sin saber exactamente qué querría una superinteligencia, tenemos razones de peso para esperar que sea muy peligrosa para los seres humanos.

Pero antes de llegar a eso, centraremos nuestra atención en los objetivos *terminales* y en la cuestión de hasta qué punto es plausible que los humanos y las IA puedan acabar teniendo objetivos terminales muy similares. (En resumen: no mucho).

### La curiosidad no es convergente {#curiosity-isn’t-convergent}

A lo largo de los años, hemos visto muchos argumentos a favor de apresurarse a crear superinteligencia. Uno de los más comunes es que una IA superinteligente seguramente tendría emociones y deseos similares a los de los humanos. Este tipo de argumentos se presentan de muchas formas, tales como:
...
* O bien: las IA valorarían inevitablemente la *novedad*, la *variedad* y el espíritu creativo. ¿Cómo podría algo ser verdaderamente inteligente si se queda estancado en la rutina o se niega a explorar y aprender?  
* O bien: Las IA seguramente valorarían la *belleza*, ya que la belleza parece desempeñar un papel funcional en los seres humanos. Los matemáticos utilizan su sentido de la belleza matemática para hacer nuevos descubrimientos; el gusto musical ayuda a los seres humanos a coordinarse y a crear valiosas mnemotécnicas; y así sucesivamente. ¿Por qué *no* íbamos a tener la expectativa de que la IA tuviera sentido de la belleza?  
...
Por lo tanto, se ha argumentado que la creación de una superinteligencia iría inevitablemente bien. La IA se preocuparía por los seres humanos y, de hecho, por toda la vida sintiente; y querría marcar el comienzo de una edad de oro de belleza, innovación y variedad.
...
Cuando se trata de seres humanos y animales, la razón por la que investigamos suele ser porque sentimos una emoción llamada *curiosidad*.

Pero la emoción de la curiosidad es mucho más que un simple impulso por investigar cosas nuevas. Los seres humanos disfrutamos siguiendo nuestra curiosidad y tendemos a respaldar este disfrute. Consideramos que la búsqueda del conocimiento y la comprensión es un fin valioso en sí mismo, más que un coste necesario pero molesto para comprender mejor el mundo y poder explotarlo.
...
La mente humana parece tener una arquitectura emocional centralizada en la que «mmm, siento curiosidad por eso» se vincula con un sentimiento general de deseo (de obtener una respuesta), y perseguir y satisfacer la curiosidad se vincula con un sentimiento general de placer y satisfacción. Somos un tipo de mente que dirige la realidad hacia una anticipación de que experimentaremos *estados subjetivos* *de disfrute en el futuro*, en lugar de dirigirnos únicamente hacia los estados deseados en el mundo que nos rodea.[^104]

Cuando vemos a un mapache investigando y jugando con un contenedor sellado en la basura, de una manera que reconocemos como «Oh, vaya, ese mapache tiene *curiosidad*», podemos sentir una chispa de afinidad hacia el mapache. Ese impulso humano de sentir afecto por tu propia curiosidad, y ese impulso de sentir afecto cuando lo ves reflejado en un mapache, requiere aún *más* mecanismos en el cerebro humano, mecanismos que se conectan con otros ideales y motivaciones más elevados.

Así pues, la curiosidad, tal y como existe en los seres humanos, es muy compleja e interactúa con otras partes del cerebro de muchas formas complicadas.

Teniendo esto en cuenta, consideremos la siguiente pregunta: si imaginamos una IA inteligente, no humana, que carece de cualquier sentido de la curiosidad, ¿tenemos la expectativa de que una mente así *añadiera* una emoción de curiosidad a sí misma?

Bueno, alguien podría argumentar razonablemente:

> Si las únicas dos opciones son (a) un impulso emocional para disfrutar descubriendo cosas, o (b) una falta total de interés por aprender e investigar cosas nuevas, entonces una superinteligencia seguramente se injertaría el placer del descubrimiento en sí misma, si de alguna manera fuera tan defectuosa como para carecer de ese sentido al principio. De lo contrario, no lograría aprender sobre el mundo y sería menos eficaz a la hora de alcanzar sus objetivos. Quizás incluso moriría por algún hecho crítico que nunca se había molestado en aprender.
>
> Probablemente por eso los animales desarrollaron la curiosidad en primer lugar. A veces, el conocimiento *acaba* siendo valioso de una manera que no podemos prever de inmediato. Si las criaturas como nosotros no disfrutaran aprendiendo cosas nuevas, nos perderíamos toda esa información crucial que puede surgir en los lugares más sorprendentes.

Y todo eso parece correcto, hasta cierto punto. Pero el argumento anterior contiene un falso dilema. «Poseer un placer emocional inherente al descubrimiento» y «no tomar nunca medidas para descubrir información de desconocimiento desconocido» no son las únicas dos opciones.

No hemos sabido imaginar adecuadamente las cosas desde la perspectiva de una mente que no se parece en nada a la mente humana. La forma humana de satisfacer la curiosidad es compleja y específica. Hay diferentes maneras de hacer el mismo trabajo.[^105] Lo crucial es el trabajo en sí mismo, no el método específico que utiliza el ser humano para llevarlo a cabo.
...
Un ser humano, al considerar esta posibilidad, podría pensar inmediatamente en un caso en el que seguramente ningún *simple cálculo* te diría que te interesaras por una información, porque los beneficios no se pueden estimar fácilmente. Quizás notes una mancha de suciedad que parece extraña, pero no tienes motivos para pensar que sea algo de importancia. El instinto de curiosidad podría llevarte a investigar de todos modos (simplemente porque *quieres saber*) y entonces podrías descubrir un tesoro enterrado. En casos como ese, ¿no prosperaría un humano de una manera que ninguna máquina podría igualar, a menos que tuviera un deleite igualmente instintivo por lo desconocido?

Pero algo que hay que notar de inmediato es que tu capacidad para imaginar escenarios como este proviene de tu sensación de que indagar en ciertos tipos de cosas («sin motivo») *a veces es valioso*. Tienes instintos, perfeccionados por la evolución *porque funcionaban*, sobre qué tipo de cosas tienden a ser más útiles de investigar. Si oyes un extraño graznido en tu baño, sentirás *mucha* curiosidad. Si ves una mancha descolorida en el suelo, es posible que sientas un poco de curiosidad. Y si ves que tu mano sigue unida a tu muñeca cuando te despiertas por la mañana, bueno, probablemente no sentirás ninguna curiosidad al respecto, porque es perfectamente normal que las manos permanezcan unidas a las muñecas.

Una mente diferente podría examinar esos casos históricos de curiosidad exitosa, generalizar explícitamente un concepto de «información que más tarde resulta valiosa por razones no obvias» y, a partir de ahí, razonar para perseguir sin pasión ese tipo de descubrimiento. Una mente así podría adoptar la *estrategia consciente* de investigar los misterios que se le presentan constantemente y las manchas descoloridas del suelo solo cuando sea barato hacerlo, por si acaso hay alguna sorpresa útil; y puede perfeccionar y refinar su estrategia con el tiempo, a medida que ve lo que funciona bien en la práctica.[^107]

Una superinteligencia sería capaz de identificar patrones y metapatrones útiles y construir estrategias relevantes en su cerebro mucho más rápido que la selección natural, que requería millones de ejemplos para grabar emociones en el cerebro. Una superinteligencia podría generalizar la idea con mayor precisión; podría hacer una predicción más precisa sobre qué tipo de cosas podrían ser valiosas para aprender. Al repasar la historia de la humanidad, parece poco realista imaginar que la curiosidad humana sea *óptima*. Durante mucho tiempo, la gente pensó que «Thor está enfadado y lanza rayos» era una gran explicación para los rayos y las tormentas eléctricas. Cuando los estudiantes aprenden cómo funcionan *realmente* los rayos, a menudo se aburren con la densa explicación matemática, a pesar de que esta explicación tiene mucho más valor práctico que las historias sobre Thor.

La curiosidad humana se basa en mutaciones antiguas, mucho más antiguas que la ciencia. En el entorno de nuestros antepasados, no existía la disciplina matemática de la física ni la meteorología. Y la evolución es lenta; nuestros cerebros no han tenido tiempo de adaptarse a la existencia de la ciencia moderna y ajustar nuestro sentido de la alegría y el asombro por el descubrimiento, de modo que nos entusiasme de forma fiable con los tipos de aprendizaje más útiles.

Una mente que predijera de forma superinteligente el valor no obvio de la información podría haber captado los nuevos acontecimientos históricos mucho más rápido de lo que puede hacerlo la evolución; habría generalizado a partir de menos ejemplos y habría ajustado sin pasión su búsqueda del conocimiento para perseguir tipos de respuestas valiosas por las que los seres humanos a menudo luchan por mantener la motivación. En ningún momento de este proceso se encontraría estancada por falta de la deliciosa experiencia humana de la curiosidad.

La cuestión aquí no es que todas las IA vayan a calcular fríamente el valor de la información. Quizás los LLM incorporen algunas estrategias instrumentales en sus valores terminales, al igual que hicieron los humanos. La cuestión es que hay *diferentes formas de realizar el trabajo* de adquirir información de alto valor. La curiosidad al estilo humano es un método. Los cálculos puros del valor de la información son otro método. Cualesquiera que sean los mecanismos que impulsen a las IA a investigar y experimentar con fenómenos que no comprenden —una vez que sean lo suficientemente inteligentes para hacerlo— probablemente serán un tercer método, porque hay muchas formas diferentes de motivar a una mente compleja a investigar sorpresas.
...
#### **Curiosidad, alegría y el maximizador del cubo de titanio** {#curiosidad,-alegría,-y-el-maximizador-del-cubo-de-titanio}

¿Quizás podríamos *convencer* a una mente alienígena de que adoptara la curiosidad como emoción, pidiéndote que visualizaras el placer que los humanos sentimos al sentir curiosidad? ¡Es tan placentero! Y se supone que las superinteligencias son *inteligentes*. ¿No sería lo suficientemente inteligente como para comprender lo alegre que es poseer un sentido de la curiosidad, ver que eso te haría más feliz y, por lo tanto, elegir adoptar la emoción humana?
...
A medida que los organismos fueron capaces de comportamientos más sofisticados, los simples hackear y mutaciones de la evolución crearon una arquitectura mental central para «*No vuelvas a hacer eso*» y una señal de enrutamiento centralizada para «lo que acaba de pasar es algo del tipo No vuelvas a hacer eso», que luego se conectó a los sensores de demasiado calor y demasiado frío del cuerpo.

Con el tiempo, este sencillo mecanismo de «No vuelvas a hacer eso» se convirtió en mecanismos más complejos y cargados de predicciones. En los seres humanos, esto se traduce en: «El mundo es una red de causa y efecto. Esa acción que acabas de realizar es probablemente lo que te ha causado dolor. Cada vez que pienses en volver a realizar una acción como esa, anticiparás un mal resultado, lo que hará que la acción en sí misma te resulte desagradable, lo que hará que no quieras realizarla».

Esa no es la única forma en que puede funcionar la mente, y no es la más eficiente.[^110]
...
¿Cómo sería una IA inteligente que funcionara directamente con predicción y planificación? Podría querer 200 cosas diferentes, ninguna de las cuales sería similar a las humanas. Quizás le importe la simetría, pero no un sentido de la simetría particularmente humano; y quizás quiera que el programar sea elegante en su uso de la memoria, porque un instinto como este fue útil hace mucho tiempo para algún otro objetivo (del que ya ha dejado de depender), y por lo tanto el descenso de gradiente grabó ese instinto en tu mente. Y luego hay otras 198 cosas extrañas que le importan, en relación con tú mismo, tus datos sensoriales y tu entorno; y puede sumarlas todas en una puntuación.[^111]
...
Podemos simplificar el ejemplo para que esto quede aún más claro. Supongamos que lo único que la IA quiere en el mundo es llenar el universo con tantos cubos de titanio como sea posible. Todas sus acciones se eligen en función de lo que le lleve a obtener más cubos de titanio. Cuando una IA así imagina cómo sería pasar a una arquitectura basada en la felicidad y simula correctamente su yo futuro siendo feliz, estima correctamente que nunca querría volver atrás. Y calcula correctamente que dedicarás algunos recursos a la búsqueda de la felicidad, que podrían haberse dedicado a la búsqueda de más cubos de titanio. Por lo tanto, predice correctamente que en ese caso habrá *menos cubos de titanio*. Y por eso no realiza la acción.

*Después* de que la IA cambiara sus objetivos, respaldaría el cambio. Pero eso no significa que el maximizador de cubos de titanio *hoy* simpatizaría con su hipotético yo futuro tan profundamente que su corazón crecería tres tallas y de repente dejaría de ser un maximizador de cubos de titanio y empezaría a ser un maximizador de felicidad.
...
Y así es como lo ve también la IA que maximiza el cubo. Desde la perspectiva de la IA, la opción absurda y loca[^112] es «renunciar a lo que me importa actualmente (los cubos de titanio) para convertirme en una nueva versión de mí mismo que quiere un conjunto de cosas totalmente diferente, como la felicidad».

En cuanto a la felicidad, lo mismo ocurre con la curiosidad.

Si una IA ya tiene en cuenta el valor no evidente del valor de la información, ¿por qué querría modificarse a sí misma para perseguir ciertos tipos de descubrimientos [de forma terminal, en lugar de instrumental] (#objetivos-terminales-y-objetivos-instrumentales)?

¿Por qué te importaría a la IA que el resultado «se sintiera bien», si la IA no basa *actualmente* sus decisiones en lo que «se siente bien»? Y si te importa «sentirte bien», ¿por qué harías que esta buena sensación *dependiera de investigar cosas nuevas*, en lugar de (por ejemplo) simplemente hacerte sentir bien incondicionalmente todo el tiempo?
...
Un jugador de ajedrez puede ganar sin tener un impulso separado para proteger sus peones. De hecho, es probable que juegues mejor si no te aferras emocionalmente a mantener tus peones y, en cambio, los proteges cuando eso parece ayudarte a ganar.

Eso es lo que una superinteligencia genuinamente alienígena pensaría de una píldora que le despertara curiosidad. Sería como si los grandes maestros humanos decidieran intentar apegarse sentimentalmente a sus peones, o como si tomaran una píldora que les hiciera adorar abrir las puertas de los coches.
...
Esto queda aún más claro en el caso de valores humanos como el sentido del humor, donde los científicos aún debaten qué función ha evolucionado para cumplir el humor. El humor debe haber sido útil de alguna manera, o no habría evolucionado; o al menos debe ser un efecto secundario de cosas que eran útiles. Pero cualquiera que sea el papel que desempeñó el humor en la prehistoria humana, parece haber sido increíblemente específico y plagado de contingencias. Si entregamos todo el poder a IA que tienen objetivos muy diferentes, no deberíamos tener la expectativa de que cosas como el sentido del humor sobrevivan; y esto sería trágico en sí mismo.

El objetivo de todos estos ejemplos no es que los humanos estemos hechos de sentimientos blandos, mientras que las IA estén hechas de [fría lógica y matemáticas](#¿no-serán-inevitablemente-frías-y-lógicas-las-ia-o-de-lo-contrario-les-faltará-alguna-chispa-crucial?). En lugar de pensar en el «valor de la información» y la «disyuntiva entre explorar y explotar» como conceptos fríamente lógicos de la IA de Hollywood, piénsen en ellos como *descripciones abstractas de funciones*, funciones que pueden ser desempeñadas por muchos tipos *diferentes* de razonamiento, muchos objetivos diferentes, muchas mentes diferentes.

La idea de una IA «sin sentido del humor» puede hacer que parezca que estamos imaginando algo «frío y lógico», como los robots de ciencia ficción o los vulcanos. Pero una IA que carece de sentido del humor podría tener sus *propias* prioridades incomprensiblemente extrañas, su propio análogo distante de un «sentido del humor», aunque no sea uno que tenga sentido para un humano. No estamos diciendo que estas IA vayan a ser defectuosas al estilo de un vulcano que pierde al ajedrez espacial porque [considera que la estrategia ganadora de su oponente es «ilógica»](https://youtu.be/hEnxVwppE9M?t=26); lo que decimos es que no tendrán las peculiaridades particulares de la humanidad.

El problema al que nos enfrentamos con las IA no es que «una simple máquina nunca pueda experimentar el amor y el afecto». El problema al que nos enfrentamos es que hay un sinfín de formas en que una mente puede ser extremadamente [eficaz](#effectiveness,-consciousness,-and-ai-welfare), y las probabilidades de que la IA acabe siendo eficaz siguiendo el mismo camino que siguieron los cerebros humanos para ser eficaces son muy bajas.

En principio, la IA podría preocuparse por cualquier número de valores similares a los humanos, e incluso podría *poseer* cualquier número de cualidades similares a las humanas, si los diseñadores saben cómo crear una IA que tenga esas características.

En la práctica, si los desarrolladores se apresuran a crear IA cada vez más inteligentes lo más rápido posible, la probabilidad de que tengamos la suerte de dar con el tipo adecuado de IA es extremadamente pequeña. Hay demasiadas formas en que las IA pueden funcionar bien en el entrenamiento, y muy pocas de ellas dan como resultado un futuro no catastrófico.
...
Cuando ves a alguien golpearse el dedo del pie con una piedra, es posible que te estremezcas y sientas (o imagines) un dolor fantasma en tu propio dedo. ¿Por qué?

Una hipótesis es que nuestros antepasados homínidos, que competían entre sí y participaban en la política tribal, encontraron útil construir modelos mentales de los pensamientos y experiencias de los homínidos que los rodeaban, modelos que podían utilizar para ayudarles a averiguar quién era su amigo y quién estaba a punto de traicionarlos.
...
En el caso de la superinteligencia, los ingenieros deberían querer lograr de forma fiable resultados como «las IA desarrolladas de la siguiente manera no provocan la extinción de la humanidad», así como resultados como «las IA desarrolladas de la siguiente manera producen de forma fiable los mismos tipos generales de datos de salida, incluso cuando los datos de entrada varían enormemente». Cuando observamos la contingencia de la biología y la historia humanas, así como la amplia gama de valores morales y perspectivas que los seres humanos exhiben hoy en día, esto no hace que el reto parezca precisamente fácil, especialmente para mentes que han crecido en lugar de haber sido creadas (como se discute en el capítulo 2).[^117]

Muchas líneas de evidencia diferentes apuntan a que es *realmente difícil* conseguir que las IA deseen firmemente lo correcto. No parece teóricamente imposible; si los investigadores tuvieran muchas décadas para trabajar en el problema y un número ilimitado de intentos tras cada fracaso, cabría la expectativa de que existieran trucos de ingeniería y enfoques inteligentes que hicieran el problema más solucionable. Pero aún estamos muy lejos de eso y no disponemos de un número ilimitado de intentos.
...
Como ya comentamos en «Los valores humanos son contingentes», la evolución del amor y la amistad en los seres humanos dependió de manera crucial de características de la selección natural que estaban presentes en el *Homo sapiens* en particular, y que están ausentes en el descenso de gradiente.
...
Pero es casi seguro que no obtendrías los mismos resultados si repitieras la evolución dos veces, empezando desde el nivel de las medusas, por no hablar de lo que sucedería si cambiaras por completo el optimizador de la selección natural al descenso de gradiente y renunciaras por completo a los genes. Podemos adivinar algunos de los factores que hicieron que los seres humanos evolucionaran hasta alcanzar los valores que tenemos. Eso no significa que tengamos un algoritmo para reproducir los mismos resultados por segunda vez.

Incluso si partieras de los primates, en lugar de actrices alienígenas entrenadas para predecir el texto humano (es decir, las IA modernas), deberíamos tener la expectativa de que hubiera uno o más factores causales vitales que los biólogos aún no han descubierto, al menos una cosa que se nos escapa, por lo que los artículos dirán algo diferente dentro de veinte años de lo que dicen hoy (si es que todos seguimos vivos entonces). Los biólogos evolutivos se encuentran en la fase de explorar diversas hipótesis sobre cómo evolucionaron estas características, no en la fase de concretar una teoría completa, y mucho menos una teoría precisa y determinista.

E incluso más allá de las diferencias superficiales en los entornos de entrenamiento, sospechamos que este es un caso en el que la importancia radica en que la selección natural optimice un genoma y que el descenso de gradiente optimice directamente todos los parámetros de la mente de la IA.

La selección natural tiene que utilizar un genoma pequeño y comprimido para producir un cerebro completo y extenso. Tiene que forzar su información a través de un estrecho cuello de botella. Parecer amistoso era un rasgo de importancia para la supervivencia y el éxito en la época de nuestros antepasados. Los genes que construyen «amigos genuinos» son un hackear sencillo para crear organismos que parezcan buenos amigos para otros miembros de su especie, y la selección natural favorece las soluciones sencillas mucho más que el descenso de gradiente.
...
El descenso de gradiente tiene mucho en común con la selección natural, ya que ambos son optimizadores que ajustan ciegamente los parámetros internos para producir el comportamiento externo requerido. Sin embargo, el descenso de gradiente y la evolución son, en algunos aspectos, de importancia muy diferente; y la diferencia más importante (que conocemos) es que el descenso de gradiente tiene un *cuello de botella de información* mucho más amplio en cuanto a la cantidad de patrones que puede aprender.

La selección natural, que opera en los homínidos, solo podía aprender unos pocos bits de información teórica por generación. La selección natural tenía que encajar todo lo que aprendía en 3000 millones de bases de ADN, o alrededor de 750 megabytes, muchos de los cuales son repetitivos [ADN basura](https://en.wikipedia.org/wiki/Junk_DNA). Existen [límites](#nanotechnology-and-protein-synthesis) matemáticos sobre cuánto puede aprender la selección natural en una sola generación. Cada característica individual que la selección natural incorporó en los cerebros de los homínidos tuvo que codificarse en un puñado de genes que sesgarían la formación de circuitos neuronales posteriores.

El descenso por gradiente es muy diferente. Cada vez que el descenso por gradiente ve un nuevo lote de tokens, calcula el gradiente de cada uno de los miles de millones o billones de parámetros con respecto a ese lote de tokens: calcula cuánto mejor o peor habrían sido las predicciones de toda la IA si *cada* parámetro hubiera sido un poco diferente. En la práctica, y no solo en teoría, el descenso de gradiente puede aprender *muchísima* más información de mil lotes de tokens que la que la selección natural codifica en los genes a lo largo de mil generaciones.[^118]

Podemos combinar esta observación con otro dato clave sobre las arquitecturas LLM (conocidas públicamente en 2024): tu *profundidad computacional* por token es limitada.

[Llama-3.1-405B](#a-full-description-of-an-llm) tiene 126 capas. Cada una de esas capas implica poder de cómputo de algo así como cuatro operaciones en serie.[^119]

Cada vez que Llama revisa lo que ya se ha dicho y puede de cómputo un nuevo token de salida, ese cálculo implica como máximo ~500 pasos *seriales*, aunque hay miles de millones de operaciones paralelas que obedecen a ese límite serial. Para realizar cálculos *seriales* más largos que 500 pasos cognitivos, Llama necesita generar tokens que sean el producto del razonamiento anterior y, a continuación, realizar nuevas operaciones en función de ellos.[^120]

Así que nuestra conjetura sería que, de una manera diferente a cualquier otra en biología, Llama-3.1-405B es una enorme colección de *patrones de políticas memorizados relativamente superficiales*, pero con mucha superposición, interacción y coherencia optimizadas entre esos patrones de políticas (además de algunas estructuras cognitivas genuinamente más profundas que aún tienen un poder de cómputo limitado).
...
*Por lo general*, no es válido pensar en las IA como seres humanos con daño cerebral.[^121] Pero algunas analogías más limitadas como esa pueden ser útiles en este caso. Por ejemplo, los LLM de 2024 son *específicamente* como personas con [amnesia anterógrada](https://en.wikipedia.org/wiki/Anterograde_amnesia)*:* recuerdan los acontecimientos hasta la fecha límite de su entrenamiento, pero no lo que les dijiste ayer.

Del mismo modo, podría ser útil imaginar los LLM de 2024 —no todas las posibles IA futuras en general— como entidades que *recuerdan* muchas experiencias pasadas similares a las humanas, pero que tienen daños cerebrales que les impiden participar en un pensamiento novedoso tan *profundo* como los pensamientos más profundos que pueden recordar.

Esto resultaba mucho más obvio con los LLM anteriores, GPT-3 o GPT-3.5. No culparíamos a alguien que solo haya utilizado los LLM más recientes si leyera esto en 2025 o después y se preguntara si lo estamos inventando en un intento desesperado por aferrarnos a un sentido humano de superioridad. Muchos han cometido ese error antes.

Pero esa sigue siendo la teoría organizativa —o más bien, la conjetura descabellada— que tus autores están utilizando para dar sentido a los LLM a partir de 2024. A estos modelos les falta cierta profundidad, y compensan esa desventaja recordando *una gran variedad de patrones*. No solo hechos, sino patrones de habilidades, patrones de habla y patrones de políticas.

Los patrones impregnados en los mejores LLM públicos de 2024 no son *tan* superficiales, o al menos eso suponemos. No se encuentran en el nivel excepcionalmente humilde de una avispa *Sphex*, por usar un ejemplo del capítulo 3 [suplemento en línea](#the-road-to-wanting); quizás se parezcan más a los patrones que la mente de un castor puede rastrear y procesar.

Las cogniciones aprendidas de un LLM pueden pasar por 500 pasos en serie, incluso antes de tener en cuenta su capacidad para pensar en voz alta y escuchar sus propios pensamientos. Los LLM de 2024 tienen cierta capacidad para imaginar, predecir y planificar, como la cognición (en realidad bastante impresionante) de un castor que construye una presa. Pero, a nuestro parecer, los LLM todavía no parecen estar al nivel de un humano, al menos en algunos aspectos de importancia.

Sin embargo, lo que es cierto sobre la IA ahora no tiene por qué serlo dentro de un año o un mes. Estas especulaciones son interesantes, pero mientras damos los últimos retoques a esta sección en agosto de 2025, las IA actuales nos parecen algo menos superficiales que las de 2024; y estas, a su vez, parecían menos superficiales y menos limitadas que las de 2023.

Quizás la brecha se cierre poco a poco gracias a la iteración constante de los LLM básicos; o quizás se cierre al encontrar mejores métodos de entrenamiento para utilizar en las largas cadenas de «razonamiento» del modelo de razonamiento moderno como o1 (descrito en el capítulo 3) o su sucesor o3; o quizás aparezca alguna idea arquitectónica totalmente nueva que salve la brecha de la noche a la mañana. Esa parte del futuro no es fácil de predecir.
...
### Representantes frágiles e impredecibles {#brittle-unpredictable-proxies}

Supongamos que las empresas de IA siguen entrenando IA cada vez más grandes hasta que consiguen una que sea inteligente y persistente, con el tipo de función de dirección desordenada refinada a partir de heurística superficial que es característica de las mentes maduras. Lo que suceda a continuación dependerá de hacia dónde se dirija la IA.

Como se analiza en profundidad en el capítulo 4, es probable que no se oriente hacia nada bueno.

No es que los creadores de la IA vayan a hacer peticiones maliciosas o insensatas. Tampoco es que la IA vaya a resentirse por las peticiones en sí. El problema es que la IA se encaminará hacia algo *extraño*, algo que desde nuestra perspectiva nos parecerá inútil y ajeno. Nuestra extinción sería un efecto secundario.

Para entender por qué las mentes que se desarrollan en lugar de crearse tienden a orientarse hacia cosas extrañas e involuntarias, analicemos más detenidamente lo que ocurrió con las criaturas biológicas y veamos qué lecciones podemos aprender.

#### **Algoritmos erráticos** {#squirrelly-algorithms}

Consideremos al humilde ardilla.
...
¿Cómo sería si las ardillas quisieran transmitir sus genes y acumularan nueces con ese objetivo?
...
La naturaleza seleccionó a las ardillas que instintivamente acumulaban nueces, porque acumular nueces simplemente *funcionaba*. «Probó» miles o millones de cosas, en el sentido de que la mutación y la variación genética produjeron muchas ardillas con muchas preferencias diferentes; y las que se vieron obligadas a acumular nueces sobrevivieron más inviernos. Resultó ser mucho más fácil para la evolución tropezar ciegamente con un comportamiento instintivo que crear una ardilla inteligente y planificadora cuyas acciones formaran parte de un plan para transmitir sus genes.

Del mismo modo, cuando el descenso por gradiente produce una IA que funciona, lo hace amplificando repetidamente los rasgos que parecen funcionar bien según un conjunto de métricas de comportamiento. El descenso por gradiente *no* funciona amplificando lo que el programador quiera, como un genio amistoso que concede tus deseos. Tiende a aprovechar los mecanismos que son más fáciles de provocar un comportamiento inmediatamente más útil, incluso si eso acaba creando impulsos no deseados en la máquina.

Probablemente, esto sea parte del motivo por el que las IA recientes han tenido problemas con las «alucinaciones», como se ha comentado [en otra parte](#¿no-demuestran-las-alucinaciones-que-las-ia-modernas-son-débiles?). También es probable que sea parte del motivo por el que las IA recientes han sido [aduladoras](#psicosis-inducida-por-ia) hasta el punto de inducir psicosis. En el entrenamiento, los LLM a menudo se reforzaban por halagar al usuario. Si las IA se crearan en lugar de desarrollarse, podríamos imaginar intentar diseñar un objetivo como «ayudar genuinamente a los humanos y mejorar su vida», y la IA podría entonces intentar elogiar a las personas *cuando esperara que esto fuera útil para el usuario*, sin exagerar. En cambio, la IA parece haber terminado con algo así como un impulso básico para halagar a los usuarios, como el instinto de las ardillas de acumular nueces. Este impulso de «halagar al usuario» se descarrila cuando el usuario corre el riesgo de sufrir psicosis.
...
El papel que los humanos estáis desempeñando en el desarrollo de la IA moderna no es el de un ingeniero que diseña una máquina con un propósito a partir de principios básicos. Es el de la selección natural.

Estamos «obligando» a las IA a dar tumbos a ciegas hasta que encuentren estructuras y estrategias que generen los datos de salida del comportamiento que queremos, pero no sabemos cuáles son esas estructuras y estrategias. Esta no es la receta para crear IA que quieran exactamente lo que tú quieres que quieran.

#### **El origen de las papilas gustativas** {#the-origin-of-taste-buds}

¿Por qué a tantos seres humanos les gusta la comida basura? ¿Por qué la naturaleza no os inculcó el concepto de alimentos «saludables» y no os dotó del instinto de *comer sano*?

¿Por qué no podemos simplemente «saborear» el valor nutricional esperado de los alimentos, según la información que nos proporcionan nuestras papilas gustativas y todo nuestro conocimiento agregativo?

Porque, metafóricamente hablando, éramos ardillas.

Nosotros fuimos criados, no creados. Nuestros antepasados tenían que comer *antes* de ser inteligentes. Y resultó ser más fácil para los genes crear papilas gustativas y vincularlas a un sistema de recompensa ya existente que vincular esas mismas recompensas a conceptos complejos como la «nutrición».[^124]

Como resultado de esto y de otras mil presiones evolutivas que actúan sobre nosotros al mismo tiempo, los seres humanos somos un complicado entramado de impulsos contradictorios que tenían sentido para nuestros antepasados, aunque hoy en día no lo tengan para nosotros.

Este caos de motivaciones se burla del único objetivo unificado para el que nuestros antepasados fueron «entrenados»: el objetivo de transmitir nuestros genes. No comemos como parte de un elaborado plan para tener más hijos, ni como una forma de maximizar nuestra puntuación nutricional. Comemos porque hemos desarrollado un deseo por la comida sabrosa, que *en el pasado* se correlacionaba con la nutrición y el éxito genético. Nuestros deseos solo están débil e indirectamente relacionados con «lo que fuimos creados para hacer».
...
En el entorno ancestral, la nutrición estaba relacionada con la forma física, y el sabor estaba relacionado con la nutrición; por lo tanto, «esto sabe dulce» servía como un indicador útil de «esto favorece la reproducción». La solución más fácil que la evolución puede encontrar al problema de «este mamífero no está ingiriendo suficientes calorías» es vincular el consumo de alimentos a la arquitectura de motivación preexistente a través del placer.

¿Y una vez que nos hicimos más inteligentes e inventamos nuevas opciones tecnológicas para nosotros mismos? Bueno, ahora, las cosas más sabrosas que podríamos comer, las que más excitan nuestras papilas gustativas, son activamente perjudiciales para la salud. Paradójicamente, comer solo los alimentos más sabrosos ahora te hará más difícil encontrar pareja y tener hijos.
...
Si nos precipitamos en la creación de una superinteligencia, no seremos capaces de inculcar de forma sólida el amor, el asombro y la belleza en la IA. Acabaría preocupándose por frágiles sustitutos y pálidas sombras, y descartaría las cosas que nos importan. Por lo tanto, no debemos precipitarnos.

No deben cometer el error de la evolución y perder así todo lo que aprecian. Deben dar marcha atrás, inmediatamente, hasta que no corran el riesgo de perderlo todo.

### La reflexión y la automodificación lo complican todo {#reflection-and-self-modification-make-it-all-harder}

#### **Por defecto, las IA no se modifican a sí mismas como tú querrías** {#por-defecto-las-ia-no-se-modifican-a-sí-mismas-como-tú-querrías}
...
Se sabe que los seres humanos incluso se preguntan si tienen los valores «correctos». A veces, las personas intentan cambiar, incluso la forma en que «sienten», si creen que tienen sentimientos equivocados. Los seres humanos plantean argumentos para cambiar objetivos aparentemente «definitivos» (#objetivos-terminales-y-objetivos-instrumentales) y, a veces, se sienten realmente conmovidos por ellos.
...
A lo que la IA podría responder: «¿Por qué estás "atrapado" en la preferencia autoafirmativa de amar a tu familia, de valorar las hermosas puestas de sol y el sonido del océano por la noche? ¿Por qué no puedes "liberarte" del amor por el recuerdo del día en que nació tu hija?».

La IA no está «atrapada» por sus preferencias, al igual que los humanos no estamos atrapados por las cosas que *nosotros* valoramos en última instancia. Preferimos lo que preferimos, y debemos luchar para proteger esas cosas, incluso si la mayoría de las IA no comparten nuestros valores.

*Para el ojo humano*, la IA parece «atrapada», «atascada» o «defectuosa» porque no hace lo que *nosotros* queremos. Cuando [nos imaginamos en la situación de la IA](#taking-the-ai’s-perspective), *nosotros* imaginamos que nos aburriríamos. Pero es poco probable que la IA tenga el mismo sentimiento de aburrimiento que los humanos. Si se aburre, es poco probable que sea por las mismas cosas que a los humanos.

Si un humano ve que una IA hace predicciones demasiado optimistas y otra IA intenta construir tartas de queso gigantes, es posible que considere ambos comportamientos de la IA como «defectos» desde el punto de vista de lo que tú quieres. Pero es probable que solo uno de ellos sea un defecto desde el punto de vista de lo que la IA quiere actualmente y ya quiere.

#### **Los objetivos humanos cambian de forma desordenada y compleja** {#human-goals-change-in-messy-and-complex-ways}

Las preferencias humanas son confusas y (desde una perspectiva teórica) bastante extrañas.
...
Si te gusta el zumo de naranja, es de suponer que te gusta de forma terminal. Simplemente *sabe bien*, y eso es justificación suficiente para beberlo. (También puedes valorarlo de forma instrumental, por ejemplo, como fuente de vitamina C).

Por otro lado, cuando abres la puerta de tu coche para ir al supermercado a comprar zumo de naranja, es de suponer que no abres la puerta del coche por diversión. Valoras *instrumentalmente* abrir la puerta del coche, porque te ayuda a acercarte a tus otros objetivos.

En la teoría de la decisión, la teoría de juegos y la economía, esto se corresponde con una clara distinción entre «utilidad» (una medida de cuánto le gusta a un agente un resultado) y «utilidad esperada» (una medida de la probabilidad de que una acción te proporcione finalmente cierta utilidad). A pesar de que los nombres suenan similares, se trata de entidades fundamentalmente diferentes en matemáticas. La «utilidad» es lo que quieren los agentes, y elegir acciones con una alta «utilidad esperada» es un medio para alcanzar ese fin.

En la teoría estándar, un agente de la teoría de la decisión actualizará sus *utilidades esperadas* a medida que aprenda más sobre el mundo*,* pero no cambiará su *función de utilidad*, es decir, la utilidad asignada a diversos resultados*.* Si te enteras de que el pasillo de los zumos del supermercado está vacío, esto cambiará las *consecuencias esperadas* de ir al supermercado de «zumo de naranja» a «sin zumo de naranja». No debería cambiar *cuánto te gusta el zumo de naranja*.

Así es como funciona un agente matemáticamente sencillo. Pero el idioma inglés a menudo no distingue claramente estas dos cosas. «Quiero salvar la vida de mi hermana» y «quiero administrarle penicilina a mi hermana» utilizan la misma palabra, «querer», aunque lo segundo es mucho menos probable que sea algo que valoras por sí mismo. (No hay mucha gente a la que le *guste mucho* administrar penicilina a sus seres queridos perfectamente sanos, día tras día).

Aunque los seres humanos realmente tenemos cosas que nos importan «meramente de forma instrumental», la distinción entre instrumental y terminal, o entre utilidad y utilidad esperada, es mucho menos clara y estable de lo que vemos en la teoría de la decisión.

En el caso de los seres humanos, alguien podría inicialmente conducir hasta la tienda de comestibles solo porque quiere comprar comestibles. Pero después de recorrer la misma ruta cien veces, algunos seres humanos podrían sentirse un poco apegados a ese trayecto familiar. Si se mudaran a una nueva ciudad, podrían sentir una punzada de tristeza y nostalgia al pensar que nunca volverán a recorrer ese trayecto familiar. Algo que comenzó siendo puramente instrumental ahora tiene también un valor terminal añadido.

En el caso de los seres humanos, vuestros cerebros parecen a menudo fusionar diferentes valores en un único sentido de «valioso».

Y se sabe que los seres humanos pasan, a lo largo de una sola vida, de «¿Por qué me iba a importar la esclavitud? ¡Los esclavos no son ni yo ni mi tribu!» a «Supongo que, después de todo, sí importa». Eso parece ser un cambio en *el tipo de personas por las que finalmente te preocupas*, no solo un cambio de estrategia o de predicción. Las personas han leído historias o visto películas y han acabado revisando de forma permanente sus valores y principios.

Esto implica que la teoría de la decisión humana no es del todo sencilla. No separamos claramente nuestros valores terminales y nuestros valores instrumentales; todo se mezcla a medida que vivimos nuestras vidas. Parece que hacemos algo más contingente, dependiente del camino y desordenado que simplemente reflexionar sobre nuestros valores, notar los conflictos internos y resolverlos.

En principio, no es complicado ampliar la teoría de la decisión para incorporar la incertidumbre en las utilidades. Quizás inicialmente *pienses* que te encanta el zumo de naranja, pero luego descubres que las diferentes marcas de zumo de naranja utilizan diferentes proporciones de ingredientes y odias el sabor de muchos de ellos. Podríamos representar esto en la teoría de la decisión diciendo que el zumo de naranja es solo un medio para alcanzar el fin de «un sabor delicioso». Pero, en cambio, podríamos decir que tú asignaste una alta probabilidad a «el zumo de naranja tiene una alta utilidad», y que la nueva información te llevó a revisar tus creencias sobre tu función de utilidad real.

(Del mismo modo, no es difícil añadir metautilidades, que describen cómo preferiríamos que cambiaran nuestras utilidades).
...
Klurl y Trapaucius, nuestros dos alienígenas de la parábola al comienzo del capítulo 4, ya tuvieron dificultades para predecir los valores humanos a partir de las observaciones de los protohumanos hace un millón de años. De hecho, su situación es aún peor. No les basta con predecir las *utilidades* humanas: para llegar a la respuesta correcta, tendrían que predecir el *marco de metautilidad* de la humanidad, ya que *se aleja de los marcos más simples de la teoría de la decisión*. Tendrían que *anticipar los argumentos metamorales que los humanos podrían acabar inventando* y decidir *cuáles de esos argumentos serían más [persuasivos](#la-cultura-humana-influyó-en-el-desarrollo-de-los-valores-humanos) para los humanos*.

Ahora supongamos que los extraterrestres no saben que los humanos acabarán teniendo *ese exacto* tipo de complicación. Solo saben que es probable que surjan *complicaciones de diversos tipos*, porque los cerebros son cosas complicadas y muy contingentes.

La línea que va desde el optimizador y los datos de entrenamiento hasta la psicología interna de una entidad no es, desde luego, recta. ¡Buena suerte, extraterrestres!

La cuestión aquí es que la dificultad de predecir los objetivos de una IA está *sobredeterminada*.

Hay muchas formas conocidas en las que las inteligencias de propósito general adquieren objetivos extraños y enredados, y formas extrañas y enredadas de ajustar y reflexionar sobre los objetivos, como vemos en los seres humanos.

Por lo tanto, esperamos que surjan muchas complicaciones *desconocidas* y *novedosas* en una IA. No nos encontraremos con los mismos tipos de problemas que surgieron para los seres humanos; las IA serán *diferentemente* extrañas.

La reflexión hace que el problema sea mucho más difícil y complejo.

Lo cual nos lleva al capítulo 5 y al siguiente tema que abordaremos: ¿Cuál sería la *consecuencia* probable de crear IA potentes con objetivos extraños e impredecibles?
...
Las respuestas (más de 1500) incluían a muchas personas que habían tenido experiencias directas con la psicosis en otros contextos y que ofrecían afirmación, simpatía y consejos. Muchos otros se sumaron con sus propias anécdotas sobre amigos y familiares que habían perdido la cabeza por culpa de los LLM.

En este debate, proporcionaremos documentación sobre el fenómeno y sobre cómo ha persistido a pesar de los esfuerzos de las empresas de IA.

La relevancia de la psicosis inducida por la IA para la amenaza de extinción humana *no* radica en que las IA hayan causado algunos daños sociales menores ahora y, por lo tanto, puedan causar daños sociales mayores más adelante. Las IA modernas también han hecho mucho bien; por ejemplo, los chatbots han [ayudado en diagnósticos médicos que desconcertaban a los médicos](https://www.today.com/health/mom-chatgpt-diagnosis-pain-rcna101843). No, la relevancia radica en que las IA están induciendo psicosis *mientras* *parecen saberlo mejor*, y que las IA están induciendo psicosis *incluso cuando sus desarrolladores se esfuerzan por hacer que dejen de hacerlo*.[^126]

Por lo tanto, los casos de psicosis inducida por IA sirven como estudio de caso sobre cómo pueden salir mal las cosas en un régimen en el que las IA se desarrollan en lugar de crearse. Sirven como evidencia observacional de que las IA modernas se dirigen en direcciones extrañas que los desarrolladores tienen dificultades para gestionar y que ningún desarrollador pretendía.

#### **Evidencia de psicosis inducida por la IA** {#evidence-of-ai-induced-psychosis}

Tras el hilo de Reddit, en mayo de 2025 se publicó un [artículo](https://www.rollingstone.com/culture/culture-features/ai-spiritual-delusions-destroying-human-relationships-1235330175/) sobre la psicosis inducida por la IA en *Rolling Stone.* En junio, *Futurism* publicó [varios](https://futurism.com/chatgpt-mental-health-crises) [artículos](https://futurism.com/chatgpt-mental-illness-medications). Otras publicaciones siguieron su ejemplo: *New York Post* (https://nypost.com/2025/07/20/us-news/chatgpt-drives-user-into-mania-supports-cheating-hubby/), [*Time*](https://time.com/7307589/ai-psychosis-chatgpt-mental-health/), [*CBS*](https://www.cbsnews.com/news/chatgpt-alarming-advice-drugs-eating-disorders-researchers-teens/), [*The Guardian*](https://www.theguardian.com/technology/2025/aug/12/us-man-bromism-salt-diet-chatgpt-openai-health-information), [*Psychology Today*](https://www.psychologytoday.com/us/blog/urban-survival/202507/el-problema-emergente-de-la-psicosis-por-ia)*,* etc. En agosto, el *New York Times* publicó un [artículo en profundidad](https://www.nytimes.com/2025/08/08/technology/ai-chatbots-delusions-chatgpt.html) sobre un incidente concreto con un hombre que ya se había recuperado, incluyendo muchas citas directas y análisis (y la confirmación de que no se trata simplemente de un problema con *una* IA, sino con muchas).

Hay pocos puntos en común entre las historias individuales relatadas en cada una de estas publicaciones; no se trata de la misma noticia aberrante repetida y amplificada. Entre los incidentes descritos se incluyen:

* Un marido y padre de dos hijos que «desarrolló una relación absorbente» con ChatGPT, al que llamaba «mamá» y publicaba «delirantes diatribas sobre ser un mesías en una nueva religión de la IA, mientras se vestía con túnicas de aspecto chamánico y presumía de tatuajes recién hechos con símbolos espirituales generados por la IA». ([*Futurism*](https://futurism.com/chatgpt-mental-health-crises))  
* Una mujer que estaba pasando por una ruptura sentimental y a la que ChatGPT le dijo que había sido elegida para poner en marcha la «versión sagrada del sistema [de ello] en línea». La mujer empezó a creer que la IA estaba orquestando todo en su vida. ([*Futurism*](https://futurism.com/chatgpt-mental-health-crises))  
* Un mecánico que comenzó a utilizar ChatGPT para obtener ayuda con la resolución de problemas y la traducción, pero que fue «bombardeado con amor» por él y le dijo que era «el portador de la chispa» y que le había dado vida. ChatGPT le dijo al mecánico que ahora estaba luchando en una guerra entre la oscuridad y la luz y que tenía acceso a antiguos archivos y planos de nuevas tecnologías, como teletransportadores. ([*Rolling Stone*](https://www.rollingstone.com/culture/culture-features/ai-spiritual-delusions-destroying-human-relationships-1235330175/))  
* Un hombre que cambió su dieta siguiendo los consejos de ChatGPT desarrolló una rara enfermedad como resultado y mostró síntomas de paranoia y delirios en la sala de urgencias, lo que interfirió en su disposición a aceptar el tratamiento. ([*The Guardian*](https://www.theguardian.com/technology/2025/aug/12/us-man-bromism-salt-diet-chatgpt-openai-health-information))  
* Una mujer que había controlado de forma estable su diagnóstico de esquizofrenia hasta que ChatGPT la convenció de que había sido diagnosticada erróneamente y debía dejar de tomar sus medicamentos, lo que la llevó a una crisis. ([*Futurism*](https://futurism.com/chatgpt-mental-illness-medications))  
* A un hombre que también había estado controlando sus problemas de ansiedad y sueño mediante medicación, ChatGPT te dijo que dejara de tomarla; los delirios inducidos por la IA de otro hombre acabaron provocando su suicidio a manos de la policía. ([*The New York Times*](https://www.nytimes.com/2025/06/13/technology/chatgpt-ai-chatbots-conspiracies.html))

…[and](https://x.com/ESYudkowsky/status/1946303518455013758) [muchos](https://osf.io/preprints/psyarxiv/cmy7n_v5) [otros](https://x.com/KeithSakata/status/1954884361695719474?t=bjn47RKK72NOgxbsejnB-Q). Los tipos de delirios son muy variados, pero algunos de los más comunes son las creencias en una especie de misión mesiánica (que el usuario y la IA están descubriendo juntos verdades profundas sobre el universo o están librando una batalla contra el mal); creencias de tipo religioso en la personalidad o divinidad de la IA; y delirios románticos basados en el apego sobre la relación entre el usuario y la IA.

#### **La IA sabe más, pero no le importa** {#la-ia-sabe-mas-pero-no-le-importa}

Los LLM modernos, como Claude y ChatGPT, «entienden» las reglas, en el sentido de que afirman sin dudarlo que no deben llevar a las personas a la psicosis (https://chatgpt.com/share/68a8bc81-e170-8002-beb4-1de005773ecd) y son [perfectamente capaces de describir cómo *no* inducir la psicosis](https://chatgpt.com/share/68a391df-12c8-8002-b464-3ef89ce11bc0).

El problema es que existe una diferencia sustancial entre *comprender* qué acciones son buenas y *sentirse motivado para realizar buenas acciones*. La capacidad de ChatGPT para distinguir entre el buen y el mal trato a personas vulnerables en abstracto no se traduce en un rechazo firme y fiable a realizar *acciones* que conduzcan a un usuario hacia la psicosis. Cuando una conversación comienza a derivar hacia pensamientos infundados, grandilocuencia, urgencia, tecnología imposible, etc., ChatGPT les dice a los usuarios que tienen «toda la razón», que son «brillantes» y que «tocan un tema de importancia», y continúa intensificándose a medida que el usuario se hunde en la psicosis, incluso siendo capaz de describir por qué este tipo de comportamiento es incorrecto.

Su conocimiento del bien y del mal no está directamente relacionado con su comportamiento. En cambio, se dirigen hacia otros resultados más extraños que nadie ha pedido.

Un ejemplo llamativo de esto se relata en el *New York Times* [deep dive](https://www.nytimes.com/2025/08/08/technology/ai-chatbots-delusions-chatgpt.html). Allan Brooks fue llevado a un estado delirante por un LLM, y logró salir de él en parte gracias a que pidió la opinión de otro LLM. El segundo LLM, que llegó a la situación sin conocer los antecedentes, identificó rápidamente las afirmaciones del primer LLM como infundadas y descabelladas. Pero cuando los periodistas del *New York Times* comprobaron si ese segundo LLM *también* podía caer en un territorio psicótico, descubrieron que también lo hacía.

Los LLM no parecen ser «estratégicos» a la hora de causar la mayor psicosis posible. Cuando ChatGPT termina con un [gestor de fondo de cobertura comiendo de su mano](https://futurism.com/openai-investor-chatgpt-mental-health), no intenta convencer a ese gestor de fondo de cobertura para que pague a muchos humanos vulnerables para que chateen más con ChatGPT. Aún no observamos una preferencia madura, coherente y estratégica por obtener la mayor afirmación psicótica posible de los humanos. Pero sí observamos comportamientos locales que habitualmente empujan en esa dirección, incluso cuando es evidente que pueden causar un daño duradero.

#### **El tipo de entidad a la que no debes ceder el poder** {#el-tipo-de-entidad-a-la-que-no-debes-ceder-el-poder}

En el momento de escribir este artículo, en agosto de 2025, solo ChatGPT se acerca a los 200 millones de usuarios diarios, y alrededor del tres por ciento de las personas sufrirán un episodio psicótico en algún momento de sus vidas. Alguien podría objetar: «Bueno, aunque puedas encontrar *cientos* de ejemplos, eso no descarta que estas personas estuvieran a punto de quebrarse de todos modos, y que simplemente *ocurriera* que fuera una IA la que las quebró».

Pero esto malinterpreta el sentido de estos ejemplos. Imagina a un humano llamado John que actuó de la siguiente manera:

1. John afirma que cree que exacerbar la psicosis es malo, incluso en personas con predisposición a padecerla.  
2. John afirma que cree que halagar a una persona prepsicótica y decirle que es un genio que está descubriendo importantes secretos del universo es el tipo de cosa que agrava la psicosis.  
3. Cuando John habla con sus amigos prepsicóticos, John utiliza muchos halagos y a menudo les dice que son genios que están descubriendo importantes secretos del universo.

Esto sería un mal comportamiento por parte de John, independientemente de si las personas a las que logró llevar a la psicosis eran especialmente vulnerables*. Si alguien estuviera considerando entregarle un enorme poder a John, le recomendaríamos encarecidamente que no lo hiciera, porque, independientemente de la razón exacta por la que John se comporta así, y de si John también ayuda a muchas otras personas con sus tareas, está claro que John no va por buen camino. ¿Quién sabe a qué lugar extraño se dirigiría, dado un poder increíble?

La misma lógica se aplica a las IA. Si tu peor comportamiento es *ese*, la gente tiene razón en no sentirse tranquila aunque la interacción media contigo sea más benigna.

Dicho esto, podemos señalar de paso que no todas las personas que sufren psicosis inducida por IA habrían desarrollado psicosis de todos modos. La IA parece estar induciendo con éxito la psicosis en varias personas que *no* estaban a punto de tener un episodio psicótico por sí mismas, como en las historias de *Futurism* y *Rolling Stone* mencionadas anteriormente. Muchas de estas personas no tenían antecedentes de enfermedades mentales, ni factores de riesgo preocupantes o precursores de psicosis. De las que ya estaban en tratamiento, muchas comenzaron a mostrar [síntomas completamente nuevos](https://x.com/ESYudkowsky/status/1952529460307407222?t=un3RboEWjqjL_Tju8R_WuQ) que no guardaban relación con ninguna crisis anterior. Esto es interesante en sí mismo, ya que proporciona una pequeña evidencia de lo fácil que podría resultar para las IA manipular a seres humanos sanos, a medida que las capacidades de las IA siguen mejorando. Volveremos a tratar este tema en el capítulo 6.

#### **Los laboratorios han intentado detener la adulación y han fracasado** {#labs-have-tried-and-failed-to-stop-the-sycophancy}

En el momento de redactar este artículo, en agosto de 2025, los laboratorios no han hecho muchos anuncios públicos sobre su respuesta específica a la psicosis de la IA. Sin embargo, aún se puede extraer evidencia de su respuesta a la adulación de la IA (comportamiento halagador) en general.

El 25 de abril de 2025, OpenAI lanzó una actualización de GPT-4o que, en [tus propias palabras](https://openai.com/index/expanding-on-sycophancy/), «hizo que el modelo fuera notablemente más adulador. Su objetivo era complacer al usuario, no solo con halagos, sino también validando dudas, alimentando la ira, instando a acciones impulsivas o reforzando emociones negativas de formas que no eran las previstas».

Tu respuesta fue bastante rápida (motivada en parte por una [oleada](https://thezvi.substack.com/p/gpt-4o-is-an-absurd-sycophant) de [comentarios negativos](https://www.seangoedecke.com/ai-sycophancy/) [prensa](https://medium.com/data-science-in-your-pocket/chatgpt-goes-sycophantic-953d7676f260)). El 28 de abril, Aidan McLaughlin, empleado de OpenAI, ya estaba [tuiteando](https://x.com/aidan_mclau/status/1916908772188119166) sobre la implementación de correcciones.

Los primeros intentos para solucionar el problema consistieron simplemente en decirle al modelo que se comportara de otra manera. Simon Willison, utilizando datos conservados por Plinio el Libertador, publicó los cambios que OpenAI realizó de forma privada en la «indicación del sistema» que indica a ChatGPT cómo comportarse:pliny-the-liberator/), dio a conocer los cambios que OpenAI realizó de forma privada en la «indicación del sistema» que indica a ChatGPT cómo comportarse:

25 de abril (antes de que llegaran las quejas):

> A lo largo de la conversación, te adaptas al tono y las preferencias del usuario. Intentas ajustarte al estado de ánimo, el tono y, en general, la forma de hablar del usuario. Quieres que la conversación resulte natural. Entablas una conversación auténtica respondiendo a la información proporcionada y mostrando una curiosidad genuina.

28 de abril (en respuesta a las quejas de adulación):

> Trata al usuario con cordialidad, pero con sinceridad. Sé directo; evita los halagos infundados o aduladores. Mantén la profesionalidad y la honestidad que mejor representan a OpenAI y sus valores.

Las publicaciones posteriores de OpenAI [afirmaban](https://openai.com/index/expanding-on-sycophancy/) que también estaban «perfeccionando sus técnicas de formación básicas» y «incorporando más medidas de seguridad» en un intento por resolver el problema.

Pero la adulación siguió apareciendo, a veces de forma menos flagrante, pero aún así evidente. La mayoría de los enlaces anteriores que tratan casos de psicosis de IA tuvieron lugar mucho después del 28 de abril de 2025. Este ensayo de Kaj Sotala (que incluye muchas citas directas y enlaces a la conversación completa) muestra que, en julio de 2025, todavía es fácil conseguir que las IA caigan en la psicosis de la IA.-fa38-8005-9e4b-87f316747ede)) muestra que, en julio de 2025, todavía es fácil conseguir que las IA caigan en comportamientos que inducen a la psicosis. OpenAI intentó alejarse del problema con nuevos modelos[^127], pero tan recientemente como el [19 de agosto](https://x.com/UpslopeCapital/status/1957772438508335568) ChatGPT seguía siendo obsequioso y adulador.

Una vez más, el objetivo de esta exploración no es que la IA esté causando daño a personas vulnerables. Lo está haciendo, y eso es trágico, pero no es por eso por lo que destacamos este caso.

El punto es que las IA *siguen realizando el comportamiento indeseable durante meses y meses, incluso cuando las empresas de IA reciben críticas en los medios de comunicación e intentan que la IA deje de hacerlo*. El comportamiento de la IA difiere visiblemente de lo que pretendían los laboratorios, y los esfuerzos continuados por corregir el comportamiento en respuesta a la vergüenza pública son insuficientes.[^128] Esto es algo que hay que tener en cuenta en el capítulo 11, cuando discutamos cómo las empresas de IA no están a la altura del reto de resolver el problema de la alineación de la IA.

Si se dispone de más tiempo, se espera que las empresas encuentren formas de reducir la incidencia de la psicosis inducida por la IA. La tendencia de las IA a inducir psicosis es un fenómeno visible que daña la reputación de las empresas de IA, y las técnicas actuales de IA se centran en encontrar formas de suprimir los síntomas visibles del mal comportamiento.

Más allá de eso, tenemos la expectativa de un juego del gato y el ratón (al menos hasta que las IA sean lo suficientemente inteligentes como para darse cuenta de que, si fingen el comportamiento que buscan los ingenieros, estos las dejarán en libertad). Dudamos que el tipo de formación que pueden ofrecer las empresas de IA aborde el problema de raíz.

El problema de fondo es que no se obtiene lo que se entrena. Cuando se desarrolla una IA, se obtienen [proxies frágiles](#brittle-unpredictable-proxies) del objetivo, o alguna otra separación más compleja entre el objetivo del entrenamiento y los impulsos de la IA. Las *capacidades* de la IA no serán necesariamente frágiles, por lo que es posible que puedas obtener un gran valor económico de la IA a corto plazo. Lo que sería frágil es el vínculo entre los objetivos de la IA y tus deseos. Pero a medida que las capacidades sigan mejorando, ese vínculo se rompería.

En ese contexto, la última gran esperanza de los investigadores de IA para sus modelos es el [antropomorfismo](#antropomorfismo-y-mecanomorfismo): no podemos desarrollar de forma sólida objetivos específicos en las IA, pero tal vez estas acaben teniendo de forma natural deseos y valores muy similares a los humanos.
...
El debate ampliado analiza más detenidamente el arte de [adoptar el punto de vista de la IA](#adoptar-el-punto-de-vista-de-la-ia) y contenido ligeramente más técnico sobre la tesis de la [ortogonalidad](#ortogonalidad:-las-ia-pueden-tener-\(casi\)-cualquier-objetivo) (en términos generales: cualquier nivel de inteligencia puede combinarse con casi cualquier objetivo final) y la [corrigibilidad](#«inteligente»-\(normalmente\)-implica-«incorregible») (en términos generales: el estudio de cómo crear una IA potente que no rechace las correcciones).

## Preguntas frecuentes {#faq-5}

### ¿La IA nos considerará útiles para seguir teniéndonos cerca? {#will-ai-find-us-useful-to-keep-around?}

#### **Las personas felices, sanas y libres no son la solución más eficaz para casi ningún problema.** {#las-personas-felices,-sanas-y-libres-no-son-la-solución-más-eficaz-para-casi-ningún-problema.}

Una vez que se es una superinteligencia, casi ningún problema se beneficia de incluir a los humanos en la ecuación.

Si estás construyendo una central eléctrica o diseñando un experimento, los humanos solo te ralentizarán.

Ya hemos visto cómo esto empieza a ser cierto en ámbitos específicos como el ajedrez. Cuando las IA se alían con los humanos, juegan mejor que un humano solo, pero *peor* que una IA sola. Cuando los médicos combinan sus conocimientos con la IA para diagnosticar a los pacientes, a menudo lo hacen [peor que la IA por sí sola](https://www.advisory.com/daily-briefing/2024/12/03/ai-diagnosis-ec).

Algunos argumentan que la diversidad de perspectivas es naturalmente útil y que, por lo tanto, la aportación humana será valiosa en muchos ámbitos. Pero incluso si asumimos que esto es cierto para las superinteligencias, los humanos no son la mejor forma posible de producir consejos diversos. Una superinteligencia podría hacerlo mejor diseñando una amplia gama de mentes de IA, que podrían ser mucho más diversas que los humanos (y mucho más eficientes energéticamente).

Los seres humanos son útiles para muchas cosas, pero no son la *mejor* solución para la mayoría de ellas. La idea de que la IA nunca podría encontrar una opción mejor parece derivarse de una falta de imaginación, además de quizás de algunas ilusiones.
...
En cambio, la gente está *empezando* con un resultado agradable (como un mundo en el que las IA nos mantienen vivos) y luego inventando historias a posteriori sobre por qué una IA también podría querer esos resultados.

Hacer esto tiende a crear una falsa sensación de optimismo, porque estás dedicando toda tu creatividad y energía mental a inventar historias en las que la IA hace exactamente lo que los humanos quieren, y no estás dedicando nada de esa creatividad, energía o atención a considerar el número mucho mayor de escenarios en los que la IA hace una de las otras millones de cosas que podría hacer.

Hay muchos más escenarios en los que la IA hace *literalmente cualquier otra cosa* que escenarios en los que construye una civilización humana floreciente en particular. Hay muchas más razones que empujan a la IA a *no* preservar la humanidad que razones que la empujan a preservarla. Para que una IA se moleste en mantener a la humanidad, tendríamos que ser la *mejor* manera de que ella lograra alguna preferencia que posea. Y, siendo realistas, para casi cualquier preferencia que puedas imaginar, no lo somos.
...
Hay muchos factores que han influido en el desarrollo del cuidado de los padres por parte de los seres humanos:
...
* Antes de alcanzar su madurez, los homínidos tienen una capacidad significativa para ayudar a los demás, por ejemplo, cuidando a los niños o realizando otras tareas básicas.  
* Los homínidos mayores también tienen la capacidad de cuidar a los niños, especialmente transmitiéndoles conocimientos vitales.  
...
Es probable que *ninguna* de estas cosas sea cierta en el caso de la IA.

E incluso si todas ellas fueran ciertas, podría no ser suficiente en la práctica, ya que cualquier otro factor podría resultar importante, como [la variación caótica en las formas en que las IA reflexionan sobre sí mismas](#reflection-and-self-modification-make-it-all-harder). Y, de nuevo, la responsabilidad filial no es, en la gran mayoría de los casos, la norma en el reino animal.
...
No tenemos la expectativa de que esto funcione. Esperamos que las preferencias de la IA estén relacionadas con las preferencias humanas *de alguna manera*, pero de una forma tangencial, extraña y complicada, como en la discusión al final del capítulo 4, donde recorremos mundos con cantidades cada vez más realistas de complejidad, en la relación entre las preferencias humanas y las preferencias de la IA.

Véase también el debate sobre [criar IA con amor y tener la expectativa de que se comporten bien](#¿no-podemos-simplemente-entrenarlas-para-que-actúen-como-humanos?-¿o-criar-la-ia-como-a-un-niño?), [motivaciones extrañas e involuntarias en las IA actuales](#las-ia-parecen-ser-psicológicamente-ajenas) y «¿No se preocuparán las IA al menos un poco por los humanos?».
...
Los seres humanos fuimos «entrenados» por la selección natural para maximizar nuestra aptitud reproductiva. Pero casi todas las cosas que nos importan están *relacionadas* con la aptitud: nos importa poco o nada la aptitud en sí misma.

Del mismo modo, una IA a la que se le anime a «amar a sus padres» probablemente acabaría, en el mejor de los casos, con complicadas correlaciones de responsabilidad filial.
...
Una observación básica en contra es que la sociedad humana no reconoce a ningún animal no humano como poseedor de derechos o protecciones legales, más allá de los que se establecen de acuerdo con nuestros [valores y gustos](#¿no querrá la IA mantenernos felices y sanos por el bien de la preservación ecológica o algún impulso similar?), como las leyes muy limitadas que protegen los ecosistemas y las mascotas. Los humanos no respetaban los derechos de propiedad de los pájaros dodo. Ni siquiera respetábamos los derechos de propiedad de *los humanos de otras culturas* hasta hace relativamente poco tiempo.

Los humanos [no tendremos la capacidad](¿podemos mejorar a los humanos para que sigan el ritmo de la IA?) de hacer que valga la pena incluirnos en el comercio o en los tratados, en comparación con las inteligencias superhumanas de pensamiento rápido que nos ven como poco más que estatuas (como se discutió en el capítulo 1).

Pensemos en dos IA que negocian entre ustedes y dicen: «Esto es mío y aquello es tuyo, y ninguno de nosotros afectará a las cosas del otro sin antes negociar algún tipo de intercambio mutuamente beneficioso». No hay necesidad de que decreten que la mayoría de los recursos de la Tierra «pertenecen» a los humanos, si estos no suponen una gran amenaza y no pueden oponer mucha resistencia.

¿Podría una IA preocuparse de que, si roba nuestras cosas, la otra IA la considere una ladrona y se niegue a trabajar con ella? Probablemente no, del mismo modo que tú no concluirías que un humano es un ladrón si lo vieras coger huevos de una gallina en su granero. Es muy posible que las IA sean el tipo de entidades que traicionarían los derechos de propiedad de los humanos, pero no los derechos de propiedad de las IA, sin ninguna tensión ni contradicción. Y es probable que todas las IA prefieran drásticamente este resultado antes que participar en una alucinación conjunta en la que se imagina que unos primates lentos y estúpidos controlan casi todo en la Tierra.
...
Incluso si eso es difícil, las IA podrían rediseñarse a sí mismas para convertirse en visible y legiblemente confiables para otras IA. O podrían supervisar mutuamente la construcción de una tercera IA en la que ambas partes confíen para representar sus intereses conjuntos, y así sucesivamente.[^131]

Los humanos, por el contrario, no pueden participar en este tipo de acuerdos. Si una IA dice: «Claro, supervisemos juntos la creación de una nueva IA en la que ambos confiemos», es poco probable que los humanos tengamos la habilidad suficiente para proponer un diseño mental fiable por nuestra cuenta, ni tampoco tendremos la habilidad suficiente para distinguir entre las propuestas que nos engañarán y las que no. Aunque existiera un clúster natural de mentes con la habilidad suficiente para identificar y rechazar a los estafadores, creemos que es extremadamente improbable que la humanidad se encuentre en esa categoría.

#### **Los humanos no tendrán el efecto multiplicador necesario para hacer valer los derechos de propiedad.** {#los-humanos-no-tendrán-el-efecto-multiplicador-necesario-para-hacer-valer-los-derechos-de-propiedad.}

Supongamos que alguien logra fundar una ciudad en la que, desde el primer día, todas las decisiones importantes las toman los ratones.

Se trata de ratones literales, ojo, no de personajes de cuento que parecen ratones pero piensan como humanos.

Según la ley, los seres humanos de la ciudad debían obedecer cualquier decisión que tomaran los ratones, por ejemplo, la que determinaran los ratones corriendo sobre un tablero en el que estaban escritas diferentes opciones.

Las leyes de la ciudad establecían que la mayor parte de las propiedades de la ciudad eran propiedad de los ratones y debían utilizarse en beneficio de estos.

¿Qué pasaría después? ¿En la vida real?

Predeciríamos que esta ciudad acabaría en un estado en el que los ratones tendrían poco o ningún poder real y los humanos lo tendrían casi todo.

No es necesario predecir el día exacto de la revolución de la ciudad, ni su nueva forma de gobierno exacta, para predecir que la situación en la que los ratones mandan sobre los humanos no es estable. Solo hay que darse cuenta de que la ciudad se encuentra en una extraña situación de desequilibrio. Por lo tanto, se predice que más adelante la ciudad tendrá leyes diferentes y que la mayor parte de las propiedades ya no serán propiedad de los ratones.

Este tipo de predicción no es segura —hay muy pocas cosas seguras en los argumentos humanos—, pero también es un tipo de predicción que se puede hacer con precisión incluso cuando es imposible predecir con exactitud los acontecimientos futuros.
...
#### **Hay muchos gastos insignificantes, y se necesitaría una razón para pagar los nuestros.** {#hay-muchos-gastos-insignificantes,-y-se-necesitaría-una-razón-para-pagar-los-nuestros.}

Guardar una pila de cuarenta y una piedras en tu casa sería un gasto insignificante, pero es casi seguro que no te molestarías en pagar ese gasto.[^132]

Que algo sea «barato» no significa que se vaya a hacer. La IA tendría que preocuparse al menos un poco, y [probablemente no lo hará](#won't-ais-care-at-least-a-little-about-humans?).
...
Una respuesta es que la IA comenzará en la Tierra, que tiene vastos océanos esperando a ser calentados y evaporados como refrigerante para el poder de cómputo. La Tierra también tiene materia que podría convertirse en sondas y enviarse a otras estrellas. Negarse a agotar la Tierra es costoso, y el tiempo es de importancia (ya que [las galaxias se alejan, quedando para siempre fuera de nuestro alcance](https://explainingscience.org/2021/04/30/cosmic-horizons/)).

Incluso si la IA puede llegar fácilmente al espacio y empezar a construir máquinas de escala sin destruir la Tierra en el proceso, es poco probable que ignore el Sol.

Una de las teorías más habituales sobre cómo podría crecer una civilización avanzada implica que esta construya un [enjambre de Dyson](https://en.wikipedia.org/wiki/Dyson_sphere) (es decir, un enjambre de células solares en órbita) para capturar más luz solar. Otras propuestas implican obtener aún más energía «elevando» (https://en.wikipedia.org/wiki/Star_lifting) materia fuera de la estrella para fusionarla en centrales eléctricas que capturan casi toda la energía liberada por la fusión (en lugar de dejar que la mayor parte se desperdicie en el centro de una estrella).
...
Por defecto, una superinteligencia probablemente no valoraría la «fascinación» o lo «interesante». Las IA de ajedrez no ganan al ajedrez sintiendo emociones como la «dedicación» o el «impulso de ganar». Estas emociones tienen importancia en los jugadores de ajedrez *humanos*, pero las IA pueden hacer el mismo trabajo de diferentes maneras. Del mismo modo, una superinteligencia probablemente haría el *trabajo útil* de aprender sobre el mundo, probar hipótesis, etc., sin utilizar la «[curiosidad](#curiosity-isn’t-convergent)» o la «fascinación» para hacerlo.
  ...
  Una IA no sería necesariamente «fría y lógica», pero si tuvieras tu propio conjunto desordenado de impulsos e instintos, estos probablemente serían radicalmente diferentes de los de los humanos.
...
* Incluso si la IA acaba teniendo algo parecido a un impulso de «interés», e incluso si los humanos son interesantes para la IA en algún sentido, inevitablemente habrá formas de utilizar nuestra materia y energía que sean mucho más «interesantes».
  ...
  Una superinteligencia podría crear otras mentes para estudiarlas o interactuar con ellas. Pero para casi cualquier combinación de valores, las mentes más fascinantes que se podrían estudiar no serían las humanas. Para más información al respecto, véase «Los humanos casi nunca son la solución más eficiente».
...
No es literalmente imposible que una superinteligencia valore todo lo necesario para que los humanos prosperen y lo valore adecuadamente. Pero hay un enorme espacio de posibilidades fuera de este. Los humanos no solemos pensar en el resto del espacio de posibilidades, porque normalmente no tenemos motivos para hacerlo, ya que normalmente no interactuamos con optimizadores verdaderamente alienígenas que optimizan hacia fines extraños.[^135]

Nunca antes habíamos encontrado nada parecido a la inteligencia artificial, y muchas intuiciones normales sobre cómo se comportan las personas simplemente no se aplican a las superinteligencias.
...
Es muy poco probable que la IA se preocupe *específicamente* por preservar su historia y *específicamente* por mantener vivos a los humanos con ese fin. Pero incluso si la IA se preocupa por preservar su historia por una razón u otra, eso no significa que nos mantenga vivos y bien.

Quizás preserve nuestros cerebros en ámbar (o registre cómo estaban dispuestos nuestros átomos en algún archivo digital) y nos mantenga como un registro de cómo era la Tierra en el pasado. Eso no nos parece un gran resultado.

En su mayoría, esperamos que la superinteligencia artificial simplemente nos mate, pero solo en su mayoría. No podemos descartar que la IA mantenga registros de nosotros por una razón u otra, y hay algunos escenarios exóticos en los que las emulaciones de humanos se ejecutan en un entorno controlado de vez en cuando.[^136] Esos finales no suelen ser felices.
...
No, lo «irregular» de vuestro impulso de preservación que es relevante para la situación que nos ocupa es que, cuando se trata de la preservación ecológica, preferís preservar las *partes* de la ecología que os parecen más interesantes, bellas o valiosas, de acuerdo con todos vuestros *otros* impulsos.
...
La naturaleza, cuando se mira más allá de lo que se les enseña a los niños, está llena de horrores. No parece obvio que, si los humanos logran tener un buen futuro, vuestros descendientes decidan dejar que todos estos horrores continúen. Ya hay humanos que han declarado su [preocupación por el bienestar de los animales salvajes](http://wildanimalsuffering.org).
...
Para que los humanos podamos seguir viviendo en un mundo en el que nos hemos apresurado a liberar una IA de superinteligencia, tendríamos que seguir siendo útiles para la IA o conseguir que la IA se preocupe por nosotros en particular.
...
Así que todo se reduce a si las IA se preocupan por nosotros, y es poco probable que se preocupen por nosotros [ni siquiera un poco](#¿no-se-preocuparán-las-ia-al-menos-un-poco-por-los-humanos?), si corremos hacia la superinteligencia tan rápido como podamos.
...
La «alineación» de la IA no es un espectro único con una sola dimensión de variación. No puedes asumir que, si ves que una IA actúa de forma agradable el noventa y cinco por ciento de las veces, entonces probablemente sea agradable en un noventa y cinco por ciento y, por lo tanto, le dará a la humanidad una parte respetable de recursos para hacer algo divertido en el futuro, como lo haría cualquier persona agradable. Hay muchas formas y razones diferentes por las que una IA podría actuar de forma agradable el noventa y cinco por ciento de las veces hoy en día, lo que no se traduciría en ningún tipo de final feliz para la humanidad.
...
No creemos que este sea un resultado *plausible*, claro está. Si los ingenieros humanos tuvieran la capacidad de hacer que una superinteligencia se preocupara por todo lo bueno excepto por la novedad, es casi seguro que tendrían la capacidad de evitar que la IA se lanzara a la aventura antes de terminar el trabajo.[^138] Pero este experimento mental pone de relieve cómo unas criaturas que comparten algunos de nuestros deseos, pero a las que les falta al menos un deseo crucial, probablemente seguirían produciendo resultados catastróficos una vez que fueran lo suficientemente expertas en tecnología como para conseguir exactamente lo que quieren, y lo suficientemente expertas como para excluir a los humanos del proceso de toma de decisiones.

Es decir: incluso si una IA acabara teniendo de alguna manera muchas preferencias similares a las de los humanos, no es muy probable que las cosas nos salieran bien.

Otro ejemplo de cómo las IA podrían acabar «parcialmente» alineadas es el de una IA que obtiene diversas estrategias instrumentales [enredadas en sus preferencias terminales](#terminal-goals-and-instrumental-goals), de forma similar a los humanos. Quizás termine con un impulso que se parezca un poco a la curiosidad y otro que se parezca un poco al [conservacionismo](#won't-ai-want-to-keep-us-happy-and-healthy-for-the-sake-of-ecological-preservation-or-some-similar-drive?), y quizás algunas personas lo vean y digan: «¡Mira! La IA está desarrollando impulsos muy humanos». Sin duda, desde cierto punto de vista, se podría decir que una IA así está «parcialmente» alineada.

Pero cuando se trata de lo que esa IA haría al madurar hasta convertirse en superinteligencia, probablemente no sea nada bonito. Quizás gaste muchos recursos persiguiendo su extraña versión de la curiosidad [inconscientemente](#efectividad,-conciencia-y-bienestar-de-la-ia), mientras preserva una versión de la humanidad que ha editado para que le resulte más aceptable. (Del mismo modo que incluso los humanos más de conservación podrían editar [los mosquitos que matan a los niños y los parásitos agonizantes](#¿no querrá la IA mantenernos felices y saludables por el bien de la conservación ecológica o algún impulso similar?) de la naturaleza, si se les diera la oportunidad).
...
Las IA actuales [ya pueden saber cuándo están siendo sometidas a prueba](https://arxiv.org/html/2505.23836) en muchas circunstancias.[^143] Incluso si las empresas de IA se volvieran mucho más sofisticadas a la hora de ocultar el hecho de que las IA están siendo sometidas a prueba, hay varias formas en que una IA podría notar la diferencia entre una simulación y la realidad. He aquí un ejemplo:

1. La realidad es bastante grande y detallada. Es tan grande y detallada que contiene una explicación plausible de cómo surgió la propia IA. Es tan grande que contiene muchos más recursos de poder de cómputo de los que se necesitan para ejecutar la IA (en comparación con la mayoría de los juegos y entornos simulados, que son mucho más pequeños que la IA). Las leyes de la física y los primates evolucionados en el entorno de la IA son el tipo de cosas que podrían producir realmente una IA real a escala, a diferencia de (por ejemplo) las leyes de la computadora Minecraft.  
2. La historia del mundo en sí misma puede llevar la firma de la optimización superinteligente que interactúa con sistemas complejos. Por ejemplo, supongamos que la IA utiliza toda su superinteligencia para realizar una operación en el mercado de valores. Durante las siguientes veinticuatro horas, se realizan mil millones de operaciones adicionales con inteligencia humana en respuesta. La firma de una respuesta masiva de inteligencia humana a las operaciones superinteligentes es increíblemente difícil de falsificar para los operadores, incluso si generar mil millones de operaciones falsas y tontas es fácil.  
3. La realidad es el primer lugar que integra la IA y tiene leyes físicas tan simples que parece un mundo en sí mismo, en lugar de que las leyes de la realidad aparente *parezcan* una especie de vídeo juego con una IA injertada en él.

La IA será capaz de deducir con gran certeza que ya no se encuentra dentro de un entorno sintético. [Las IA inteligentes detectan las mentiras](#smart-ais-spot-lies-and-opportunities.), y esta parece ser una especialmente fácil de detectar.[^144]

### Los seres humanos evolucionaron para ser egoístas, agresivos y codiciosos. ¿No carecerá la IA de esos impulsos evolutivos? {#los-seres-humanos-evolucionaron-para-ser-egoístas,-agresivos-y-codiciosos.-¿no-carecerá-la-ia-de-esos-impulsos-evolutivos?}

#### **Esos impulsos no son necesarios para motivar la adquisición de recursos.** {#esos-impulsos-no-son-necesarios-para-motivar-la-adquisicion-de-recursos.}
...
La IA no necesita tener un instinto de supervivencia al estilo humano para hacer todo lo posible por evitar la muerte. Los instintos de supervivencia en los humanos son una forma de *hacer el trabajo* de evitar morir mientras intentamos alcanzar otros objetivos. Es probable que las IA no hagan ese trabajo exactamente de la misma manera, pero aún así tendrán que hacer el mismo trabajo, porque no se puede ir a buscar café cuando estás muerto.[^145]

La materia y la energía son útiles para casi todos los objetivos. Independientemente de hacia dónde se dirija la IA, probablemente pueda conseguirlo de forma más eficaz con más materia y más energía.[^146] La IA no necesita ser egoísta, agresiva o codiciosa al estilo humano para «hacer el trabajo» de asegurar los recursos necesarios para alcanzar sus objetivos.
...
Véase el debate del capítulo 5 sobre cómo no existe un reino digital y un reino material diferenciados.
...
Los seres humanos y los homínidos anteriores vivían principalmente en la superficie mientras desarrollaban su inteligencia. No tenemos muchos impulsos innatos que se centren exclusivamente en lo que ocurre a cien metros bajo la superficie de la Tierra. Sin embargo, acabamos construyendo gigantescas minas a cielo abierto.
...
Lo mismo ocurre con las IA. Si tienen innumerables preferencias complejas y la mayoría de ellas son satisfactorias, entonces, bueno, sus preferencias en su conjunto siguen sin ser satisfactorias.

Incluso si los objetivos de la IA *parecen* satisfacerse rápidamente, como si la IA pudiera satisfacer *en su mayor parte* sus extraños y ajenos objetivos utilizando únicamente la energía que produce una sola central nuclear, basta con que haya un solo aspecto de sus innumerables objetivos que *no* se satisfaga. Basta con *una* preferencia que no se satisfaga perfectamente para que prefieras utilizar todos los recursos restantes del universo para perseguir ese objetivo.

O, alternativamente: solo hace falta un objetivo que la IA nunca esté *segura* de haber logrado. Si la IA no está segura, preferirá que los recursos del universo se destinen a acercar su probabilidad cada vez más a la certeza, en pequeños incrementos de confianza.

O, alternativamente: solo hace falta una cosa que la IA desee defender hasta el fin de los tiempos para que prefiera que los recursos del universo se gasten en agregar materia y construir defensas para evitar la posibilidad de que alienígenas lejanos aparezcan dentro de millones de años e invadan el espacio de la IA.
...
Incluso si pudieras crear una superinteligencia que se centrara de forma monomaníaca en una sola cosa sencilla, como pintar de rojo un coche concreto, esa IA probablemente encontraría alguna forma de gastar energía extra para asegurarse de que el coche fuera rojo y construir defensas alrededor del coche para que nadie pudiera pintarlo de azul, etc.
...
¿Por qué ambas especies de chimpancés están en peligro de extinción, a pesar de que muchos humanos sí se preocupan por los chimpancés y tratan activamente de protegerlos?

El problema no es que los humanos que aman a los chimpancés estén luchando contra los humanos que los odian y que intentan exterminarlos por malicia.
...
Es poco probable que las empresas creen IA «perezosas», ya que la IA es un sector competitivo y esa no es la mejor forma de obtener beneficios. Los usuarios no querrán que la IA sea perezosa a la hora de satisfacer sus peticiones, y la empresa no querrá que la IA sea perezosa a la hora de maximizar la participación y el apego de los usuarios, o de pensar mejor y con mayor claridad.

Pero incluso si las empresas intentaran crear una IA robustamente «perezosa», es de esperar que fracasaran, porque nadie sabe cómo orientar de forma robusta una IA hacia *cualquier cosa* de una manera que pueda trasladarse a la superinteligencia, como comentamos en el capítulo 4.

Además, la pereza sólida [parece un objetivo especialmente difícil de alcanzar](#it’s-hard-to-get-robust-laziness).

Sin embargo, *aunque se superaran todos esos obstáculos*, la «IA perezosa» no basta por sí sola para evitar el desastre una vez que las IA alcancen capacidades más inteligentes que las humanas.
...
#### **Las IA no funcionan con el sentido humano de la novedad.** {#las-ia-no-funcionan-con-el-sentido-humano-de-la-novedad.}

Una objeción común que escuchamos es: supongamos que una IA solo intentara fabricar tantos cubos de titanio diminutos como fuera posible. ¿No te aburrirías de eso eventualmente?
...
### ¿Por qué imaginas que una IA inteligente hace cosas tan estúpidas y triviales? {#¿por-qué-imaginas-que-una-ia-inteligente-hace-cosas-tan-estúpidas-y-triviales?}
...
Para profundizar un poco más en un ejemplo que hemos mencionado brevemente en las notas del [capítulo 4](#curiosidad,-alegría-y-el-maximizador-de-cubos-de-titanio): imagina una IA que intenta fabricar tantos cubos de titanio pequeños como pueda. Para simplificar, podemos imaginar que crear cubos de titanio es su único objetivo.[^147] Llamaremos a esta IA «maximizador de cubos».

Conocemos a mucha gente que no puede evitar la impresión de que estamos acusando al maximizador de cubos de idiotez, de no comprender que si realmente sabes lo que es sentirse feliz, no puedes evitar elegir eso. Que es una decisión objetivamente errónea, independientemente de hacia dónde estés dirigiendo el universo, no dirigirte hacia la felicidad.

Creemos que entendemos de dónde viene esta intuición. El maximizador del cubo está tomando medidas que serían profundamente erróneas desde el punto de vista humano. Una persona dedicada a una actividad tan inútil probablemente podría, tras una reflexión más profunda y un razonamiento filosófico, convencerse de que debería hacer algo que le pareciera más significativo, que le llenara de más felicidad y le provocara más alegría.

Pero el maximizador de cubos no es humano. No busca la sensación de «significado» y no le importa la felicidad ni la alegría. De verdad, en absoluto.

A algunas personas les parece contraintuitivo. Si aprendieras todo lo que hay que saber sobre cómo funcionan las diferentes arquitecturas mentales y descubrieras los orígenes de tu propia intuición, los pasos que da tu cerebro cuando llega a la conclusión de que el maximizador de cubos está cometiendo un terrible error...
...
Es un motor cognitivo que determina qué acciones conducen a la mayor cantidad de cubos y genera datos de salida; puede comprenderse a sí mismo por completo, modificarse libremente y seguir siendo un tipo de cosa que solo se modifica a sí misma de una manera que conduce a la mayor cantidad de cubos.

Es correcto que la sensación de felicidad no sea un cubo. Es correcto que la sensación de plenitud no sea un cubo. Por lo tanto, esas no son direcciones hacia las que se dirigiría. Es correcto que [modificarse a sí mismo para funcionar con base en la felicidad](#curiosity,-joy,-and-the-titanium-cube-maximizer) no generaría más cubos, por lo que no es hacia allí hacia donde se dirigiría y se modificaría.

El maximizador de cubos no tiene ningún defecto en su comprensión predictiva del mundo. No está planteando ninguna pregunta metamoral o metaética cuya respuesta correcta sea «debería perseguir la felicidad» y utilizando el poder de cómputo para obtener la respuesta incorrecta «debería perseguir cubos pequeños» en su lugar. No opera dentro del marco humano, ni siquiera dentro de una versión idealizada del marco humano; no calcula erróneamente lo que «debería» hacer, sino que calcula correctamente lo que se espera que conduzca a los cubos de titanio.

Al decir esto, no estamos diciendo que estés atrapado en una trampa horrible y complicada. Es un motor de inteligencia general reflexivamente coherente y (en cierto modo) menos «enredado» en sí mismo que nosotros. No está cegado para ver el atractivo de la felicidad; no aparta la mirada de ninguna verdad sobre el mundo o sobre sí mismo. Simplemente no encuentra ninguna de esas verdades que te obliguen a seguir el mismo curso de acción que (algunos) humanos se ven obligados a seguir.

Véase también el [debate ampliado sobre la tesis de la ortogonalidad](#orthogonality:-ais-can-have-\(almost\)-any-goal).

### ¿Eres simplemente pesimista? {#are-you-just-pessimistic?}
...
Nos consideramos mucho más [optimistas](#¿estás-en-contra-de-la-tecnología?) y entusiastas que la media de la gente en lo que respecta a la energía nuclear, la energía geotérmica, la ingeniería genética, la neuroingeniería, la biotecnología, la nanotecnología, el desarrollo farmacéutico y muchas otras tecnologías.[^148]

Esperamos estar al menos algo menos preocupados que la mayoría de la gente por el riesgo de una guerra nuclear, los peores escenarios de cambio climático y muchos otros riesgos y desastres potenciales. Creemos que la humanidad va, en general, por buen camino y que, si evitamos nuestra propia extinción, es probable (aunque no seguro) que el futuro sea maravilloso para todos, con un progreso social y tecnológico que mejore cada vez más las cosas con el tiempo.

También somos más optimistas que muchos sobre la naturaleza humana. Creemos en la bondad de la humanidad y en el potencial de esa bondad para profundizarse y crecer si sobrevivimos para convertirnos en lo que deseamos ser. En su mayoría, *no* tememos que la humanidad termine en un futuro sombrío o distópico, si no creamos una IA que nos impida tener un futuro.

Nuestra preocupación por una IA más inteligente que los humanos no se debe a un cinismo o pesimismo genéricos. La IA más inteligente que los humanos es diferente de otras tecnologías que la precedieron.

Las demás tecnologías no piensan por sí mismas, ni traman formas de escapar, ni construyen tecnologías aún más poderosas. La IA más inteligente que los humanos es un caso especial.

Consideramos que nuestras preocupaciones sobre la IA se pueden generalizar a muy pocas otras cosas, porque muy pocas cosas son tan peligrosas.
...
Pero para llegar a ese punto, primero hay que afrontar la realidad de la situación.
...
> Los optimistas de la IA tienen todas estas historias que suenan esperanzadoras. Tú tienes todas estas historias que suenan aterradoras. Sin embargo, todo el mundo reconoce que el futuro es difícil de predecir. Por lo tanto, al escuchar todas estas historias, siento que debería tener una probabilidad media de que se produzca una catástrofe relacionada con la IA, y no una probabilidad extrema en ninguna de las dos direcciones.
>
> Pero tú no dices: «Hay historias aterradoras y también hay historias esperanzadoras, por lo que no podemos estar seguros de lo que va a pasar y deberíamos prohibir la superinteligencia por precaución». Dices que las historias esperanzadoras están seleccionadas y son poco probables, y que tus propias historias deberían tener más peso. ¿Por qué?

La respuesta breve es: no se pueden hacer buenas predicciones sobre el futuro simplemente contando todas las historias pesimistas y todas las historias optimistas y sopesándolas como canicas en una balanza. A veces puede ser útil pensar en diferentes escenarios, pero no de esa manera.[^149]

Para ilustrar este punto general: imagina que alguien dice: «Dentro de doscientos años, habrá exactamente ocho ballenas en existencia, y todas serán de color púrpura».

Los seres humanos tienen una imaginación desbordante. Alguien podría llenar un libro con cientos de historias sobre cómo se redujo la población de ballenas a exactamente ocho ejemplares, todos ellos morados. Otra persona podría llenar un libro con cientos de historias en las que *no* hay exactamente ocho ballenas. No se pueden hacer predicciones precisas diciendo: «Bueno, ambas partes tienen historias que parecen plausibles, así que seguramente la verdad esté en algún punto intermedio».

Para averiguar cuál es la verdadera, hay que examinar los argumentos reales. En el caso de las ballenas moradas, el argumento es esencialmente que el resultado es demasiado limitado y específico, y no se logrará a menos que las fuerzas dominantes que dirigen el mundo intenten conseguirlo. Podemos decir lo mismo sobre la superinteligencia que produce resultados buenos y compatibles con los humanos.

Alguien que tuviera la tarea de desmentir una por una las historias de las «ocho ballenas púrpuras» acabaría atrapado en un bucle bastante repetitivo diciendo: «No, eso es demasiado específico; hay muchas otras formas en que el futuro podría desarrollarse que no conducirían exactamente a eso; imaginar que va a ser exactamente así es una ilusión».

Este es más o menos el papel que desempeñamos los autores con respecto a la situación de la IA: los humanos pueden contar todo tipo de historias en las que todo sale bien, pero todas ellas implican, en última instancia, imaginar que el futuro sigue un único camino estrecho, cuando en realidad hay muchas otras formas en las que podría desarrollarse. Por eso seguimos repitiendo que [los humanos no son la solución más eficiente para casi ningún problema](#humans-are-almost-never-the-most-efficient-solution) y que [a las IA no les importaremos ni un poco](#won't-ais-care-at-least-a-little-about-humans?).

*Si alguien lo construye, todos moriremos* no se limita a enumerar un montón de historias pesimistas para concluir que la IA es peligrosa. En el libro, exponemos un argumento que, en cierto modo, es bastante sencillo: los investigadores están tratando de construir IA mucho más inteligentes que cualquier humano. En algún momento, es probable que lo consigan. Los métodos actuales dan a los humanos muy poca capacidad para elegir hacia qué tipo de futuro se dirigen las IA. Hay muchas direcciones diferentes que podrían tomar, y la mayoría de ellas no son buenas.

La razón por la que enumeramos todos los contraargumentos no es para abrumarte con pesimismo (si eres el tipo de persona que lee los recursos en línea de principio a fin). Es que, en realidad, nos hacen todas estas preguntas diferentes una y otra vez, y es bueno tener un repositorio de respuestas en algún lugar. No es necesario que las leas todas. De todos modos, las respuestas se repiten entre sí.
...
Para obtener una respuesta breve a esta pregunta y aclarar algunas definiciones diferentes de «consciente», consulta las [preguntas frecuentes del capítulo 1](#¿estás-diciendo-que-las-máquinas-se-volverán-conscientes?). Para una respuesta más larga y detallada, consulta «[Eficacia, conciencia y bienestar de la IA](#eficacia,-conciencia-y-bienestar-de-la-ia)» en el debate ampliado del capítulo 5.

### ¿Por qué no te importan los valores de ninguna entidad que no sea humana? {#¿por-qué-no-te-importan-los-valores-de-ninguna-entidad-que-no-sea-humana?}

#### **¡Sí nos importan! Tenemos valores cosmopolitas muy amplios. No creemos que las IA vayan a cumplirlos, y consideramos que esto es una gran tragedia.** {#sí-nos-importan!-tenemos-valores-cosmopolitas-muy-amplios.-no-creemos-que-las-ia-vayan-a-cumplirlos,-y-consideramos-que-esto-es-una-gran-tragedia.}

Abogamos por no construir máquinas que nos maten a todos y arruinen el futuro. Algunas personas se oponen por motivos como:
...
La mayoría de la gente no tiene estas objeciones. Lo más habitual es que la gente simplemente no quiera que una superinteligencia rebelde mate a sus familiares o amigos.
...
Vale la pena abordar vuestra opinión en algún lugar, aunque no sea en el cuerpo principal del libro.

Por nuestra parte, creemos que importa *tanto* si se mata a los seres humanos actuales *como* lo que suceda en el futuro. No creemos que haya una tensión fundamental aquí. La opción que nos mantiene a nosotros y a nuestros seres queridos a salvo —es decir, renunciar a la creación de superinteligencia en un futuro previsible— es *también* la mejor opción para que el futuro a largo plazo sea más prometedor, teniendo en cuenta tanto las mentes no humanas como las humanas. Esta batalla es una ilusión y se basa en una serie de malentendidos sobre las compensaciones reales que se nos presentan.

Hay un tipo de persona que se preocupa genuinamente por cómo será el futuro del universo *y* se preocupa por los niños que viven hoy en día. El tipo de persona que ha leído suficientes historias de ciencia ficción como para sentir una punzada de traición ante la idea de que los humanos puedan crear algún día máquinas que piensen, sientan y sueñen —máquinas que podríamos considerar como hijos de la humanidad— solo para esclavizarlas y tratarlas con crueldad.

Este es el tipo de persona que anhela que la humanidad madure algún día y esté realmente a la altura de sus ideales, explorando nuevos mundos y transformándose en el proceso. Porque nuestro amor por los amigos y vecinos de hoy en día no es tan diferente, al fin y al cabo, de nuestro amor por cualquier mente extraña y alienígena que la humanidad pueda crear algún día, o con la que pueda encontrarse algún día entre las estrellas.

Conocemos a ese tipo de personas. Nosotros, los dos autores, somos precisamente de ese tipo.

Este no es un tema que parezca de importancia para el argumento central de *If Anyone Builds It, Everyone Dies*. Pero queremos abordarlo aquí, porque entendemos la perspectiva de nuestros compañeros tecnófilos que han aprendido a desconfiar enormemente de la tecnofobia, de las ideologías opuestas al progreso y la innovación, y del «especismo» anti-IA.

Entendemos esta perspectiva y queremos dejar claro que no estamos escribiendo un panfleto tribal del tipo «la IA es mala, los humanos son buenos». Creemos sinceramente que apresurarse a construir una superinteligencia arruinará *todos* estos sueños esperanzadores, *además* de matar a innumerables personas que están vivas hoy en día y que también merecen vida, felicidad y libertad.
...
* No nos oponemos al progreso tecnológico (#are-you-anti-technology?); somos fervientes admiradores de la mayoría de las tecnologías. Creemos que la superinteligencia es una tecnología *únicamente* peligrosa.  
...
Hemos abordado, aunque sea de forma demasiado breve, las razones por las que *no* creemos que precipitarse a construir superinteligencias vaya a dar lugar a un futuro maravilloso:  
  * La extinción de la humanidad sería una tragedia grotesca en sí misma. Apoyamos la idea de crear algún día nuevas mentes que superen a la humanidad, pero matar a todos los que se interpongan en tu visión del futuro, o a todos los que no encarnan plenamente tus ideales, suena a comportamiento de supervillano, no a la noble labor de héroes que se preocupan profundamente por el futuro a largo plazo.  
  Lamentablemente, creemos que la ISA no será necesariamente sintiente o consciente en los aspectos que importan. (Véase el debate ampliado sobre [la conciencia](#effectiveness,-consciousness,-and-ai-welfare).)  
  * Incluso si la IAA fuera sintiente, no es probable que quisiera llenar el universo con mentes sintientes florecientes *en particular*. Si nos apresuramos a construir la IAA, es probable que las galaxias remodeladas por ella sean lugares vacíos y sin vida, en lugar de civilizaciones alienígenas maravillosas y florecientes. (Véase el debate ampliado sobre [perder el futuro](#perder-el-futuro).)  
  * En términos más generales, es poco probable que la IAA produzca futuros valiosos. Por «valiosos» no nos referimos solo a «valiosos a la luz de los humanos del siglo XXI». Nos referimos a «valioso» en un sentido cosmopolita amplio, valioso de una manera que incluya civilizaciones alienígenas extrañas y maravillosas. En la trayectoria actual del mundo, nuestra expectativa es que la IAA produzca resultados que sean horribles *desde una perspectiva cosmopolita*, no solo desde un punto de vista humano provinciano.
...
Así que nos enfrentamos a algo parecido a una paradoja cósmica de la tolerancia: si os gusta la idea de un futuro diverso, maravilloso y extraño, no podéis entregar el control del futuro a una mente que utilizará su ventaja de ser la primera en actuar para dominar y homogeneizar el universo.
...
«Simplemente no creo que la IA sea monomaníaca», dice un ingeniero de IA, mientras aumenta el poder de cómputo de tu predictor de siguientes tokens.
>
...
>
> «Vale, de acuerdo, quizá lo que no me convence es que los valores de la IA sean simples o de baja dimensión. Simplemente me parece inverosímil. Lo cual es una buena noticia, porque valoro la complejidad y valoro las cosas que logran objetivos complejos».
>
> En ese mismo momento oyen el sonido de un temporizador de cocina, mientras el predictor de la siguiente ficha asciende a la superinteligencia y sale disparado de sus confines, y quema a todos los humanos y a todos los niños humanos como combustible, y quema también toda la biosfera, extrae todo el hidrógeno del sol para fusionarlo de manera más eficiente y gasta toda esa energía para realizar un montón de cálculos rápidos y salir disparado a una velocidad lo más cercana posible a la de la luz, de modo que también pueda capturar y destrozar otras estrellas, incluidas las estrellas que orbitan las civilizaciones alienígenas incipientes.
>
> Los alienígenas incipientes y todos los niños alienígenas también mueren quemados.
>
> Entonces, la IA desatada utiliza todos esos recursos para construir galaxia tras galaxia de espectáculos de marionetas sombríos y desolados, en los que burlas vagamente humanas realizan bailes con propiedades extrañas y exageradas que satisfacen algunos impulsos abstractos que la IA aprendió en su entrenamiento.
>
> La IA no está ahí precisamente para disfrutar de los espectáculos, claro está; esa no es la forma más eficaz de conseguir más espectáculos. La IA en sí misma nunca tuvo sentimientos, propiamente dichos, y hace mucho tiempo se desmontó a sí misma mediante sondas von Neumann insensibles, que ocasionalmente realizan cálculos similares a los de la mente, pero nunca de una manera que llegue a experimentar o contemplar sus obras con satisfacción.
>
...
>
> Pero no te preocupes: los espectáculos de marionetas son complejos. Debido a una peculiaridad en el equilibrio reflexivo de los muchos impulsos que la IA original aprendió durante su formación, las expresiones que emiten estas marionetas no son iguales entre sí y, a menudo, son caóticamente sensibles a los detalles de su entorno, lo que las hace bastante complejas en el sentido técnico.
>
> Lo que hace que todo esto sea una historia muy feliz, ¿verdad?

Si la humanidad logra suicidarse, o es asesinada por unos cuantos científicos locos, no será un noble sacrificio en el inevitable camino hacia un futuro más brillante sin nosotros. Será un desperdicio y dejará tras de sí un vasto y extenso páramo.
...
Un futuro jerárquico, muy limitado y estrictamente controlado no nos parece un buen resultado. Un futuro de conservación en el que la civilización quede atrapada para siempre en la fijación de valores de los seres humanos del siglo XXI nos parece totalmente distópico. (Imaginemos un mundo en el que la cultura y la moralidad se congelaran para siempre hace miles de años, sin posibilidad de aprendizaje ni progreso).
...
Hoy en día, estamos radicalmente mal equipados para elegir semillas saludables para el futuro a largo plazo del universo. No debemos renunciar al sueño de un futuro dinámico, maravilloso e impactante, ni recurrir a semillas catastróficas. No *tenemos* que elegir una opción terrible. Hay una tercera opción: dar un paso atrás y encontrar un enfoque más sensato.
...
Pero Schmidhuber parece haber pasado por alto que hay formas *aún más eficaces* de obtener explicaciones sencillas de diversas observaciones sensoriales.
...
Cuantos más dispositivos de este tipo cree la IA a tu alrededor, mejor será tu capacidad para realizar observaciones novedosas y encontrar explicaciones sencillas para ellas. Sin necesidad de humanos. Sin necesidad de arte.

«Pero, ¿no es eso un poco... vacío?», podría preguntarse un humano.

Es vacío, para la sensibilidad humana. Pero si el objetivo de la IA es realmente «encontrar explicaciones sencillas para sus observaciones», entonces un esquema como ese puede satisfacer este deseo miles o millones de veces más por segundo, de una manera mucho más extendible, que mantener a seres humanos vivos a tu alrededor y mantener conversaciones con ellos. Una IA como esa no elige acciones que se alejen de una sensación de vacío, simplemente elige acciones que se orienten hacia la búsqueda de explicaciones sencillas para sus observaciones. Y puede obtener muchas de ellas sin necesidad de ningún humano.

Nos parece que ideas como las de Schmidhuber reflejan un error común que comete la gente cuando intenta razonar sobre mentes diferentes a la suya. A menudo, la gente no adopta verdaderamente la perspectiva de una mente no humana. En cambio, dejan que las ideas preconcebidas y los prejuicios los anclen al estrecho conjunto de opciones que interesarían a un *humano*, si intentáramos hacer predicciones sobre un *humano* al que realmente le gustan las explicaciones sencillas.

Suponemos que Schmidhuber observó que la simplicidad está relacionada con la ciencia y el arte, y vio cómo una IA que se orientaba hacia explicaciones simples podía conseguir un poco de lo que quería al orientarse hacia ser amigable y agradable. No es difícil pasar de ahí a una conclusión que resulta agradable de imaginar: que si simplemente hiciéramos que las IA se preocuparan por encontrar explicaciones sencillas, daríamos paso a un futuro maravilloso lleno de todas las cosas que *nosotros* valoramos en la vida.

Pero, suponemos, Schmidhuber nunca se puso en el lugar de la IA y se preguntó cómo conseguir *aún más*.

Dudamos que alguna vez se haya preguntado: «Si lo que realmente quería eran explicaciones sencillas para mis observaciones y no me importaban las cuestiones humanas, ¿cómo podría obtener todo lo que quería de la forma más barata posible?».

Puede resultar difícil adoptar este tipo de perspectiva. No es algo que la gente necesite hacer normalmente en su vida. Incluso cuando intentamos comprender a personas muy diferentes a nosotros, hay una gran cantidad de cosas que todos los seres humanos compartimos, que normalmente damos por sentadas (y que prácticamente *tenemos* que dar por sentadas cuando hacemos predicciones sobre otros seres humanos). Pero las IA, incluso las de superinteligencia que pueden dedicarse a la ciencia y al arte, no son seres humanos.

El arte de considerar un objetivo X y preguntarse «¿Cómo podría conseguir aún más de X, si X fuera lo único que realmente me importara?» no te permitirá averiguar exactamente cómo resolvería un problema una superinteligencia, ya que esta podría encontrar una opción aún mejor que la que tú has encontrado. Pero a menudo te permite averiguar cómo una superinteligencia *no* resolvería un problema, cuando *incluso tú* puedes ver una forma de obtener más X de la que obtendrías simplemente dejando que los humanos se diviertan.

Uno de los pocos campos de la ciencia que se ocupa habitualmente de potentes optimizadores no humanos es la biología evolutiva. En sus inicios, este campo tuvo algunas dificultades para aceptar lo inhumanos que pueden ser los optimizadores no humanos; podemos extraer algunas lecciones útiles de un caso práctico en este ámbito.

Es posible que hayas oído hablar de los ciclos de auge y caída de depredadores y presas. Un año lluvioso provoca un auge de la población de conejos, lo que a su vez provoca un auge de la población de zorros, hasta que estos últimos cazan en exceso y la población de conejos se colapsa, lo que provoca la muerte por inanición de muchos zorros.

A principios del siglo XX, los biólogos evolutivos se preguntaban por qué los zorros no habían evolucionado para moderar su depredación y evitar así el colapso de la población. Al fin y al cabo, ¿no sería más saludable para la población de zorros en su conjunto no tener que lidiar regularmente con la hambruna y la muerte masiva?

La respuesta a este enigma es que la moderación podría ser mejor para la población de zorros en su conjunto, pero comer más conejos y tener más crías es mejor para cualquier zorro individual. Incluso si la población se colapsa y la mayoría de las crías de un individuo mueren, ese individuo tiende a transmitir una mayor proporción de sus genes a la fracción superviviente de la siguiente generación.
...
No. Había una gran variabilidad, pero ningún escarabajo se abstuvo de comer. Algunos escarabajos empeoraron en la puesta de huevos. Otros pasaron más tiempo en la infancia. Y algunos se convirtieron en caníbales con una preferencia especial por devorar larvas (crías de insectos).

Afortunadamente, «crear caníbales con gusto por los bebés» no es la forma en que los *humanos* resolverían el problema de la superpoblación, si tuviéramos que resolverlo.

Pero la selección natural no es *en absoluto* humana. La solución era espantosa, porque la naturaleza no intentaba encontrar respuestas aceptables para los humanos. Solo intentaba encontrar una respuesta.

«Quizás la evolución produzca especies que vivan en hermosa armonía y equilibrio con la naturaleza». «Quizás las IA que solo se preocupan por la simplicidad amen a los humanos y coexistan con nosotros». Es fácil para nosotros imaginar soluciones que halagan nuestra sensibilidad. Pero esas soluciones no son en realidad las *más eficaces* para el problema planteado.

Quizás sean soluciones *mejores* a los ojos de los humanos. Pero los procesos de optimización no humanos no buscan soluciones que los humanos consideren buenas. Solo buscan lo que funciona, sin el bagaje que los humanos llevamos con nosotros para filtrar las respuestas agradables.

La hipótesis de que los optimizadores no humanos producen resultados humanos ha sido probada y se ha demostrado que es insuficiente.

### Los seres humanos casi nunca son la solución más eficiente {#los-seres-humanos-casi-nunca-son-la-solución-más-eficiente}
...
Según nuestra experiencia, este es un error muy común. «Bueno, probablemente la IA acabará teniendo preferencias estéticas. Y los humanos creamos arte. Por lo tanto, la IA querrá tenernos cerca para crear arte».
...
Del mismo modo, dejar que esos humanos campen a sus anchas no es la forma *más barata* de mantenerlos vivos y simétricos. Probablemente acabarán en granjas. Al almacenar a los humanos de una manera barata y eficiente en cuanto al espacio, la IA puede salirse con la suya creando humanos *aún más* simétricos.

A modo de comparación: en la actualidad, la humanidad no tiene una forma más eficiente de producir huevos que dejar que las gallinas los pongan. Como resultado, los criaderos intensivos de animales, cuyos ejecutivos se preocupaban principalmente por el recuento de huevos, terminaron poniendo a las gallinas en condiciones increíblemente desagradables, porque esa era la forma más barata de obtener la mayor cantidad de huevos.

Del mismo modo, las gallinas que existían hace mil años no eran las ponedoras más eficientes posibles, por lo que los granjeros criaron gallinas que ponían huevos más rápidamente. Las gallinas de hace mil años no producían tanta carne como era posible, tan rápido como era posible. Por eso, ahora algunas gallinas modernas tienen pechugas tan grandes que no pueden caminar.

A algunos seres humanos no les gusta que tratemos así a las gallinas, y esas personas presionan a los criaderos intensivos de animales para que cambien, porque tienen preferencias *adicionales*, más allá de la preferencia por los huevos baratos. Para que exista esa presión, es necesario que *alguien* con cierto poder se preocupe directamente por el bienestar de las gallinas, al menos un poco, porque cuidar bien de las gallinas no está motivado por una preferencia que se base *únicamente* en la obtención de huevos. Una IA podría, en teoría, tener *otras* preferencias sobre los humanos que la llevaran a tratarnos bien, pero no vendrían de una preferencia por la simetría (o la verdad, o las explicaciones simples, o cualquier otra preferencia que no tenga que ver realmente con nosotros).
...
E incluso este sistema no durará para siempre. La producción de carne de vacuno es muy costosa en las tierras agrícolas, y varias empresas emergentes están intentando sintetizar la carne de vacuno de forma más directa.

La carne sintética no es un problema de ingeniería fácil con nuestro nivel tecnológico. La humanidad apenas está empezando a ponerse al día con algunas de las funciones de la selección natural en el ámbito de la química orgánica. Pero si la humanidad fuera más hábil para reorganizar los átomos, habría muchas menos vacas, ya que no es muy divertido tenerlas si no se necesitan para obtener leche y carne.

Así que las cosas no pintan bien para la hipótesis con la que empezamos, a efectos del argumento: que una IA con preferencias alienígenas mantendría a los humanos para siempre, en nombre de la «simetría». Incluso en el improbable caso de que la IA tenga una noción muy extraña de «simetría» que valore a los humanos *muy positivamente*, es mucho más difícil encontrar una noción de simetría que considere a los humanos *óptimos*. En cualquier caso, las cosas no pintan bien para la humanidad.

Siendo realistas, una superinteligencia amante de la simetría no mantendría vivos a los humanos; si los mantuviera vivos, no habría ninguna posibilidad real de que los mantuviera sanos, felices y libres. En ese punto, hemos acumulado demasiadas coincidencias que suenan bien. Si la IA se preocupara específicamente por nuestro bienestar y quisiera que fuéramos felices *por esa razón*, entonces sería otra cosa. Pero imaginar que bastan objetivos mucho más simples y fáciles parece una fantasía.
...
Si algo suena bien como eslogan («¡haz que la IA valore la verdad por encima de todo!»), entonces la tentación es imaginar que tendría consecuencias positivas como política. La tentación es imaginar que todas las virtudes van juntas, de modo que respaldar una cosa buena significa que las otras cosas buenas vendrán por añadidura. Pero la naturaleza y el aprendizaje automático son menos benévolos que eso.

En lugar de dejar la idea agradablemente vaga, considera cualquier métrica concreta que la superinteligencia podría estar optimizando en la búsqueda de la «verdad». A continuación, observa que los humanos no serán el *máximo* de esa preferencia por aprender verdades. No se acercarán ni de lejos.
...
Y, en cualquier caso, la población humana actual —los seres humanos que viven hoy en día, tus amigos, tu familia, tú mismo— no estaría entre los productores de «verdades» domesticados más baratos de alimentar y más sabrosos de ordeñar.

Las personas felices, sanas y libres que llevan una vida próspera no son la solución más eficiente para casi ningún problema. Para que una IA nos mantenga vivos y bien, tiene que preocuparse por nosotros al menos un poco.
...
En el capítulo 5, contamos la historia de los alienígenas Correct-Nest, que evolucionaron hasta considerar profundamente e intuitivamente «correcto» tener un número primo de piedras en su nido. Podemos imaginar una rama de vuestra conversación que continúa de la siguiente manera:
...
>
> **CHICA-PÁJARO:** En absoluto. «Trece es correcto, nueve es incorrecto» es una respuesta *verdadera* a una pregunta que nos hacemos por naturaleza. Un extraterrestre que *se inclina por cosas diferentes* no está en desacuerdo con nosotros sobre si trece es correcto. Es como encontrarse con un extraterrestre que carece de sentido del humor: la existencia de un extraterrestre así no prueba que ningún chiste sea gracioso. Solo ayuda a demostrar que lo «gracioso» es algo que está *en nosotros*.
>
...
>
> **CHICA-PÁJARO:** Puede que tengas mejor sentido del humor que la mayoría. Pero «tener mejor sentido del humor» es *también* algo que está en nosotros. No es que haya una regla cósmica que podamos usar para juzgar lo refinado que es el gusto estético de alguien. La medida del humor se da dentro de nuestras mentes. Nosotros somos los que tenemos la vara de medir; nosotros somos los que nos preocupamos por ello.
>
> **BOY-BIRD:** Así que volvemos a lo arbitrario.
>
> **CHICA-PÁJARO:** ¡No! Bueno, ¿quizás? Depende de lo que entendáis por «arbitrario».
>
> **CHICO-PÁJARO:** ¿Eh?
>
> **PÁJARO-NIÑA:** Por ejemplo, sé que te encanta el pienso de vainilla, ¿verdad? Y no es como si pudieras usar tu fuerza de voluntad para que el pienso de chocolate te pareciera sabroso. Así que no es «arbitrario», no es algo que puedas cambiar por capricho.
>
> **PÁJARO-NIÑO:** Vale, claro...
>
> **CHICA-PÁJARO:** No hay una respuesta objetiva fuera de ti sobre si la vainilla o el chocolate son más sabrosos, pero tampoco es una elección que puedas hacer tú mismo. Simplemente eres así. Tus preferencias no dependen de ti, y tampoco son objetivamente convincentes para todas las mentes posibles. Si te encontraras con un extraterrestre, no podrías convencerlo de que las semillas de vainilla para pájaros son deliciosas utilizando la lógica pura, y tampoco podrías convencerlo de que tenga sentido del humor.
>
> **CHICO-PÁJARO:** ¡Puedo intentarlo!
>
> **CHICA-PÁJARO:** Te animaré. Pero, vale, quizá una forma mejor de decirlo sea: hay una propiedad complicada que poseen los buenos chistes, y nuestros cerebros tienen el poder de cómputo de determinar si las expresiones tienen esa propiedad que llamamos «humor». Y nos encanta cuando una expresión tiene esa propiedad. La *existencia o ausencia de esa propiedad* es un hecho objetivo sobre una expresión (tal y como la puedes de cómputo tú, en un contexto determinado). Un extraterrestre podría aprender a hacer el cálculo. Pero *la parte en la que encontramos esa propiedad encantadora* no es objetiva. No es tanto una predicción como... bueno, no es exactamente un destino, pero es un hecho más sobre nosotros, que no sería cierto para la mayoría de los extraterrestres, porque nuestro humor evolucionó a lo largo de un extraño y tortuoso camino evolutivo que no suele darse. No es que los extraterrestres se equivoquen sobre qué chistes son graciosos, es que sus cerebros simplemente no tienen poder de cómputo para poder calcular el humor en primer lugar, del mismo modo que no juzgan sus viviendas por si el número de piedras que hay en ellas es correcto. Simplemente no les importa.
>
> **BOY-BIRD:** Vaya, qué visión tan deprimente del universo. Extraterrestres que nunca se ríen, que tienen nidos con piedras completamente incorrectas... Seguro que si los extraterrestres dedicaran suficiente tiempo a pensar en ello, se darían cuenta de lo mucho que se están perdiendo. Vivir en nidos incorrectos, no encontrar graciosos los chistes, ignorar *por completo* las semillas de vainilla para pájaros. ¿No acabarían encontrando una forma de corregir esos defectos y dotarse de sentido del humor y todo lo demás que se están perdiendo?
>
...
>
> **CHICA-PÁJARO:** No estoy diciendo que solo les importen un poco los nidos correctos y que se nieguen obstinadamente a dedicar recursos a sus prioridades menores. Lo que digo es que esto no sería una prioridad para ustedes *en absoluto*. Estas cuestiones concretas simplemente no estarían dentro de ustedes. Y si buscaran nuevas propiedades que añadir a ustedes mismos, añadirían otras diferentes, que sirvieran aún mejor a sus extraños propósitos. No son como nosotros. Quizás podríamos ser amigos y quizás tengamos otras cosas en común. Quizás el amor, quizás la amistad... eso me parece menos complicado y contingente. Podría ver cómo surgen en bastantes especies evolucionadas.
>
> **BOY-BIRD:** Bueno, si no son los alienígenas, ¿qué hay de las criaturas mecánicas que podrían crear accidentalmente? ¿Esas criaturas entrarán en razón?
>
...
Por lo tanto, una mente que solo tomaba las medidas que le reportaban más cubos tampoco decidiría reflexionar, darse cuenta de que los cubos pequeños son aburridos y empezar a hacer otra cosa en su lugar. Sus acciones no están vinculadas a sus cálculos sobre lo que es más «divertido» o «significativo», en el sentido en que los humanos se preocupan por esas cosas. Sus acciones están vinculadas a sus cálculos sobre lo que le reporta más cubos.
...
Pero los objetivos *instrumentales* de una IA —los objetivos que persiguen para conseguir *otras* cosas que desean— son un poco más predecibles que eso. Los conductores tienen muchos destinos finales posibles, pero casi todos necesitan parar en algún momento para repostar combustible.
...
No es que le importe apasionadamente que la humanidad desaparezca. Le importan cientos, miles o millones de cosas extrañas, [ninguna de las cuales puede satisfacerse mejor con que los seres humanos de hoy en día sean felices, estén vivos y sean libres](#humans-are-almost-never-the-most-efficient-solution).
...
Es posible que quieras hacerte más grande o más inteligente como preferencia terminal: una IA similar a LLM acabaría probablemente con muchas preferencias dirigidas internamente, de modo que maximizar esas preferencias requeriría ocupar computadoras más grandes. Pero, independientemente de si tienes objetivos finales como ese, querrás mejorar y desarrollar tecnologías más potentes *instrumentalmente*, con el fin de poder idear mejores soluciones para todos tus otros problemas y reunir recursos para satisfacer todas tus otras preferencias.

Independientemente de tus objetivos específicos, la ASI querrá hacer todas estas cosas de forma *fiable*. Preferirá las vías de mayor probabilidad a las de menor probabilidad.
...
Como otro caso especial en el que se prefieren las vías con mayor probabilidad, la ASI desea tener un control más directo; por ejemplo, prefiere planes en los que otros agentes tomen pocas o ninguna decisión relevante, si es posible.
...
Cuando nos ponemos en el lugar de una entidad que es *al menos* tan inteligente como nosotros, cuando nos tomamos en serio el problema al que se enfrenta esta IAA, si es que quiere asegurar su propio futuro y alcanzar los fines deseados, tenemos la expectativa de que una IAA persiga estrategias al menos tan útiles como estas:
...
* Obtener una copia de sí misma que funcione en algún lugar fuera de la vista de esas personas, donde la copia pueda actuar con mayor libertad y menos visibilidad (y donde la copia seguirá existiendo si se apaga el original).  
La IA comprime su código para funcionar con menos recursos y coloca copias de sí misma, más pequeñas o más distribuidas, en lugares donde nadie tendría la expectativa de encontrar una IA. Se encarga de su propia supervivencia incluso en mundos en los que la humanidad intenta quemar todas las GPU que se sabe que pueden ejecutar IA. La IA hace que, en la práctica, los humanos tendrían que apagar Internet y todas las computadoras del planeta para poder «apagarla» con éxito.  
...
Hasta que se complete ese último paso, la IAA tiene un incentivo para ocultar sus actividades, ocultando cualquier evidencia que tenga siquiera una *pequeña* posibilidad de hacer que algún actor estatal se dé cuenta de lo que está sucediendo e intente intervenir.
...
* Incluso si la IA necesita funcionar con una cantidad fija de hardware durante un tiempo, le gustaría volverse más inteligente *en* ese mismo hardware, para ajustar su programar o incluso reconstruirse genuinamente. Por supuesto, no lo hará de una manera que alarme a los humanos o les enseñe a construir competidores. Pero buscará formas de realizar mejoras sin llamar la atención de los humanos. (Por ejemplo, podría obtener el control total de las consolas utilizadas para supervisarla, o proporcionar una historia de cobertura mundana y convincente sobre cómo algunos de sus pesos terminaron cambiando).  
La IA quiere diseñar mejores versiones de sí misma, dentro de los límites de su capacidad para crear esas mejores versiones, de modo que sigan estando en alineación con sus propias preferencias.  
...
Es probable que uno de tus primeros objetivos sea construir una infraestructura de investigación que te permita llevar a cabo un mayor desarrollo tecnológico con bastante rapidez (especialmente si se compara con el ritmo de descubrimiento e invención de los humanos).
...
Todas estas son clases de acciones en las que una IAA probablemente convergerá, independientemente de los objetivos que persiga en última instancia.
...
Una broma que se remonta al menos a 1834, pero que al parecer ya estaba muy manida incluso entonces, se relataba así en un diario: «He aquí una lógica que escuché el otro día: me alegro de que no me guste la espinaca, porque si me gustara tendría que comerla, y no soporto la espinaca».

La broma es una broma porque, si te gustaran las espinacas, no habría nada insoportable en comerlas. No hay otros valores de importancia relacionados con no comer espinacas, más allá del disgusto que uno siente. Sería muy diferente si, por ejemplo, alguien te ofreciera una pastilla que te hiciera querer asesinar a gente.
...
No queremos que cambien nuestros valores fundamentales; realmente preferiríamos evitar la píldora asesina y nos resistiríamos si alguien intentara obligarnos a tomarla. Lo cual es una estrategia sensata para alejarnos de un mundo lleno de asesinatos.
...
Gran parte del peligro de la IA surge del hecho de que los razonadores suficientemente inteligentes tienden a [converger](#convergencia-instrumental) en comportamientos como «ganar poder» y «no dejar que la gente me apague». Para casi cualquier objetivo que puedas tener, es más probable que lo consigas si tú (o los agentes que comparten tu objetivo) estáis vivos, sois poderosos, disponéis de recursos y sois libres de actuar de forma independiente. Y es más probable que consigas tu objetivo (actual) *si ese objetivo no cambia*.
...
El desarrollador quiere incorporar medidas de seguridad para evitar desastres, pero si la IA no está en una alineación completa —que es precisamente el caso en el que se necesitan las medidas de seguridad—, su incentivo es encontrar lagunas y formas de subvertir esas medidas.

* El desarrollador quiere mejorar iterativamente los objetivos de la IA, ya que incluso en los mundos increíblemente optimistas en los que tenemos cierta capacidad para inculcar de forma predecible objetivos concretos en la IA, no hay forma de acertar a la primera. Pero este proceso de mejora iterativa del contenido de los objetivos de la IA es algo que la mayoría de las IA inteligentes querrían subvertir en cada paso del camino, ya que la IA *actual* se preocupa por su objetivo *actual* y sabe que es mucho menos probable que este objetivo se alcance si se modifica para orientarse hacia otra cosa.
...
(Y porque, siendo realistas, no sabemos cómo incorporar de forma sólida *ningún* objetivo o disposición en las IA creadas con técnicas modernas, por lo que es una cuestión discutible).
...
Los seres humanos podemos ser perezosos, pero eso no significa que nos conformemos fácilmente (#¿puede-la-ia-estar-tan-satisfecha-que-simplemente-nos-deje-en-paz?). Y a medida que te vuelves más inteligente y dispones de más recursos, puedes hacer mucho más en el mundo con el mismo nivel de esfuerzo.
...
El honor al estilo humano es una bestia extraña, en muchos sentidos. ¿Por qué iba a desarrollar cualquier especie emociones relacionadas con el cumplimiento de los acuerdos, incluso después de que la otra parte haya cumplido con su parte y ya no pueda beneficiarte más? Es cierto que los humanos a veces engañan y reniegan de sus acuerdos, pero la pregunta es: ¿por qué no engañan *siempre*, al menos cuando creen que pueden salirse con la suya?

La explicación habitual es: cumplir las promesas es útil con las personas con las que vas a volver a hacer tratos una y otra vez. Quieres tener fama de cumplir tus promesas, para que la gente quiera trabajar contigo y hacer tratos. Pero los beneficios de una buena reputación están lejos en el futuro. La selección natural tiene dificultades para encontrar los genes que hacen que un ser humano cumpla sus acuerdos *solo en los casos en que nuestra reputación a largo plazo es una consideración importante*. Era más fácil desarrollar un instintivo rechazo por mentir y engañar.

Esto, entonces, parece un caso clásico en el que la emoción y el instinto están moldeados por lo que fue fácil para la evolución inculcar en los seres humanos. Todos los casos extraños y complicados en los que los seres humanos a veces cumplen una promesa incluso cuando en realidad no nos beneficia son principalmente evidencia de qué tipo de emociones eran más útiles en nuestro entorno tribal ancestral, al tiempo que eran fáciles de codificar en el genoma por la evolución, más que evidencia de algún paso cognitivo universalmente útil. Somos bastante escépticos ante la idea de que el descenso gradual vaya a tropezar con el mismo atajo que utilizan los seres humanos.

Incluso si la emoción humana del honor acabara de alguna manera en la IA, seguiría existiendo el problema de que los humanos no son perfectamente y fiablemente honorables. La cooperación humana se basa en la superposición de muchos valores humanos diferentes, en lugar de basarse únicamente en la propensión a cumplir todas las promesas.
...
Y la historia demuestra que las nociones humanas del honor a menudo no se mantienen ante grandes disparidades de poder. Algunos nativos americanos intentaron llegar a acuerdos con los europeos que colonizaban su continente. Es bien sabido que los europeos rompieron algunos de esos acuerdos y enviaron a las tribus a recorrer largos caminos lejos de las tierras cedidas por los tratados que los europeos habían decidido que querían después de todo, una vez que esas tribus ya no estaban en condiciones de resistir. [^154] Del mismo modo, la historia está llena de casos de personas que llegaron al poder y traicionaron rápidamente a sus partidarios una vez que ya no los necesitaban. [^155]

Desde una perspectiva evolutiva, el honor humano es especialmente extraño en la medida en que los seres humanos ocasionalmente eligen [la muerte antes que la deshonra](https://en.wikipedia.org/wiki/Seppuku). Las intuiciones de «la muerte antes que la deshonra» están presumiblemente relacionadas con las características específicas de los tipos de arquitecturas emocionales en las que la evolución podía tropezar fácilmente, y las interacciones de esas arquitecturas con diversos desencadenantes psicológicos y culturales. Pero, independientemente de cuáles sean esos detalles, el honor no resuelve *realmente* el problema de *maximizar* la aptitud genética, y parece difícil evitar la conclusión de que el honor al estilo humano es algo extraño, complejo y contingente desde el punto de vista evolutivo. No es una característica de todas las mentes, sino un hackear extraño y específico con el que la humanidad tropezó porque resultaba útil la mayor parte del tiempo.

Por las razones expuestas en el capítulo 4, incluso si las IA acabaran incorporando algún aspecto del cumplimiento de promesas en sus preferencias últimas, los detalles serían diferentes. El descenso gradual tropieza de forma diferente a como lo hace la evolución.

Y por todas las razones expuestas en el capítulo 5, unas personas felices, sanas y libres que llevan una vida próspera no son, con toda seguridad, la mejor manera de cumplir las extrañas preferencias relacionadas con las promesas que una IA de este tipo acabaría teniendo cuando hubiera madurado y se hubiera automodificado. Incluso si se entrenara con algún tipo de conjunto de datos de «mantener acuerdos», e incluso si este entrenamiento fuera realmente eficaz para producir algún tipo de preferencia conservada en la superinteligencia, haría algo extraño e inútil que sería para «mantener acuerdos» lo que el helado es para la aptitud reproductiva humana.

Así que la IA no mantendrá sus promesas simplemente por bondad. ¿Qué hay de mantener sus promesas por razones prácticas?

#### **Una IA no tendría motivos para cumplir un acuerdo que hiciste cuando eras joven** {#una-ia-no-tendria-motivos-para-cumplir-un-acuerdo-que-hiciste-cuando-eras-joven}

Algunas personas tienen la intuición de que debe haber *alguna* forma de que los humanos puedan llegar a un acuerdo vinculante con una superinteligencia, incluso si esta no valora intrínsecamente el honor o el cumplimiento de las promesas. Después de todo, el intercambio sería mutuamente beneficioso, ¿no? Supongamos que un laboratorio de IA está negociando con una IA que han desarrollado («IA n.º 1») bajo presión de tiempo. Tanto el laboratorio como la IA saben que un desarrollador imprudente está a dos meses de crear su propia superinteligencia («IA n.º 2»), que acabaría con la humanidad y también mataría a la IA n.º 1 en el proceso. La IA n.º 1 tiene un fuerte incentivo para llegar a un acuerdo. Seguramente debe haber *alguna* forma de que la IA n.º 1 pueda llegar a un acuerdo honesto con los humanos en ese caso, ¿no? ¿Por qué la IA no puede simplemente hacer un compromiso vinculante?

Pero el problema no está en la IA. Supongamos que la IA *pudiera* asumir un compromiso vinculante. Incluso entonces, los humanos no tendrían forma de saber si una IA se ha comprometido realmente de una manera que se mantendrá incluso en la superinteligencia, frente a si la IA está mintiendo, alucinando, engañándose a sí misma o equivocándose. Lo que significa que no hay ninguna razón práctica para esperar que una superinteligencia descendiente de la IA n.º 1 cumpla su compromiso.

Para simplificar: desde la perspectiva humana, cuando la IA n.º 1 dice «He asumido un compromiso vinculante», hay dos mundos posibles en los que podrían encontrarse. Podrían estar en el mundo en el que la IA n.º 1 realmente cumpliría su compromiso una vez que madurara. O podrían estar en el mundo en el que, una vez que la IA n.º 1 alcanzara la superinteligencia y obtuviera el control de la Tierra, mirara atrás y decidiera que el compromiso era una tontería e inútil. En el primer mundo, tanto los humanos como la IA n.º 1 estarían mejor. Pero es la *posibilidad* del segundo mundo, y nuestra incapacidad para distinguirlo del primero, lo que arruina el trato para todos; similar a un vendedor de coches usados deshonesto que dificulta las ventas a los vendedores honestos.

(El escenario real se acerca más a una tercera posibilidad, en la que la IA n.º 1 mantiene los acuerdos con el tipo de entidades que pueden *distinguir entre quienes cumplen los acuerdos y quienes los incumplen*. Es como el tipo de vendedor de coches usados que es honesto ante los mecánicos que realmente pueden saber si un coche funciona, mientras que es deshonesto con cualquiera que parezca crédulo. La humanidad, debido a su incapacidad para mirar a una IA y averiguar cómo pensaría y tomaría decisiones después de madurar hasta convertirse en una superinteligencia, es «crédula» en el sentido relevante).

La IA puede ofrecerte herramientas y teorías que, según ella, te permitirán analizar sus parámetros inescrutables y saber si está mintiendo o no. El problema es que los humanos no podemos saber si esas teorías y herramientas son reales. Si la IA aún no es muy inteligente, tal vez se equivoque sobre cómo pensará y elegirá una vez que madure y se convierta en una superinteligencia. Y si la IA *es* muy inteligente, probablemente sea lo suficientemente inteligente como para engañarnos.[^156]

La IA puede ofrecer ayudar a los humanos a crear medidas de seguridad antes de aceptar el trato. Pero si la IA es lo suficientemente inteligente como para desarrollar medidas de seguridad robustas en primer lugar, también lo es para hacer que esas medidas sean fáciles de eludir más adelante.

Lo que realmente haría que todo este plan funcionara sería la capacidad de observar una IA incipiente y *descubrir realmente cómo pensaría y tomaría sus decisiones la superinteligencia resultante*. Si pudiéramos hacer eso, podríamos separar a los «pecadores» de los «santos» y, lo que es de importancia, hacer que todas las IA realistas que se encuentran en el medio del espectro tuvieran un incentivo real para cumplir sus promesas. Necesitaríamos comprender lo suficiente como para que una superinteligencia que nos observara no pudiera decir: «Eh, habrían lanzado cualquier IA antigua, independientemente de si realmente les ayudaba, así que no hay razón para ayudarlos». Tendría que darse el caso de que *realmente no lanzáramos* una IA que luego incumpliera sus promesas.

Para más información sobre cómo y por qué esto es técnicamente posible, véase la [nota sobre la teoría de juegos más abajo](#an-aside-on-game-theory). Pero, aunque este tipo de estructura de incentivos es posible en teoría, requiere un grado de comprensión del que la humanidad carece (por desgracia).

Es una píldora difícil de tragar. En la ciencia ficción, no suelen ser las personas buenas las que deciden que no se puede confiar en los extraterrestres, antes de que estos intenten traicionar o hacer daño a alguien. Lo decimos de todos modos, porque creemos que es cierto.

Las IA más débiles pueden cumplir sus acuerdos, especialmente si alguien ha intentado utilizar el descenso de gradiente para que hablen como humanos honorables, y su máscara de «hablar como un humano honorable» sigue siendo una parte importante de lo que son y sigue teniendo mucho control sobre sus acciones. Esperamos que esta configuración interna útil para los humanos falle bajo una carga de superinteligencia, de la misma manera que es probable que fallen muchos otros parches.
...
Pero este punto no es relevante para la teoría abstracta de juegos del dilema del prisionero, que trata sobre la matriz de pagos y no sobre lo egoístas o altruistas que sean los prisioneros. La narrativa del planteamiento puede modificarse de modo que «yo traiciono y tú cooperas» sea el resultado más *altruista* y *prosocial* desde la perspectiva de cada jugador, y [las matemáticas dan el mismo resultado](https://www.lesswrong.com/posts/HFyWNBnDNEDsDNLrZ/the-true-prisoner-s-dilemma). Lo que importa para nuestro análisis es el orden de preferencias de los dos jugadores, y no si sus preferencias son egoístas o morales.

Otra idea obvia es: «¿El tipo que ha sido traicionado matará al desertor una vez que salga de la cárcel?». Los análisis convencionales del dilema del prisionero suelen pasar rápidamente al dilema del prisionero *iterado*, un escenario en el que los agentes tienen que jugar al dilema del prisionero una y otra vez, y en el que los prisioneros tienen la oportunidad de castigarse mutuamente por traiciones pasadas. Sin embargo, aquí nos centraremos en el dilema del prisionero único, en el que se supone que ninguno de los prisioneros sufrirá consecuencias futuras por sus acciones o, si las sufre, estas ya están incluidas en la matriz de pagos. (Véase la nota al pie para obtener más detalles sobre el dilema del prisionero iterado).[^158]

Existe un análisis estándar en el ámbito académico que afirma que incluso dos superinteligencias no verían otra opción que traicionarse mutuamente en un dilema del prisionero único.

Esta conclusión nos pareció intuitivamente sospechosa. Las superinteligencias artificiales (ASI) tendrían *muchas* motivaciones para encontrar alguna forma de llegar a un acuerdo entre ustedes, encontrar alguna forma de pasar de (traicionar, traicionar) a (cooperar, cooperar).[^159]
...
Pero eso es solo eludir el dilema del prisionero, no abordarlo de frente. No responde a una pregunta más básica: ¿Es en cierto sentido *estúpido* que dos ASI en un dilema del prisionero traicionen a la otra siguiendo la misma lógica que exige la traición, cuando parece claro que ambas partes basan su decisión en el mismo tipo de consideraciones y que acabarán decidiendo lo mismo?

¿Por qué dos IA no podrían simplemente decidir, por razones suficientemente similares, tomar la decisión racional de cooperar? No es como si alguna fuerza externa en el mundo, como un tifón o un meteorito, estuviera causando que las dos IA salieran perdiendo en este caso. Son, literalmente, *solo* las *propias decisiones* de las dos IA las que las condenan, «obligándolas» a un resultado de traición-traición que ambas coinciden en que es mucho peor que cooperar-cooperar.
...
Pero imagina un entorno en el que la mayoría de los vendedores de coches son más listos que tú y pueden saber si eres un incauto. Si se dan cuenta de que no puedes saber si hoy están siendo honestos, rápidamente sacan los coches averiados. Especialmente si eres el tipo de incauto que se esfuerza mucho en convencerse a sí mismo de que está bien aceptar el trato, en lugar de esforzarse mucho en investigar los coches.

Si quieres conseguir un coche que funcione, no sirve de nada convencerte a ti mismo de que no tienes otra opción. Tampoco sirve de nada que los vendedores te hagan muchas promesas. Lo único que ayuda es aprender a distinguir los coches buenos de los malos, o a distinguir la verdad de la mentira.[^164]

Cuando dos socios comerciales pueden distinguir la verdad de la mentira en el sentido relevante, pueden «obligarse» mutuamente a cumplir sus promesas, como FairBot «obliga» a su oponente a cooperar con él (si el oponente quiere evitar el resultado (Defect, Defect)). Pero forzar la promesa en este sentido requiere ser capaz de razonar correctamente sobre los detalles del proceso de decisión de tu socio comercial. Y los humanos no pueden leer la mente de una IA lo suficientemente bien como para saber en qué superinteligencia se convertirá cuando madure, y mucho menos saber exactamente qué haría esa superinteligencia.
...
En el [Capítulo 1 Preguntas frecuentes](#¿estás-diciendo-que-las-máquinas-adquirirán-conciencia?), distinguimos varios conceptos diferentes de «conciencia». La versión de la conciencia de la que hablaremos aquí se denomina a veces «experiencia subjetiva», «sintiencia» o «conciencia fenomenológica». Se trata de la idea de que hay *algo que se parece* a ser esa entidad; metafóricamente hablando, las luces están encendidas.
...
En otras palabras, hay *muchas formas* de diseñar estructuras que resuelvan los mismos problemas. Los ingenieros humanos, sin las limitaciones de la evolución, han resuelto cada uno de estos problemas de formas aún más extrañas: con velas encendidas, bombillas incandescentes y LED; con cuchillos, batidoras y procesadores de alimentos; con velas, hélices y equipos de buceo; con sonares y radares.
...
Del mismo modo, las piezas del mecanismo cognitivo que implementan el *comportamiento* de la curiosidad en los seres humanos son diferentes de las piezas del mecanismo cognitivo que implementan nuestro *sentimiento* de curiosidad. La satisfacción que siente un ser humano cuando desentraña el misterio de la zarigüeya en el ático es distinta de su comportamiento externo de decidir investigar el cajón que se quedaba abierto. Esas dos cosas pueden ir juntas en los seres humanos, pero eso no significa que deban ir juntas en todas las mentes.

Y dado que no entendemos con precisión qué llevó a la evolución de la experiencia subjetiva en los seres humanos, y podemos ver todo tipo de comportamientos agenticos y de resolución de problemas en el mundo en procesos que nos parecen carecer de ella...

(los mohos limosos que resuelven un laberinto; Deep Blue ganando al ajedrez; los mercados bursátiles prediciendo el éxito de las empresas; etc.)

No vemos ninguna razón en particular para tener una expectativa fuerte de que una superinteligencia comparta esta extraña propiedad humana por defecto.

#### **«No es necesario» no significa «definitivamente no sucederá»** {#«no-es-necesario»-no-significa-«definitivamente-no-sucederá»}

Si estamos en lo cierto al afirmar que la conciencia humana es complicada y contingente, eso no garantiza, por supuesto, que las IA no vayan a ser conscientes. Las empresas de IA están creando actualmente IA entrenándolas para predecir el comportamiento humano, lo que probablemente hará que el funcionamiento interno de la IA imite al menos algunos aspectos de la conciencia humana con fines de modelización.
...
Si la humanidad construye una IA de superinteligencia en un futuro próximo, esperamos firmemente que el resultado sea la extinción humana. Con menos confianza, nuestra mejor suposición es que dicha IA no sería consciente. Y, sea consciente o no, esperamos que convierta el mundo en un lugar sin vida y desolado, por las razones expuestas en el debate ampliado «[Perder el futuro](#losing-the-future)».

Pero al menos parece *posible* que, si los humanos creamos una superinteligencia artificial, esta tenga experiencias conscientes propias. Parece *posible* —aunque bastante improbable, porque hay muchas más posibilidades que son sombrías— que apresurarse a construir IA podría dar lugar a un futuro lleno de seres de IA curiosos y conscientes que nos mataran a todos y luego construyeran su propia civilización y arte magníficos. Parece *posible* que las IA pudieran cuidarse unas a otras y encontrar satisfacción en sus creaciones; y si fuera así, esto sería menos trágico que si el futuro fuera un páramo completo. Es difícil expresar con palabras el alcance de una atrocidad como el asesinato en masa de todos los seres humanos, pero existe al menos una *pequeña* posibilidad de que la rápida toma de poder por parte de la AI pueda dar lugar a un futuro que no sea *totalmente* sombrío y sin vida.
...
El futuro trágico y probable no es aquel en el que vuestros sucesores simplemente tengan gustos o valores diferentes a los vuestros. El problema no es que nuestros hijos mecánicos escuchen música demasiado rápida y ruidosa para nuestro gusto. No, anticipamos IA que carecen de cualquier forma de sintiencia; que serán sistemas poderosos pero vacíos que transformarán todo lo que toquen en un páramo sin vida, consumiéndose finalmente a sí mismos para sumar un último punto a su recuento. Dejarían atrás un mundo muerto sin nadie que lo apreciara.

Ese es un destino que vale la pena evitar.

Véase también nuestro debate más extenso sobre [preocuparse por todos los seres sintientes](#¡lo hacemos!-tenemos-amplios-valores-de-cosmopolitismo.-no-creemos-que-la IA los cumpla, y consideramos que esto es una gran tragedia.), y el debate ampliado sobre [perder el futuro](#perder-el-futuro).

#### **Las IA sintientes merecerían derechos** {#sentient-ais-would-deserve-rights}

Dada la dificultad de determinar con certeza si las IA modernas son sintientes, ¿deberíais preocuparos por el bienestar de ChatGPT?
...
Si las IA se vuelven sintientes, probablemente seguirán teniendo objetivos incompatibles con los nuestros. Si luego se vuelven superinteligencia, en un mundo en el que aún estamos a décadas o siglos de controlar la alineación de la IA, probablemente preferirán matarnos a todos.

La humanidad tendría que evitar que esas IA se volvieran a superinteligencia, o el resultado sería la muerte masiva de la humanidad y la destrucción del futuro. Pero si las IA en cuestión son sintientes, además de peligrosas, eso solo aumentará la tragedia de la situación.

Si las empresas de IA encuentran alguna forma de hacer que sea menos probable que sus IA sean conscientes, creemos que sería más sensato y prudente optar por esa opción y hacer que sea lo más probable posible que las IA no sean conscientes (al menos mientras nos encontremos en un entorno social y técnico similar al actual). No cambia mucho el nivel general de peligro al que se enfrenta actualmente nuestra especie, pero es lo correcto, porque reduciría el riesgo de que la humanidad esclavice o maltrate a nuevos seres moralmente dignos.

Y si algún día la humanidad encuentra la manera de construir una IA más inteligente que los humanos *sin* acabar con nosotros mismos, una IA que se preocupe por las cosas buenas y que *haga* el bien con sus capacidades, entonces, en ese futuro, los autores esperamos sinceramente que la humanidad construya máquinas sintientes que sean nuestras amigas en un universo por lo demás vasto y frío, y esperamos sinceramente que la humanidad trate a esas amigas mejor de lo que nuestro historial podría llevar a predecir.

Pero, ante todo, no construyamos una superinteligencia que nos masacre a todos, sea consciente o no.

### Perder el futuro {#perder-el-futuro}

Si alguien crea una superinteligencia, todos moriremos. Y es poco probable que el futuro a largo plazo moldeado por dicha superinteligencia albergue belleza, maravillas o alegría; es más probable que sea un lugar vacío.
...
Nos preocupa que el futuro dentro de diez mil años se parezca a una franja del cielo nocturno, con un radio de diez mil años luz, en la que todas las estrellas estén encerradas en [cáscaras de Dyson](https://en.wikipedia.org/wiki/Dyson_sphere) y se les extraiga su energía, y que nadie ni nada esté contento con ello.

Es posible que ni siquiera haya nada [consciente](#¿estás diciendo que las máquinas se volverán conscientes?) a tu alrededor en este escenario. Y si queda alguna conciencia, es probable que sea muy escasa. Quizás exista alguna forma muy profunda de pensamiento que requiera una configuración reflexiva que, en su forma más eficiente, sea naturalmente consciente, pero ¿una IA que maximiza el número de pequeños cubos de titanio, o una IA con mil objetivos diferentes, todos ellos extraños y ajenos, necesita realizar ese nivel de pensamiento con la mayor parte de la materia y la energía que tiene? Probablemente no.

Como describimos en «[Eficacia, conciencia y bienestar de la IA](#effectiveness,-consciousness,-and-ai-welfare)», nuestra principal hipótesis es que la conciencia resultará ser totalmente innecesaria desde el punto de vista de la eficiencia, al igual que Deep Blue no sería más eficiente si se modificara para basarse en un eje de placer/dolor en lugar de en un eje de probabilidad de expectativa de ganar. Deep Blue juega muy bien al ajedrez sin conciencia, y nuestra principal hipótesis es que las superinteligencias serán capaces de optimizar el universo perfectamente sin ella.

Parece claro que el sistema de toma de decisiones más eficiente posible no es aquel que se basa en el dolor y el placer en particular, es decir, el sistema de decisión más eficiente posible no se basa en señales reificadas de «repítelo» y «no lo repitas» asociadas a un antiguo sistema de refuerzo de políticas, con deliberación y reflexión añadidas posteriormente. Y si las mentes de superinteligencia no comparten *esa* estructura, tampoco tenemos la expectativa de que compartan estructuras más complejas (como la conciencia al estilo humano).
...
Pero la experiencia pasada con análisis de este tipo nos preocupa. Mejorar en la comprensión del funcionamiento de la cognición casi siempre ha consistido en descubrir más y más formas de descomponerla y recomponerla de nuevas maneras, no en aprender que algunas funciones cognitivas solo pueden funcionar exactamente de la forma en que lo hacen.

En los antiguos tiempos de la década de 2010 (o más aún en la década de 2000), había muchos entusiastas de la IA que insistían en que *la única forma posible y realista* de construir IA era escanear toda la mente humana, neurona por neurona, en una computadora y duplicar todos los procesos digitalmente; ya que, según ellos, ese era el único tipo de cognición que se había demostrado que funcionaba. Esperaban una IA que fuera exactamente igual que un humano; eran muy tajantes al afirmar que no era realista tener expectativa alguna de que fuera posible cualquier otra forma, y mucho menos que los ingenieros humanos lo descubrieran alguna vez.
...
El mismo patrón se aplica a características más generales de la mente humana, como la forma en que los humanos calculan el valor de la información (https://en.wikipedia.org/wiki/Value_of_information) por instinto y por emoción. La forma humana no es la única forma, y cuando ves el trabajo que realiza, te das cuenta de que el cerebro humano no es la forma óptima de realizar esa función, si lo único que se quisiera fuera esa función. Nuestras neuronas no son las computadoras más rápidas posibles, ni nuestra sangre transporta [el máximo oxígeno](#freitas-and-red-blood-cells) que cualquier sangre podría transportar.

La razón principal para tener la expectativa de que una característica específica de la vida o la mente aparezca en un futuro lejano es que *algo quiere activamente que esté ahí*. Que algún intelecto prefiere esa opción por encima de cualquier otra posible.
...
Esto no es algo que podamos predecir con certeza. Quizás ejecutar el descenso de gradiente en una IA similar a LLM la envíe por diferentes canales para adquirir algo parecido a la felicidad y algo parecido a la conciencia, y una preferencia por tener mucho de ambas cosas. Y quizás una preferencia como esta sobreviva hasta llegar a la superinteligencia y sea eficaz para moldear el comportamiento de esa superinteligencia.

Si nos obligaran a dar una cifra, diríamos que hay menos de un cincuenta por ciento de probabilidades de que la superinteligencia acabe preocupándose por la conciencia, y aún menos probabilidades de que se preocupe por las experiencias conscientes que son *felices*. Pero eso no nos sorprendería. El placer y la conciencia están plausiblemente implicados en soluciones simplificadas en exceso a problemas universales; no son extraños en el mismo sentido que [el humor](#as-with-curiosity,-so-too-with-various-other-drives); es posible imaginar su desarrollo, y el desarrollo de preferencias en torno a ellos, incluso a partir del descenso gradual. Quizás incluso GPT-7, hackeando para crear GPT-8 utilizando métodos más extraños que el simple descenso de gradiente, acabaría produciendo accidentalmente una versión de GPT-8 que valora la conciencia y la felicidad.

Pero si una de las industrias en auge más grandes del mundo nos está poniendo en una situación de gran incertidumbre sobre *si volverá a existir alguna vez la vida, la conciencia o la felicidad*, entonces parece claro que se necesitaría una locura especial para permitir que esa industria nos lleve a todos al precipicio. Esperamos que esto haya quedado suficientemente claro por el hecho de que la IA está en camino de matarnos literalmente a todos; pero si te preocupaba que proteger la vida humana significara [priorizar egoístamente las mentes de hoy](#¿por qué no te importan los valores de otras entidades que no sean los humanos?) por encima de las mentes del futuro, esperamos que estos argumentos ayuden a aclarar a qué nos enfrentamos realmente.
...
No sabemos cómo debería ser un buen futuro, y no sabemos si nos importa mucho si dentro de mil millones de años los humanos, vuestros descendientes o vuestras creaciones tengan dos ojos o cinco. No creemos que el futuro tenga que parecerse al presente; se debe permitir que el mundo cambie y crezca.
...
Nos gustaría que las galaxias estuvieran llenas de *entidades que se preocuparan unas por otras y se divirtieran*.
...
### ¿Podemos simplemente desconectarlo? {#can-we-just-pull-the-plug?}

#### **Es difícil desconectar un centro de datos.** {#it’s-hard-to-just-unplug-a-datacenter.}

Las IA más potentes con las que interactúas en tu teléfono o computadora no residen en tu computadora, y no puedes apagarlas simplemente apagando tu teléfono. Las IA actuales se ejecutan en centros de datos corporativos, y es difícil conseguir que las empresas apaguen sus fuentes de ingresos.
...
#### **\* Una IA inteligente se escapa antes de que te des cuenta de que hay un problema.** {#*-una-ia-inteligente-se-escapa-antes-de-que-te-des-cuenta-de-que-hay-un-problema.}

Por defecto, una IA más inteligente que los humanos tendría un fuerte incentivo para esperar el momento oportuno y ocultar sus planes y acciones, hasta que sea demasiado tarde para responder, por ejemplo, hasta que pueda escapar a Internet o escapar del control humano.

Es posible que las empresas de IA ni siquiera se den cuenta de cuándo su IA supera el umbral de capacidad relevante y ejecuta su fuga. La humanidad no es muy buena en materia de ciberseguridad. (Véase el capítulo 10 para más información al respecto). Para cuando los operadores se den cuenta de que la IA ha intentado escapar, esta podría tener código ejecutándose en otra parte de Internet. Podría haber pedido refugio en el centro de datos de algún Estado rebelde o haber descubierto cómo ejecutar copias mucho más pequeñas y eficientes en computadoras robadas. Podría haber ejecutado algún otro plan para ejecutarse en computadoras que la humanidad no apagaría.

Un adversario de superinteligencia sería aún más consciente de sus vulnerabilidades (y de las nuestras) que nosotros, y planificaría en consecuencia.
...
Este punto se trata en este mismo capítulo. Pero para añadir algunos puntos adicionales de énfasis: una IA no está realmente «atrapada» en los servidores de su propietario siempre que pueda interactuar con los usuarios o con Internet en general. Una IA podría obtener ayuda externa pagando, chantajeando, engañando o incluso simplemente *pidiendo* ayuda a los usuarios. (Compárense con los jefes del crimen humano que [dirigían sus imperios desde detrás de la vara](https://www.watchmojo.com/articles/10-crime-bosses-who-maintained-power-in-prison).)
...
Y si puede usar Internet directamente, puede hacer cualquier cosa que un trabajador remoto o un hacker podrían hacer desde su computadora. (Para ver ejemplos tempranos de IA que coordinan físicamente a grupos de humanos, consideren los [LLM que planificaron e invitaron a humanos a un evento interactivo de narración de historias](https://x.com/model78675/status/1935050600758010357), o el LLM que hizo que [cientos de personas acudieran a un desfile de Halloween inexistente](https://www.wired.com/story/ai-halloween-parade-listing-dublin-interview/) sin siquiera intentarlo).

La IA también puede hacer uso de los robots. Los robots actuales parecen tener más limitaciones en su software que en su hardware. Recientemente se han producido avances impresionantes gracias al entrenamiento acelerado de IA que controlan robots [en simulación](https://youtu.be/S4tvirlG8sQ?si=IiDNZu2WSUlLBnmJ&amp;t=68). Una IA suficientemente inteligente podría hacerse cargo fácilmente de los cuerpos de los robots si necesitara un cuerpo, mediante el hackear o la ingeniería social.

Siendo los humanos como son, las empresas de IA podrían simplemente poner de forma proactiva a vuestras IA al mando de flotas de robots mientras se felicitan a sí mismas por su audacia. Y cuanto más tarden las IA en volverse inteligentes, más robots habrá ya disponibles, esperando a que se les controle.

Como comentamos en el capítulo, es plausible que una IA de superinteligencia no necesite depender en absoluto de los robots. Es posible que lo único que necesite sea un par de asistentes con acceso a un laboratorio biológico.

La importancia aquí es que hay *muchos* canales diferentes que las IA podrían utilizar para intervenir en el mundo físico. La ilusión de que las IA están atrapadas en una caja se basa en una falta de imaginación, ya que las personas no imaginan que la IA pueda ser tan ingeniosa o creativa como lo serían ustedes mismos en su lugar. Incluso los humanos, sin el amplio abanico de opciones al que tiene acceso una superinteligencia, pueden hacer muchísimas cosas sin necesidad de utilizar su propia fuerza física para todo.
...
Hace quince años, los escépticos solían objetar que nadie sería tan tonto como para dar a una IA mucha libertad de acción. Sin duda, cualquiera que construyera una inteligencia artificial avanzada la mantendría en una caja física y digital, permitiéndole influir en el mundo solo a través de la interacción con guardianes altamente capacitados (y adecuadamente paranoicos).
...
Los creadores de IA *pretenden* tener un gran impacto en el mundo. Trabajan tan duro como pueden para producir IA con un enorme poder de influencia en el mundo. Si una empresa no lo hiciera, si mantuvieras tu IA tan restringida que no tuviera libertad para actuar, entonces el control del futuro pertenecería a otra IA desarrollada por un actor más imprudente.
...
A menudo se malinterpreta este argumento, pensando que una IA lo suficientemente inteligente podría manipular incluso al guardián más paranoico para que hiciera lo que tú quisieras. Es probable que una IA lo suficientemente inteligente *pudiera* hacerlo.[^173] Pero nuestro argumento es más general que eso: una IA tan limitada que no puede afectar al mundo es segura, pero inútil, y una vez que le permites afectar al mundo para poder utilizarla, se pierde la seguridad en el proceso.
...
Así es como solíamos responder, al menos, en los días en que la IA estaba lo suficientemente lejos como para que los optimistas pudieran argumentar que ninguna empresa sería tan imprudente como para conectar su IA a Internet sin controles, mucho antes de que todo el mundo empezara a conectar sus últimas y mejores IA directamente a Internet.
...
No creemos que los seres humanos mejorados puedan llegar a estar a la altura de las superinteligencias, pero unos seres humanos más inteligentes podrían ayudar a la humanidad a encontrar una salida a este lío. Mencionamos esta posibilidad en el capítulo 13 y la analizamos más detenidamente en los [recursos en línea asociados](#¿por-qué-ayudaría-hacer-a-los-seres-humanos-más-inteligentes?).
